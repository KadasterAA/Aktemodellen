...
Version: 2.10.0 (AA-3613: tekstblok aanhef en equivalentieverklaring)
*********************************************************
Description:
...
<xsl:stylesheet xmlns="http://www.w3.org/1999/xhtml"
	...
	<xsl:variable name="keuzeteksten" select="document('keuzeteksten_hypotheek_particulier-2.8.0.xml')" />
