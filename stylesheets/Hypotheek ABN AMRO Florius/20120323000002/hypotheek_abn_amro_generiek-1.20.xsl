...
<xsl:stylesheet xmlns="http://www.w3.org/1999/xhtml"
	...
	**** matching template ********************************************************************************
	...
	<xsl:template match="tia:Bericht_TIA_Stuk" mode="do-header">
		...
		<!-- Document title -->
		<xsl:if test="normalize-space($documentTitle) != '' and translate($documentTitle, $upper, $lower) != 'abn amro aab hypotheek'
				 and translate($documentTitle, $upper, $lower) != 'abn amro florius hypotheek' and translate($documentTitle, $upper, $lower) != 'abn amro moneyou hypotheek'">
