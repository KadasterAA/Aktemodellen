...
<!--
*************************************************************
Stylesheet: hypotheek_sns.xsl
Version: 3.0.0
(AA-3284, 2415, 2414,4234, 4447
...
<xsl:stylesheet xmlns="http://www.w3.org/1999/xhtml" xmlns:tia="http://www.kadaster.nl/schemas/KIK/TIA_Algemeen" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:kef="nl.kadaster.xslt.XslExtensionFunctions" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:gc="http://docs.oasis-open.org/codelist/ns/genericode/1.0/" exclude-result-prefixes="tia xsl xlink kef gc" version="1.0">
	...
	<!-- sns specific global variables -->
	<xsl:variable name="keuzeteksten" select="document('keuzeteksten_hypotheek_sns-3.0.0.xml')"/>
	...
	**** matching template ********************************************************************************
	...
	<xsl:template match="tia:Bericht_TIA_Stuk" mode="do-deed">
		...
		<xsl:if test="tia:IMKAD_AangebodenStuk/tia:StukdeelHypotheek[translate(tia:aanduidingHypotheek, $upper, $lower) = 'overbruggingshypotheek']">
			...
			<p>
				<xsl:text>Voorts verleent de schuldenaar, tot meerdere zekerheid voor de betaling van de lening als hierboven vermeld, bij deze aan de bank, die van de schuldenaar aanvaardt het recht van </xsl:text><xsl:value-of select="kef:convertOrdinalToText(tia:IMKAD_AangebodenStuk/tia:StukdeelHypotheek[translate(tia:aanduidingHypotheek, $upper, $lower) = 'overbruggingshypotheek']/tia:rangordeHypotheek)"/>		
...
<!--							<xsl:with-param name="haveAdditionalText" select="'true'"/> &lt;!&ndash; forceer de ; na elke aanroep recht/registergoed &ndash;&gt;-->
	...
	*********************************************************
	...
	Description: sns mortgage deed election of domicile.
	...
	*********************************************************
	...
	Description: sns mortgage deed free text part.
	...
	*********************************************************
	...
	Description: sns mortgage deed parties.
	...
	*********************************************************
	...
	Description: sns mortgage deed party persons.
