...
Version: 1.70 (JIRA: AA-2230: TB Recht)
*********************************************************
Description:
...
<xsl:stylesheet xmlns="http://www.w3.org/1999/xhtml" xmlns:tia="http://www.kadaster.nl/schemas/KIK/TIA_Algemeen" xmlns:kef="nl.kadaster.xslt.XslExtensionFunctions" xmlns:gc="http://docs.oasis-open.org/codelist/ns/genericode/1.0/" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:exslt="http://exslt.org/common" xmlns:xlink="http://www.w3.org/1999/xlink" exclude-result-prefixes="tia kef gc xsl exslt xlink" version="1.0">
	...
	<xsl:variable name="keuzeteksten" select="document('keuzeteksten_verdeling-1.25.xml')"/>
	...
	**** matching template ********************************************************************************
	...
	<xsl:template match="tia:IMKAD_AangebodenStuk" mode="do-type-of-division-uittreding-vennoten">
		<xsl:variable name="numberOfRights" select="count(tia:StukdeelVerdelingUittredingVennoten/tia:IMKAD_ZakelijkRecht)"/>
	...
	<xsl:template match="tia:IMKAD_AangebodenStuk" mode="do-type-of-division-marriage">
		...
		<tr>
			...
			<td>
				...
				<xsl:text>onder het maken van huwelijkse voorwaarden gehuwd. Tot de door de indiening van het echtscheidingsverzoek ontbonden </xsl:text>
				<xsl:if test="normalize-space($zonder) = ''">
					<xsl:text>beperkte </xsl:text>
				</xsl:if>
				<xsl:text>gemeenschap van goederen </xsl:text>
				<xsl:choose>
					<xsl:when test="$numberOfRights = 1">
	...
	**** matching template ********************************************************************************
	...
	<xsl:template match="tia:StukdeelVerdelingVennootschap | tia:StukdeelVerdelingHuwelijk | tia:StukdeelVerdelingPartnerschap | tia:StukdeelVerdelingGemeenschap | tia:StukdeelVerdelingUittredingVennoten" mode="do-distribution">
		...
		<xsl:choose>
			<!-- Variant 1 -->
			<xsl:when test="tia:verkrijgerRechtRef and not(tia:IMKAD_ZakelijkRecht/tia:verkrijgerRechtRef) and (count(../tia:Partij[concat('#', @id) = current()/tia:verkrijgerRechtRef/@xlink:href]/tia:IMKAD_Persoon[normalize-space(tia:tia_IndGerechtigde) = 'true']/tia:tia_AandeelInRechten)
								+ count(../tia:Partij[concat('#', @id) = current()/tia:verkrijgerRechtRef/@xlink:href]/tia:IMKAD_Persoon/tia:GerelateerdPersoon/tia:IMKAD_Persoon[normalize-space(tia:tia_IndGerechtigde) = 'true']/tia:tia_AandeelInRechten)
								+ count(../tia:Partij[concat('#', @id) = current()/tia:verkrijgerRechtRef/@xlink:href]/tia:IMKAD_Persoon/tia:GerelateerdPersoon/tia:IMKAD_Persoon/tia:GerelateerdPersoon/tia:IMKAD_Persoon[normalize-space(tia:tia_IndGerechtigde) = 'true']/tia:tia_AandeelInRechten)) = 0
			...
			<!-- Variant 2 -->
			<xsl:when test="count(tia:verkrijgerRechtRef) = 1 and not(tia:IMKAD_ZakelijkRecht/tia:verkrijgerRechtRef) and (count(../tia:Partij[concat('#', @id) = current()/tia:verkrijgerRechtRef/@xlink:href]/tia:IMKAD_Persoon[normalize-space(tia:tia_IndGerechtigde) = 'true']/tia:tia_AandeelInRechten)
								+ count(../tia:Partij[concat('#', @id) = current()/tia:verkrijgerRechtRef/@xlink:href]/tia:IMKAD_Persoon/tia:GerelateerdPersoon/tia:IMKAD_Persoon[normalize-space(tia:tia_IndGerechtigde) = 'true']/tia:tia_AandeelInRechten)
								+ count(../tia:Partij[concat('#', @id) = current()/tia:verkrijgerRechtRef/@xlink:href]/tia:IMKAD_Persoon/tia:GerelateerdPersoon/tia:IMKAD_Persoon/tia:GerelateerdPersoon/tia:IMKAD_Persoon[normalize-space(tia:tia_IndGerechtigde) = 'true']/tia:tia_AandeelInRechten)) > 0
								and count(tia:IMKAD_ZakelijkRecht/tia:Toedeling) = 0">
				<xsl:apply-templates select="." mode="do-allocation-header"/>
				<xsl:apply-templates select="." mode="do-allocation-to-different-persons-within-one-party">
					...
					<xsl:with-param name="acquiringPersons" select="../tia:Partij[concat('#', @id) = current()/tia:verkrijgerRechtRef/@xlink:href]/tia:IMKAD_Persoon[normalize-space(tia:tia_IndGerechtigde) = 'true' and tia:tia_AandeelInRechten]
																	| ../tia:Partij[concat('#', @id) = current()/tia:verkrijgerRechtRef/@xlink:href]/tia:IMKAD_Persoon/tia:GerelateerdPersoon/tia:IMKAD_Persoon[normalize-space(tia:tia_IndGerechtigde) = 'true' and tia:tia_AandeelInRechten]
																	| ../tia:Partij[concat('#', @id) = current()/tia:verkrijgerRechtRef/@xlink:href]/tia:IMKAD_Persoon/tia:GerelateerdPersoon/tia:IMKAD_Persoon/tia:GerelateerdPersoon/tia:IMKAD_Persoon[normalize-space(tia:tia_IndGerechtigde) = 'true' and tia:tia_AandeelInRechten]"/>
			...
			<xsl:when test="count(tia:verkrijgerRechtRef) = 1 and not(tia:IMKAD_ZakelijkRecht/tia:verkrijgerRechtRef) and count(tia:IMKAD_ZakelijkRecht/tia:Toedeling) > 0">
				...
				<xsl:apply-templates select="." mode="do-allocation-to-different-persons-within-one-party">
					<xsl:with-param name="authorizedRepresentative" select="../tia:Partij[concat('#', @id) = current()/tia:verkrijgerRechtRef/@xlink:href]/tia:Gevolmachtigde"/>
					<xsl:with-param name="acquiringPersons" select="../tia:Partij[concat('#', @id) = current()/tia:verkrijgerRechtRef/@xlink:href]/tia:IMKAD_Persoon[concat('#', @id) = current()/tia:IMKAD_ZakelijkRecht/tia:Toedeling/tia:verkrijgerRechtRef/@xlink:href and normalize-space(tia:tia_IndGerechtigde) = 'true']
																	| ../tia:Partij[concat('#', @id) = current()/tia:verkrijgerRechtRef/@xlink:href]/tia:IMKAD_Persoon/tia:GerelateerdPersoon/tia:IMKAD_Persoon[concat('#', @id) = current()/tia:IMKAD_ZakelijkRecht/tia:Toedeling/tia:verkrijgerRechtRef/@xlink:href and normalize-space(tia:tia_IndGerechtigde) = 'true']
																	| ../tia:Partij[concat('#', @id) = current()/tia:verkrijgerRechtRef/@xlink:href]/tia:IMKAD_Persoon/tia:GerelateerdPersoon/tia:IMKAD_Persoon/tia:GerelateerdPersoon/tia:IMKAD_Persoon[concat('#', @id) = current()/tia:IMKAD_ZakelijkRecht/tia:Toedeling/tia:verkrijgerRechtRef/@xlink:href and normalize-space(tia:tia_IndGerechtigde) = 'true']"/>
					<xsl:with-param name="acquirerParty" select="../tia:Partij[concat('#', @id) = current()/tia:verkrijgerRechtRef/@xlink:href]"/>
					<xsl:with-param name="isLastGroup" select="'true'"/>
			...
			<xsl:when test="tia:IMKAD_ZakelijkRecht/tia:verkrijgerRechtRef and translate($isAlocationToSpecificPartiesTheSame, $upper, $lower) = 'true' and
							(count(../tia:Partij[concat('#', @id) = current()/tia:IMKAD_ZakelijkRecht/tia:verkrijgerRechtRef/@xlink:href]/tia:IMKAD_Persoon[normalize-space(tia:tia_IndGerechtigde) = 'true']/tia:tia_AandeelInRechten)
							+ count(../tia:Partij[concat('#', @id) = current()/tia:IMKAD_ZakelijkRecht/tia:verkrijgerRechtRef/@xlink:href]/tia:IMKAD_Persoon/tia:GerelateerdPersoon/tia:IMKAD_Persoon[normalize-space(tia:tia_IndGerechtigde) = 'true']/tia:tia_AandeelInRechten)
							+ count(../tia:Partij[concat('#', @id) = current()/tia:IMKAD_ZakelijkRecht/tia:verkrijgerRechtRef/@xlink:href]/tia:IMKAD_Persoon/tia:GerelateerdPersoon/tia:IMKAD_Persoon/tia:GerelateerdPersoon/tia:IMKAD_Persoon[normalize-space(tia:tia_IndGerechtigde) = 'true']/tia:tia_AandeelInRechten)) = 0
							and count(tia:IMKAD_ZakelijkRecht/tia:Toedeling) = 0">
				<xsl:variable name="_parties">
					<tia:root>
			...
			<xsl:when test="tia:IMKAD_ZakelijkRecht/tia:verkrijgerRechtRef and translate($isAlocationToSpecificPartiesTheSame, $upper, $lower) = 'true'
								and (count(../tia:Partij[concat('#', @id) = current()/tia:IMKAD_ZakelijkRecht/tia:verkrijgerRechtRef/@xlink:href]/tia:IMKAD_Persoon[normalize-space(tia:tia_IndGerechtigde) = 'true']/tia:tia_AandeelInRechten)
									+ count(../tia:Partij[concat('#', @id) = current()/tia:IMKAD_ZakelijkRecht/tia:verkrijgerRechtRef/@xlink:href]/tia:IMKAD_Persoon/tia:GerelateerdPersoon/tia:IMKAD_Persoon[normalize-space(tia:tia_IndGerechtigde) = 'true']/tia:tia_AandeelInRechten)
									+ count(../tia:Partij[concat('#', @id) = current()/tia:IMKAD_ZakelijkRecht/tia:verkrijgerRechtRef/@xlink:href]/tia:IMKAD_Persoon/tia:GerelateerdPersoon/tia:IMKAD_Persoon/tia:GerelateerdPersoon/tia:IMKAD_Persoon[normalize-space(tia:tia_IndGerechtigde) = 'true']/tia:tia_AandeelInRechten)) > 0
								and count(tia:IMKAD_ZakelijkRecht/tia:Toedeling) = 0">
				<xsl:apply-templates select="." mode="do-allocation-header"/>
				<xsl:apply-templates select="." mode="do-allocation-to-different-persons-within-one-party">
					...
					<xsl:with-param name="acquiringPersons" select="../tia:Partij[concat('#', @id) = current()/tia:IMKAD_ZakelijkRecht[1]/tia:verkrijgerRechtRef/@xlink:href]/tia:IMKAD_Persoon[tia:tia_AandeelInRechten and normalize-space(tia:tia_IndGerechtigde) = 'true']
																| ../tia:Partij[concat('#', @id) = current()/tia:IMKAD_ZakelijkRecht[1]/tia:verkrijgerRechtRef/@xlink:href]/tia:IMKAD_Persoon/tia:GerelateerdPersoon/tia:IMKAD_Persoon[tia:tia_AandeelInRechten and normalize-space(tia:tia_IndGerechtigde) = 'true']
																| ../tia:Partij[concat('#', @id) = current()/tia:IMKAD_ZakelijkRecht[1]/tia:verkrijgerRechtRef/@xlink:href]/tia:IMKAD_Persoon/tia:GerelateerdPersoon/tia:IMKAD_Persoon/tia:GerelateerdPersoon/tia:IMKAD_Persoon[tia:tia_AandeelInRechten and normalize-space(tia:tia_IndGerechtigde) = 'true']"/>
			...
			<xsl:when test="tia:IMKAD_ZakelijkRecht/tia:verkrijgerRechtRef and translate($isAlocationToSpecificPartiesTheSame, $upper, $lower) = 'true' and count(tia:IMKAD_ZakelijkRecht/tia:Toedeling) > 0">
				...
				<xsl:apply-templates select="." mode="do-allocation-to-different-persons-within-one-party">
					<xsl:with-param name="authorizedRepresentative" select="../tia:Partij[concat('#', @id) = current()/tia:IMKAD_ZakelijkRecht[1]/tia:verkrijgerRechtRef/@xlink:href]/tia:Gevolmachtigde"/>
					<xsl:with-param name="acquiringPersons" select="../tia:Partij[concat('#', @id) = current()/tia:IMKAD_ZakelijkRecht[1]/tia:verkrijgerRechtRef/@xlink:href]/tia:IMKAD_Persoon[concat('#', @id) = current()/tia:IMKAD_ZakelijkRecht/tia:Toedeling/tia:verkrijgerRechtRef/@xlink:href and normalize-space(tia:tia_IndGerechtigde) = 'true']
																| ../tia:Partij[concat('#', @id) = current()/tia:IMKAD_ZakelijkRecht[1]/tia:verkrijgerRechtRef/@xlink:href]/tia:IMKAD_Persoon/tia:GerelateerdPersoon/tia:IMKAD_Persoon[concat('#', @id) = current()/tia:IMKAD_ZakelijkRecht/tia:Toedeling/tia:verkrijgerRechtRef/@xlink:href and normalize-space(tia:tia_IndGerechtigde) = 'true']
																| ../tia:Partij[concat('#', @id) = current()/tia:IMKAD_ZakelijkRecht[1]/tia:verkrijgerRechtRef/@xlink:href]/tia:IMKAD_Persoon/tia:GerelateerdPersoon/tia:IMKAD_Persoon/tia:GerelateerdPersoon/tia:IMKAD_Persoon[concat('#', @id) = current()/tia:IMKAD_ZakelijkRecht/tia:Toedeling/tia:verkrijgerRechtRef/@xlink:href and normalize-space(tia:tia_IndGerechtigde) = 'true']"/>
					<xsl:with-param name="acquirerParty" select="../tia:Partij[concat('#', @id) = current()/tia:IMKAD_ZakelijkRecht[1]/tia:verkrijgerRechtRef/@xlink:href]"/>
					<xsl:with-param name="isLastGroup" select="'true'"/>
			...
			<!-- Variant 8 -->
			<xsl:when test="tia:IMKAD_ZakelijkRecht/tia:verkrijgerRechtRef and translate($isAlocationToSpecificPartiesTheSame, $upper, $lower) = 'false' and (count(../tia:Partij[concat('#', @id) = current()/tia:IMKAD_ZakelijkRecht/tia:verkrijgerRechtRef/@xlink:href]/tia:IMKAD_Persoon[normalize-space(tia:tia_IndGerechtigde) = 'true']/tia:tia_AandeelInRechten)
									+ count(../tia:Partij[concat('#', @id) = current()/tia:IMKAD_ZakelijkRecht/tia:verkrijgerRechtRef/@xlink:href]/tia:IMKAD_Persoon/tia:GerelateerdPersoon/tia:IMKAD_Persoon[normalize-space(tia:tia_IndGerechtigde) = 'true']/tia:tia_AandeelInRechten)
									+ count(../tia:Partij[concat('#', @id) = current()/tia:IMKAD_ZakelijkRecht/tia:verkrijgerRechtRef/@xlink:href]/tia:IMKAD_Persoon/tia:GerelateerdPersoon/tia:IMKAD_Persoon/tia:GerelateerdPersoon/tia:IMKAD_Persoon[normalize-space(tia:tia_IndGerechtigde) = 'true']/tia:tia_AandeelInRechten)) > 0
									and count(../tia:Partij[concat('#', @id) = current()/tia:IMKAD_ZakelijkRecht/tia:verkrijgerRechtRef/@xlink:href]) = count(../tia:Partij[concat('#', @id) = current()/tia:IMKAD_ZakelijkRecht/tia:verkrijgerRechtRef/@xlink:href and (tia:IMKAD_Persoon[normalize-space(tia:tia_IndGerechtigde) = 'true']/tia:tia_AandeelInRechten or tia:IMKAD_Persoon/tia:GerelateerdPersoon/tia:IMKAD_Persoon[normalize-space(tia:tia_IndGerechtigde) = 'true']/tia:tia_AandeelInRechten or tia:IMKAD_Persoon/tia:GerelateerdPersoon/tia:IMKAD_Persoon/tia:GerelateerdPersoon/tia:IMKAD_Persoon[normalize-space(tia:tia_IndGerechtigde) = 'true']/tia:tia_AandeelInRechten)])
									and count(tia:IMKAD_ZakelijkRecht/tia:Toedeling) = 0">
				<xsl:variable name="_parties">
					<tia:root>
						<xsl:copy-of select="current()/../tia:Partij[tia:IMKAD_Persoon[tia:tia_AandeelInRechten and normalize-space(tia:tia_IndGerechtigde) = 'true'] or tia:IMKAD_Persoon/tia:GerelateerdPersoon/tia:IMKAD_Persoon[tia:tia_AandeelInRechten and normalize-space(tia:tia_IndGerechtigde) = 'true'] or tia:IMKAD_Persoon/tia:GerelateerdPersoon/tia:IMKAD_Persoon/tia:GerelateerdPersoon/tia:IMKAD_Persoon[tia:tia_AandeelInRechten and normalize-space(tia:tia_IndGerechtigde) = 'true']]"/>
					</tia:root>
				</xsl:variable>
				<xsl:variable name="parties" select="exslt:node-set($_parties)"/>
				...
				<xsl:for-each select="$groupParties/tia:groups/tia:group">
					...
					<xsl:apply-templates select="$root" mode="do-allocation-to-different-persons-within-one-party">
						...
						<xsl:with-param name="acquiringPersons" select="$currentPartij/tia:IMKAD_Persoon[tia:tia_AandeelInRechten and normalize-space(tia:tia_IndGerechtigde) = 'true'] | tia:Partij/tia:IMKAD_Persoon/tia:GerelateerdPersoon/tia:IMKAD_Persoon[tia:tia_AandeelInRechten and normalize-space(tia:tia_IndGerechtigde) = 'true'] | tia:Partij/tia:IMKAD_Persoon/tia:GerelateerdPersoon/tia:IMKAD_Persoon/tia:GerelateerdPersoon/tia:IMKAD_Persoon[tia:tia_AandeelInRechten and normalize-space(tia:tia_IndGerechtigde) = 'true']"/>
			...
			<xsl:when test="tia:IMKAD_ZakelijkRecht/tia:verkrijgerRechtRef and translate($isAlocationToSpecificPartiesTheSame, $upper, $lower) = 'false'
								and count(../tia:Partij[concat('#', @id) = current()/tia:IMKAD_ZakelijkRecht/tia:verkrijgerRechtRef/@xlink:href]) = count(../tia:Partij[tia:IMKAD_Persoon[concat('#', @id) = current()/tia:IMKAD_ZakelijkRecht/tia:Toedeling/tia:verkrijgerRechtRef/@xlink:href and normalize-space(tia:tia_IndGerechtigde) = 'true'] or tia:IMKAD_Persoon/tia:GerelateerdPersoon/tia:IMKAD_Persoon[concat('#', @id) = current()/tia:IMKAD_ZakelijkRecht/tia:Toedeling/tia:verkrijgerRechtRef/@xlink:href and normalize-space(tia:tia_IndGerechtigde) = 'true'] or tia:IMKAD_Persoon/tia:GerelateerdPersoon/tia:IMKAD_Persoon/tia:GerelateerdPersoon/tia:IMKAD_Persoon[concat('#', @id) = current()/tia:IMKAD_ZakelijkRecht/tia:Toedeling/tia:verkrijgerRechtRef/@xlink:href and normalize-space(tia:tia_IndGerechtigde) = 'true']])
								and count(tia:IMKAD_ZakelijkRecht/tia:Toedeling) > 0">
				<xsl:variable name="_parties">
					<tia:root>
						<xsl:copy-of select="current()/../tia:Partij[tia:IMKAD_Persoon[concat('#', @id) = current()/tia:IMKAD_ZakelijkRecht/tia:Toedeling/tia:verkrijgerRechtRef/@xlink:href and normalize-space(tia:tia_IndGerechtigde) = 'true'] or tia:IMKAD_Persoon/tia:GerelateerdPersoon/tia:IMKAD_Persoon[concat('#', @id) = current()/tia:IMKAD_ZakelijkRecht/tia:Toedeling/tia:verkrijgerRechtRef/@xlink:href and normalize-space(tia:tia_IndGerechtigde) = 'true'] or tia:IMKAD_Persoon/tia:GerelateerdPersoon/tia:IMKAD_Persoon/tia:GerelateerdPersoon/tia:IMKAD_Persoon[concat('#', @id) = current()/tia:IMKAD_ZakelijkRecht/tia:Toedeling/tia:verkrijgerRechtRef/@xlink:href and normalize-space(tia:tia_IndGerechtigde) = 'true']]"/>
				...
				<xsl:for-each select="$groupParties/tia:groups/tia:group">
					...
					<xsl:apply-templates select="$root" mode="do-allocation-to-different-persons-within-one-party">
						<xsl:with-param name="authorizedRepresentative" select="$currentPartij/tia:Gevolmachtigde"/>
						<xsl:with-param name="acquiringPersons" select="$currentPartij/tia:IMKAD_Persoon[concat('#', @id) = $root/tia:IMKAD_ZakelijkRecht/tia:Toedeling/tia:verkrijgerRechtRef/@xlink:href and normalize-space(tia:tia_IndGerechtigde) = 'true'] | tia:Partij/tia:IMKAD_Persoon/tia:GerelateerdPersoon/tia:IMKAD_Persoon[concat('#', @id) = $root/tia:IMKAD_ZakelijkRecht/tia:Toedeling/tia:verkrijgerRechtRef/@xlink:href and normalize-space(tia:tia_IndGerechtigde) = 'true'] | tia:Partij/tia:IMKAD_Persoon/tia:GerelateerdPersoon/tia:IMKAD_Persoon/tia:GerelateerdPersoon/tia:IMKAD_Persoon[concat('#', @id) = $root/tia:IMKAD_ZakelijkRecht/tia:Toedeling/tia:verkrijgerRechtRef/@xlink:href and normalize-space(tia:tia_IndGerechtigde) = 'true']"/>
						<xsl:with-param name="acquirerParty" select="$currentPartij"/>
						<xsl:with-param name="isLastGroup" select="$isLastGroup"/>
			...
			<!-- Variant 10 -->
			<xsl:when test="tia:IMKAD_ZakelijkRecht/tia:verkrijgerRechtRef and translate($isAlocationToSpecificPartiesTheSame, $upper, $lower) = 'false'
								and (count(../tia:Partij/tia:IMKAD_Persoon[normalize-space(tia:tia_IndGerechtigde) = 'true']/tia:tia_AandeelInRechten)
								+ count(../tia:Partij/tia:IMKAD_Persoon/tia:GerelateerdPersoon/tia:IMKAD_Persoon[normalize-space(tia:tia_IndGerechtigde) = 'true']/tia:tia_AandeelInRechten)
								+ count(../tia:Partij/tia:IMKAD_Persoon/tia:GerelateerdPersoon/tia:IMKAD_Persoon/tia:GerelateerdPersoon/tia:IMKAD_Persoon[normalize-space(tia:tia_IndGerechtigde) = 'true']/tia:tia_AandeelInRechten)) > 0
								and count(../tia:Partij[concat('#', @id) = current()/tia:IMKAD_ZakelijkRecht/tia:verkrijgerRechtRef/@xlink:href]) >= count(../tia:Partij[concat('#', @id) = current()/tia:IMKAD_ZakelijkRecht/tia:verkrijgerRechtRef/@xlink:href and (tia:IMKAD_Persoon[normalize-space(tia:tia_IndGerechtigde) = 'true']/tia:tia_AandeelInRechten or tia:IMKAD_Persoon/tia:GerelateerdPersoon/tia:IMKAD_Persoon[normalize-space(tia:tia_IndGerechtigde) = 'true']/tia:tia_AandeelInRechten or tia:IMKAD_Persoon/tia:GerelateerdPersoon/tia:IMKAD_Persoon/tia:GerelateerdPersoon/tia:IMKAD_Persoon[normalize-space(tia:tia_IndGerechtigde) = 'true']/tia:tia_AandeelInRechten)])
								and count(tia:IMKAD_ZakelijkRecht/tia:Toedeling) > 0
								and count(../tia:Partij[concat('#', @id) = current()/tia:IMKAD_ZakelijkRecht/tia:verkrijgerRechtRef/@xlink:href]) >= count(../tia:Partij[tia:IMKAD_Persoon[concat('#', @id) = current()/tia:IMKAD_ZakelijkRecht/tia:Toedeling/tia:verkrijgerRechtRef/@xlink:href and normalize-space(tia:tia_IndGerechtigde) = 'true'] or tia:IMKAD_Persoon/tia:GerelateerdPersoon/tia:IMKAD_Persoon[concat('#', @id) = current()/tia:IMKAD_ZakelijkRecht/tia:Toedeling/tia:verkrijgerRechtRef/@xlink:href and normalize-space(tia:tia_IndGerechtigde) = 'true'] or tia:IMKAD_Persoon/tia:GerelateerdPersoon/tia:IMKAD_Persoon/tia:GerelateerdPersoon/tia:IMKAD_Persoon[concat('#', @id) = current()/tia:IMKAD_ZakelijkRecht/tia:Toedeling/tia:verkrijgerRechtRef/@xlink:href and normalize-space(tia:tia_IndGerechtigde) = 'true']])
								and count(../tia:Partij[concat('#', @id) = current()/tia:IMKAD_ZakelijkRecht/tia:verkrijgerRechtRef/@xlink:href]) = (count(../tia:Partij[tia:IMKAD_Persoon[tia:tia_AandeelInRechten and normalize-space(tia:tia_IndGerechtigde) = 'true'] or tia:IMKAD_Persoon/tia:GerelateerdPersoon/tia:IMKAD_Persoon[normalize-space(tia:tia_IndGerechtigde) = 'true']/tia:tia_AandeelInRechten or tia:IMKAD_Persoon/tia:GerelateerdPersoon/tia:IMKAD_Persoon/tia:GerelateerdPersoon/tia:IMKAD_Persoon[normalize-space(tia:tia_IndGerechtigde) = 'true']/tia:tia_AandeelInRechten or
									tia:IMKAD_Persoon[concat('#', @id) = current()/tia:IMKAD_ZakelijkRecht/tia:Toedeling/tia:verkrijgerRechtRef/@xlink:href and normalize-space(tia:tia_IndGerechtigde) = 'true'] or tia:IMKAD_Persoon/tia:GerelateerdPersoon/tia:IMKAD_Persoon[concat('#', @id) = current()/tia:IMKAD_ZakelijkRecht/tia:Toedeling/tia:verkrijgerRechtRef/@xlink:href and normalize-space(tia:tia_IndGerechtigde) = 'true'] or tia:IMKAD_Persoon/tia:GerelateerdPersoon/tia:IMKAD_Persoon/tia:GerelateerdPersoon/tia:IMKAD_Persoon[concat('#', @id) = current()/tia:IMKAD_ZakelijkRecht/tia:Toedeling/tia:verkrijgerRechtRef/@xlink:href and normalize-space(tia:tia_IndGerechtigde) = 'true']]))">
				<xsl:variable name="_parties">
					<tia:root>
						<xsl:copy-of select="current()/../tia:Partij"/>
				...
				<xsl:for-each select="$groupParties/tia:groups/tia:group">
					...
					<xsl:apply-templates select="$root" mode="do-allocation-to-different-persons-within-one-party">
						<xsl:with-param name="authorizedRepresentative" select="$currentPartij/tia:Gevolmachtigde"/>
						<xsl:with-param name="acquiringPersons" select="$currentPartij/tia:IMKAD_Persoon[normalize-space(tia:tia_IndGerechtigde) = 'true'] | tia:Partij/tia:IMKAD_Persoon/tia:GerelateerdPersoon/tia:IMKAD_Persoon[normalize-space(tia:tia_IndGerechtigde) = 'true'] | tia:Partij/tia:IMKAD_Persoon/tia:GerelateerdPersoon/tia:IMKAD_Persoon/tia:GerelateerdPersoon/tia:IMKAD_Persoon[normalize-space(tia:tia_IndGerechtigde) = 'true']"/>
						<xsl:with-param name="acquirerParty" select="$currentPartij"/>
						<xsl:with-param name="isLastGroup" select="$isLastGroup"/>
			...
			<xsl:when test="tia:IMKAD_ZakelijkRecht/tia:verkrijgerRechtRef and translate($isAlocationToSpecificPartiesTheSame, $upper, $lower) = 'false'
				...
				<xsl:variable name="_parties">
					<tia:root>
						<xsl:copy-of select="current()/../tia:Partij[not(tia:IMKAD_Persoon[tia:tia_AandeelInRechten and normalize-space(tia:tia_IndGerechtigde) = 'true']) and not(tia:IMKAD_Persoon/tia:GerelateerdPersoon/tia:IMKAD_Persoon[tia:tia_AandeelInRechten and normalize-space(tia:tia_IndGerechtigde) = 'true']) and not(tia:IMKAD_Persoon/tia:GerelateerdPersoon/tia:IMKAD_Persoon/tia:GerelateerdPersoon/tia:IMKAD_Persoon[tia:tia_AandeelInRechten and normalize-space(tia:tia_IndGerechtigde) = 'true'])]"/>
					</tia:root>
				</xsl:variable>
				<xsl:variable name="parties" select="exslt:node-set($_parties)"/>
				<xsl:variable name="rights" select="tia:IMKAD_ZakelijkRecht"/>
				...
				<xsl:for-each select="$numberedRights/tia:IMKAD_ZakelijkRecht">
					...
					<xsl:if test="$processedPersonsRightsGroup and count($processedPersonsRightsGroup/tia:groups/tia:group[1]/tia:IMKAD_ZakelijkRecht[tia:orderNumber = current()/tia:orderNumber]/preceding-sibling::tia:IMKAD_ZakelijkRecht) = 0
						...
						<xsl:apply-templates select="$root" mode="do-allocation-to-different-persons-within-one-party">
							<xsl:with-param name="authorizedRepresentative" select="$currentPartij/tia:Gevolmachtigde"/>
							<xsl:with-param name="acquiringPersons" select="$currentPartij/tia:IMKAD_Persoon[tia:tia_AandeelInRechten and normalize-space(tia:tia_IndGerechtigde) = 'true'] | $currentPartij/tia:IMKAD_Persoon/tia:GerelateerdPersoon/tia:IMKAD_Persoon[tia:tia_AandeelInRechten and normalize-space(tia:tia_IndGerechtigde) = 'true'] | $currentPartij/tia:IMKAD_Persoon/tia:GerelateerdPersoon/tia:IMKAD_Persoon/tia:GerelateerdPersoon/tia:IMKAD_Persoon[tia:tia_AandeelInRechten and normalize-space(tia:tia_IndGerechtigde) = 'true']"/>
							<xsl:with-param name="acquirerParty" select="$currentPartij"/>
			...
			<xsl:when test="tia:IMKAD_ZakelijkRecht/tia:verkrijgerRechtRef and translate($isAlocationToSpecificPartiesTheSame, $upper, $lower) = 'false'
				...
				<xsl:variable name="_parties">
					<tia:root>
						<xsl:copy-of select="current()/../tia:Partij[not(tia:IMKAD_Persoon[(tia:tia_AandeelInRechten and normalize-space(tia:tia_IndGerechtigde) = 'true') or (tia:GerelateerdPersoon/tia:IMKAD_Persoon/tia:tia_AandeelInRechten and normalize-space(tia:tia_IndGerechtigde) = 'true')]) and not(tia:IMKAD_Persoon[(concat('#', @id) = current()/tia:IMKAD_ZakelijkRecht/tia:Toedeling/tia:verkrijgerRechtRef/@xlink:href and normalize-space(tia:tia_IndGerechtigde) = 'true') or tia:GerelateerdPersoon/tia:IMKAD_Persoon[concat('#', @id) = current()/tia:IMKAD_ZakelijkRecht/tia:Toedeling/tia:verkrijgerRechtRef/@xlink:href and normalize-space(tia:tia_IndGerechtigde) = 'true'] or tia:GerelateerdPersoon/tia:IMKAD_Persoon/tia:GerelateerdPersoon/tia:IMKAD_Persoon[concat('#', @id) = current()/tia:IMKAD_ZakelijkRecht/tia:Toedeling/tia:verkrijgerRechtRef/@xlink:href and normalize-space(tia:tia_IndGerechtigde) = 'true']])]"/>
					</tia:root>
				</xsl:variable>
				<xsl:variable name="parties" select="exslt:node-set($_parties)"/>
				<xsl:variable name="rights" select="tia:IMKAD_ZakelijkRecht"/>
				...
				<xsl:variable name="_allParties">
					<tia:root>
						<xsl:copy-of select="current()/../tia:Partij[tia:IMKAD_Persoon[normalize-space(tia:tia_IndGerechtigde) = 'true' and (tia:tia_AandeelInRechten or tia:GerelateerdPersoon/tia:IMKAD_Persoon[normalize-space(tia:tia_IndGerechtigde) = 'true']/tia:tia_AandeelInRechten or tia:GerelateerdPersoon/tia:IMKAD_Persoon[normalize-space(tia:tia_IndGerechtigde) = 'true']/tia:GerelateerdPersoon/tia:IMKAD_Persoon[normalize-space(tia:tia_IndGerechtigde) = 'true']/tia:tia_AandeelInRechten)] or tia:IMKAD_Persoon[normalize-space(tia:tia_IndGerechtigde) = 'true' and (concat('#', @id) = current()/tia:IMKAD_ZakelijkRecht/tia:Toedeling/tia:verkrijgerRechtRef/@xlink:href or tia:GerelateerdPersoon/tia:IMKAD_Persoon[concat('#', @id) = current()/tia:IMKAD_ZakelijkRecht/tia:Toedeling/tia:verkrijgerRechtRef/@xlink:href and normalize-space(tia:tia_IndGerechtigde) = 'true'] or tia:GerelateerdPersoon/tia:IMKAD_Persoon[normalize-space(tia:tia_IndGerechtigde) = 'true']/tia:GerelateerdPersoon/tia:IMKAD_Persoon[concat('#', @id) = current()/tia:IMKAD_ZakelijkRecht/tia:Toedeling/tia:verkrijgerRechtRef/@xlink:href and normalize-space(tia:tia_IndGerechtigde) = 'true'])]]"/>
					</tia:root>
				</xsl:variable>
				<xsl:variable name="allParties" select="exslt:node-set($_allParties)"/>
				<xsl:variable name="_groupParties">
				...
				<xsl:variable name="_groupedPersonsAndRights">
					<xsl:for-each select="$groupParties/tia:groups/tia:group">
						<xsl:variable name="_groupPersonsAndRights">
							<xsl:call-template name="groupPersonsAndRights">
								<xsl:with-param name="persons" select="tia:Partij/tia:IMKAD_Persoon[tia:tia_AandeelInRechten and normalize-space(tia:tia_IndGerechtigde) = 'true'] | tia:Partij/tia:IMKAD_Persoon/tia:GerelateerdPersoon/tia:IMKAD_Persoon[tia:tia_AandeelInRechten and normalize-space(tia:tia_IndGerechtigde) = 'true'] | tia:Partij/tia:IMKAD_Persoon/tia:GerelateerdPersoon/tia:IMKAD_Persoon/tia:GerelateerdPersoon/tia:IMKAD_Persoon[tia:tia_AandeelInRechten and normalize-space(tia:tia_IndGerechtigde) = 'true']
																		| tia:Partij/tia:IMKAD_Persoon[concat('#', @id) = $root/tia:IMKAD_ZakelijkRecht/tia:Toedeling/tia:verkrijgerRechtRef/@xlink:href and normalize-space(tia:tia_IndGerechtigde) = 'true'] | tia:Partij/tia:IMKAD_Persoon/tia:GerelateerdPersoon/tia:IMKAD_Persoon[concat('#', @id) = $root/tia:IMKAD_ZakelijkRecht/tia:Toedeling/tia:verkrijgerRechtRef/@xlink:href and normalize-space(tia:tia_IndGerechtigde) = 'true'] | tia:Partij/tia:IMKAD_Persoon/tia:GerelateerdPersoon/tia:IMKAD_Persoon/tia:GerelateerdPersoon/tia:IMKAD_Persoon[concat('#', @id) = $root/tia:IMKAD_ZakelijkRecht/tia:Toedeling/tia:verkrijgerRechtRef/@xlink:href and normalize-space(tia:tia_IndGerechtigde) = 'true']"/>
								<xsl:with-param name="rights" select="$root/tia:IMKAD_ZakelijkRecht"/>
								<xsl:with-param name="acquirerParty" select="tia:Partij"/>
				...
				<xsl:for-each select="$numberedRights/tia:IMKAD_ZakelijkRecht">
					...
					<xsl:if test="$processedPersonsRightsGroup and count($processedPersonsRightsGroup/tia:groups/tia:group[1]/tia:IMKAD_ZakelijkRecht[tia:orderNumber = current()/tia:orderNumber]/preceding-sibling::tia:IMKAD_ZakelijkRecht) = 0
						...
						<xsl:apply-templates select="$root" mode="do-allocation-to-different-persons-within-one-party">
							<xsl:with-param name="authorizedRepresentative" select="$currentPartij/tia:Gevolmachtigde"/>
							<xsl:with-param name="acquiringPersons" select="$currentPartij/tia:IMKAD_Persoon[tia:tia_AandeelInRechten and normalize-space(tia:tia_IndGerechtigde) = 'true'] | $currentPartij/tia:IMKAD_Persoon/tia:GerelateerdPersoon/tia:IMKAD_Persoon[tia:tia_AandeelInRechten and normalize-space(tia:tia_IndGerechtigde) = 'true']
																		| $currentPartij/tia:IMKAD_Persoon[concat('#', @id) = $root/tia:IMKAD_ZakelijkRecht/tia:Toedeling/tia:verkrijgerRechtRef/@xlink:href and normalize-space(tia:tia_IndGerechtigde) = 'true'] | $currentPartij/tia:IMKAD_Persoon/tia:GerelateerdPersoon/tia:IMKAD_Persoon[concat('#', @id) = $root/tia:IMKAD_ZakelijkRecht/tia:Toedeling/tia:verkrijgerRechtRef/@xlink:href and normalize-space(tia:tia_IndGerechtigde) = 'true']
																		| $currentPartij/tia:IMKAD_Persoon[concat('#', @id) = $root/tia:IMKAD_ZakelijkRecht/tia:Toedeling/tia:verkrijgerRechtRef/@xlink:href and normalize-space(tia:tia_IndGerechtigde) = 'true'] | $currentPartij/tia:IMKAD_Persoon/tia:GerelateerdPersoon/tia:IMKAD_Persoon/tia:GerelateerdPersoon/tia:IMKAD_Persoon[concat('#', @id) = $root/tia:IMKAD_ZakelijkRecht/tia:Toedeling/tia:verkrijgerRechtRef/@xlink:href and normalize-space(tia:tia_IndGerechtigde) = 'true']"/>
							<xsl:with-param name="acquirerParty" select="$currentPartij"/>
							<xsl:with-param name="isLastGroup" select="$isLastPersonRightsGroup"/>
							<xsl:with-param name="variant" select="'13'"/>
						</xsl:apply-templates>
			...
			<xsl:when test="tia:IMKAD_ZakelijkRecht/tia:verkrijgerRechtRef and translate($isAlocationToSpecificPartiesTheSame, $upper, $lower) = 'false'
				...
				<xsl:variable name="_groupedPersonsAndRights">
					<xsl:for-each select="$groupParties/tia:groups/tia:group">
						<xsl:variable name="_groupPersonsAndRights">
							<xsl:call-template name="groupPersonsAndRights">
								<xsl:with-param name="persons" select="tia:Partij/tia:IMKAD_Persoon[concat('#', @id) = $root/tia:IMKAD_ZakelijkRecht/tia:Toedeling/tia:verkrijgerRechtRef/@xlink:href and normalize-space(tia:tia_IndGerechtigde) = 'true'] | tia:Partij/tia:IMKAD_Persoon[normalize-space(tia:tia_IndGerechtigde) = 'true']/tia:GerelateerdPersoon/tia:IMKAD_Persoon[concat('#', @id) = $root/tia:IMKAD_ZakelijkRecht/tia:Toedeling/tia:verkrijgerRechtRef/@xlink:href and normalize-space(tia:tia_IndGerechtigde) = 'true'] | tia:Partij/tia:IMKAD_Persoon[normalize-space(tia:tia_IndGerechtigde) = 'true']/tia:GerelateerdPersoon/tia:IMKAD_Persoon[normalize-space(tia:tia_IndGerechtigde) = 'true']/tia:GerelateerdPersoon/tia:IMKAD_Persoon[concat('#', @id) = $root/tia:IMKAD_ZakelijkRecht/tia:Toedeling/tia:verkrijgerRechtRef/@xlink:href and normalize-space(tia:tia_IndGerechtigde) = 'true']"/>
								<xsl:with-param name="rights" select="$root/tia:IMKAD_ZakelijkRecht"/>
								<xsl:with-param name="acquirerParty" select="tia:Partij"/>
				...
				<xsl:for-each select="$numberedRights/tia:IMKAD_ZakelijkRecht">
					...
					<xsl:if test="$processedPersonsRightsGroup and count($processedPersonsRightsGroup/tia:groups/tia:group[1]/tia:IMKAD_ZakelijkRecht[tia:orderNumber = current()/tia:orderNumber]/preceding-sibling::tia:IMKAD_ZakelijkRecht) = 0
						...
						<xsl:apply-templates select="$root" mode="do-allocation-to-different-persons-within-one-party">
							<xsl:with-param name="authorizedRepresentative" select="$currentPartij/tia:Gevolmachtigde"/>
							<xsl:with-param name="acquiringPersons" select="$currentPartij/tia:IMKAD_Persoon[concat('#', @id) = $root/tia:IMKAD_ZakelijkRecht/tia:Toedeling/tia:verkrijgerRechtRef/@xlink:href and normalize-space(tia:tia_IndGerechtigde) = 'true'] | $currentPartij/tia:IMKAD_Persoon[normalize-space(tia:tia_IndGerechtigde) = 'true']/tia:GerelateerdPersoon/tia:IMKAD_Persoon[concat('#', @id) = $root/tia:IMKAD_ZakelijkRecht/tia:Toedeling/tia:verkrijgerRechtRef/@xlink:href and normalize-space(tia:tia_IndGerechtigde) = 'true'] | $currentPartij/tia:IMKAD_Persoon[normalize-space(tia:tia_IndGerechtigde) = 'true']/tia:GerelateerdPersoon/tia:IMKAD_Persoon[normalize-space(tia:tia_IndGerechtigde) = 'true']/tia:GerelateerdPersoon/tia:IMKAD_Persoon[concat('#', @id) = $root/tia:IMKAD_ZakelijkRecht/tia:Toedeling/tia:verkrijgerRechtRef/@xlink:href and normalize-space(tia:tia_IndGerechtigde) = 'true']"/>
							<xsl:with-param name="acquirerParty" select="$currentPartij"/>
							<xsl:with-param name="isLastGroup" select="$isLastPersonRightsGroup"/>
							<xsl:with-param name="variant" select="'12'"/>
						</xsl:apply-templates>
	...
	**** matching template ********************************************************************************
	...
	<xsl:template match="tia:StukdeelVerdelingVennootschap | tia:StukdeelVerdelingHuwelijk | tia:StukdeelVerdelingPartnerschap | tia:StukdeelVerdelingGemeenschap | tia:StukdeelVerdelingUittredingVennoten" mode="do-allocation-to-different-persons-within-one-party">
		...
		<xsl:variable name="sortedGroupPersonsAndRights" select="exslt:node-set($_sortedGroupPersonsAndRights)"/>
		<xsl:variable name="isGevolmachtigde">
			<xsl:choose>
				<xsl:when test="not($authorizedRepresentative)">
					<xsl:text>true</xsl:text>
				</xsl:when>
				<xsl:otherwise>
					<xsl:text>false</xsl:text>
			...
			<xsl:when test="count($acquiringPersons) = 1">
				...
				<xsl:if test="$authorizedRepresentative[tia:vertegenwoordigtRef/@xlink:href = concat('#', $acquirerParty/tia:Hoedanigheid[count(tia:wordtVertegenwoordigdRef) = 0]/@id)
					...
					<p>
						...
						<xsl:text> voornoemd, die bij deze </xsl:text>
						<xsl:choose>
							<xsl:when test="count($authorizedRepresentative/tia:GerelateerdPersoon) > 0">
								<xsl:text>verklaren</xsl:text>
							</xsl:when>
							<xsl:otherwise>
								<xsl:text>verklaart</xsl:text>
						...
						<xsl:text> te aanvaarden namens,</xsl:text>
					</p>
				</xsl:if>
				<p>
					<xsl:for-each select="$sortedGroupPersonsAndRights/tia:groups/tia:group">
						...
						<xsl:if test="tia:IMKAD_ZakelijkRecht/tia:Toedeling[tia:verkrijgerRechtRef[@*[translate(local-name(), $upper, $lower) = 'href'] = $personId] and tia:aandeel]">
							<table cellspacing="0" cellpadding="0">
								<tbody>
									<tr>
										<xsl:if test="count($sortedGroupPersonsAndRights/tia:groups/tia:group[concat('#', tia:IMKAD_Persoon/@id) = $personId]) > 1
										...
										<td>
											<xsl:apply-templates select="tia:IMKAD_Persoon" mode="do-allocation-to-different-persons-within-one-party-common">
												...
												<xsl:with-param name="upperCase" select="$isGevolmachtigde"/>
											</xsl:apply-templates>
										</td>
									</tr>
								</tbody>
						...
						<xsl:for-each select="$sortedGroupPersonsAndRights/tia:groups/tia:group">
							...
							<xsl:if test="not(preceding-sibling::tia:group[tia:IMKAD_Persoon[@id = current()/tia:IMKAD_Persoon/@id]
								...
								<table cellspacing="0" cellpadding="0">
									<tbody>
										<tr>
											<xsl:if test="count($sortedGroupPersonsAndRights/tia:groups/tia:group[concat('#', tia:IMKAD_Persoon/@id) = $currentPersonId]) > 1
														and ($acquirerParty/tia:Hoedanigheid[@id = substring-after($authorizedRepresentative/tia:vertegenwoordigtRef/@xlink:href, '#') and tia:wordtVertegenwoordigdRef/@xlink:href = $currentPersonId]
																or $acquirerParty/tia:Hoedanigheid[@id = substring-after($authorizedRepresentative/tia:vertegenwoordigtRef/@xlink:href, '#') and count(tia:wordtVertegenwoordigdRef) = 0])">
												<td class="number" valign="top">
													<xsl:text>-</xsl:text>
												</td>
						...
						<xsl:for-each select="$sortedGroupPersonsAndRights/tia:groups/tia:group">
							...
							<xsl:if test="not(current()/preceding-sibling::tia:group[tia:IMKAD_Persoon[@id = current()/tia:IMKAD_Persoon/@id]
								...
								<table cellspacing="0" cellpadding="0">
									<tbody>
										<tr>
											<xsl:if test="$isGevolmachtigde = 'false'">
												<td class="number" valign="top">
													<xsl:text>-</xsl:text>
												</td>
											</xsl:if>
	...
	<xsl:template match="tia:IMKAD_Persoon" mode="do-allocation-to-different-persons-within-one-party-common">
		...
		<xsl:choose>
			<xsl:when test="(tia:tia_Gegevens/tia:GBA_Ingezetene or tia:tia_Gegevens/tia:IMKAD_KadNatuurlijkPersoon or tia:tia_Gegevens/tia:IMKAD_NietIngezetene)">
				...
				<xsl:choose>
					<xsl:when test="translate($upperCase, $upper, $lower) = 'true'">
