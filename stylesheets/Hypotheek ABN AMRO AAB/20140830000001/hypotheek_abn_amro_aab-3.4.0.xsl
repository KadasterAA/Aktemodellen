...
Version: 3.4.0 (AA-3613: tekstblok aanhef en equivalentieverklaring)
*********************************************************
Description:
...
<xsl:stylesheet xmlns="http://www.w3.org/1999/xhtml"
	...
	<xsl:variable name="keuzeteksten" select="document('keuzeteksten_hypotheek_abn_amro_aab-3.3.0.xml')" />
	<!--
	*********************************************************
	Mode: do-deed
	*********************************************************
