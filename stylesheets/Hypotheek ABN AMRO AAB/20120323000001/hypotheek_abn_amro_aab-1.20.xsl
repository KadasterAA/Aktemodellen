...
<xsl:stylesheet xmlns="http://www.w3.org/1999/xhtml"
	...
	<xsl:variable name="keuzeteksten" select="document('keuzeteksten_hypotheek_abn_amro_aab-1.06.xml')"/>
	<xsl:variable name="documentTitle">
		<xsl:choose>
			...
			<xsl:otherwise><xsl:text>ABN AMRO AAB Hypotheek</xsl:text></xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
