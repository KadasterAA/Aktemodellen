...
Version: 3.5.0 (AA-3613: tekstblok aanhef en equivalentieverklaring)
*********************************************************
Description:
...
<xsl:stylesheet xmlns="http://www.w3.org/1999/xhtml"
	...
	<xsl:include href="hypotheek_abn_amro_generiek-1.82.xsl" />

	<xsl:variable name="keuzeteksten" select="document('keuzeteksten_hypotheek_abn_amro_moneyou-3.4.0.xml')"/>
	<!--
	*********************************************************
	Mode: do-deed
	*********************************************************
