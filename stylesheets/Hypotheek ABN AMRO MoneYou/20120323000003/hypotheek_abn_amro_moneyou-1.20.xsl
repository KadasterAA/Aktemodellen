...
<!--
*********************************************************
Stylesheet: hypotheek_abn_amro_moneyou.xsl
Version: 1.20
*********************************************************
Description:
ABN AMRO MoneYou mortgage deed.
...
<xsl:stylesheet xmlns="http://www.w3.org/1999/xhtml"
	...
	<xsl:include href="hypotheek_abn_amro_generiek-1.20.xsl"/>

	<!-- ABN AMRO MoneYou specific global variables -->
	<xsl:variable name="keuzeteksten" select="document('keuzeteksten_hypotheek_abn_amro_moneyou-1.06.xml')"/>
	<xsl:variable name="documentTitle">
		<xsl:choose>
			...
			<xsl:otherwise><xsl:text>ABN AMRO MoneYou Hypotheek</xsl:text></xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
	...
	*********************************************************
	...
	Description: ABN AMRO MoneyYou mortgage deed.
	...
	**** matching template ********************************************************************************
	...
	<xsl:template match="tia:Bericht_TIA_Stuk" mode="do-deed">
		...
		<xsl:apply-templates select="." mode="do-parties">
			<xsl:with-param name="name-addition" select="'MoneYou'"/>
		</xsl:apply-templates>
		<p><xsl:text>Van gemelde volmacht(en) is mij, notaris genoegzaam gebleken.</xsl:text></p>
		<!-- Details of Mortgage -->
		...
		<table cellspacing="0" cellpadding="0">
			<tbody>
				...
				<tr>
					...
					<td>
						<xsl:text>De schuldenaar verklaarde wegens van MoneYou ter leen ontvangen gelden (hoofdelijk) schuldig te zijn aan MoneYou een bedrag van </xsl:text>
						...
						<xsl:text>. MoneYou verklaarde de hiervoor vermelde schuldbekentenis te aanvaarden.</xsl:text>
					</td>
				</tr>
				<tr>
					<td class="number" valign="top">
					...
					<td>
						<xsl:text>Voorts kunnen te eniger tijd uit hoofde van de onderhavige overeenkomst onder - in alsdan uit te brengen offertes - nader te bepalen voorwaarden eventuele overige uitbetalingen ten behoeve van de schuldenaar geschieden, indien en voorzover MoneYou en de schuldenaar zulks alsdan mochten overeenkomen.</xsl:text>
					</td>
				</tr>
		    	<tr>
					<td class="number" valign="top">
					...
					<td colspan="2">
						<xsl:text>Tot zekerheid voor de terugbetaling van de hoofdsom en de betaling van het verder verschuldigde, waaronder mede begrepen al hetgeen de schuldenaar op grond van het hierboven sub b bepaalde verschuldigd mocht zijn, zal ten behoeve van MoneYou recht van hypotheek casu quo pand worden gevestigd zoals hierna wordt omschreven.</xsl:text> 
						<br/>
						<xsl:text>Met betrekking tot deze lening hebben de comparanten verklaard dat MoneYou en de schuldenaar het volgende zijn overeengekomen.</xsl:text>
					</td>
				</tr>
				<tr>
					<td class="number" valign="top">
			...
			<tbody>
				<tr>
					...
					<td colspan="2">
						...
						<xsl:text>, waaronder begrepen de eventueel krachtens de onderhavige overeenkomst te eniger tijd nader verrichte uitbetalingen en waaronder voorts wordt begrepen al hetgeen aan MoneYou verschuldigd is en zal zijn uit hoofde van eventueel in deze akte genoemde eerder verleden akte(n) van geldlening met hypotheekstelling aangaande het hierna genoemde onderpand;</xsl:text>
		        	</td>
		        </tr>
				<tr>
					<td class="number" valign="top">
					...
					<td>
						<xsl:text>voldoening van de bedongen rente alsmede de eventueel later over een te komen verhoging daarvan;</xsl:text>
					</td>
				</tr>
				<tr>
					<td class="number" valign="top">
					...
					<td>
						<xsl:text>voldoening van alle boeten, kosten en rechten, schadevergoedingen en al hetgeen MoneYou verder uit hoofde van de lening van de schuldenaar te vorderen mocht hebben, welke onder 1 en 2 bedoelde bedragen worden begroot op een totaal bedrag ad </xsl:text>
						<xsl:call-template name="amountText">
		...
		<p>
			<xsl:text>verleent de schuldenaar bij deze aan MoneYou, die van de schuldenaar aanvaardt, het recht van</xsl:text>
		...
		<p><xsl:text>MoneYou verklaarde hierbij alle aan haar gegeven rechten en bevoegdheden te aanvaarden.</xsl:text></p>
