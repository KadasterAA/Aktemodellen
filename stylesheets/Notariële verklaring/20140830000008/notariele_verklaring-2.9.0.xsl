...
Version: 2.9.0 (AA-910: TB Burgerlijke Staat en TB Gevolmachtigde)
*********************************************************
Description:
...
<xsl:stylesheet xmlns="http://www.w3.org/1999/xhtml"
	...
	<xsl:variable name="keuzeteksten" select="document('keuzeteksten-notariele_verklaring-2.9.0.xml')" />
