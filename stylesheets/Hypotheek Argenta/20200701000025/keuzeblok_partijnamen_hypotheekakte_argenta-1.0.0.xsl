...
<!--
*********************************************************
Stylesheet: keuzeblok_partijnamen_hypotheekakte_argenta.xsl
Version: 1.0.0
*********************************************************
Description:
KEUZEBLOK PARTIJNAMEN HYPOTHEEKAKTE - Argenta
	...
	**** matching template ********************************************************************************
	...
	<xsl:template match="tia:Partij" mode="do-keuzeblok-partijnamen-hypotheekakte">
		...
		<xsl:choose>
			...
			<xsl:when test="translate(tia:aanduidingPartij, $upper, $lower) = 'geldnemer of schuldenaar'">
