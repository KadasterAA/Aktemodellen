...
<xsl:stylesheet xmlns="http://www.w3.org/1999/xhtml" xmlns:tia="http://www.kadaster.nl/schemas/KIK/TIA_Algemeen" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:kef="nl.kadaster.xslt.XslExtensionFunctions" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:gc="http://docs.oasis-open.org/codelist/ns/genericode/1.0/" exclude-result-prefixes="tia xsl xlink kef gc" version="1.0">
	...
	<xsl:variable name="keuzeteksten" select="document('keuzeteksten_hypotheek_nibc-2.0.0.xml')"/>
	...
	*********************************************************
	...
	Description: NIBC mortgage deed.
		...
		<table cellspacing="0" cellpadding="0">
			<tbody>
				<tr>
					...
					<td valign="top">
						<xsl:text>NIBC en de Schuldenaar zijn een leningsovereenkomst aangegaan, hierna te noemen: de "Leningsovereenkomst", van welke overeenkomst blijkt uit een door NIBC uitgebracht en door de Schuldenaar geaccepteerd hypotheekaanbod. Een afschrift van het door NIBC en Schuldenaar ondertekend hypotheekaanbod wordt aan deze akte gehecht.</xsl:text>
					</td>
				</tr>
				<tr>
					<td class="number" valign="top">
				...
				<tr>
					<td class="number" valign="top">&#xFEFF;</td>
					<td>
						<xsl:text>De schuldenaar verklaarde wegens van NIBC ter leen ontvangen gelden hoofdelijk schuldig te zijn aan NIBC een bedrag van: </xsl:text>
				...
				<tr>
					<td class="number" valign="top">&#xFEFF;</td>
					<td>
						<xsl:text>NIBC verklaarde de hiervoor vermelde schuldbekentenis te aanvaarden.</xsl:text>
					</td>
				</tr>
				<tr>
					<td class="number" valign="top">&#xFEFF;</td>
					<td>
						<xsl:text>Tot zekerheid voor de betaling van de Schuld is de Schuldenaar met NIBC overeengekomen en heeft zich jegens NIBC verbonden en, voor zover nodig verklaart hierbij met NIBC overeen te komen en zich te verbinden, tot het vestigen en tot het bij voorbaat vestigen van het recht van hypotheek casu quo recht van pand zoals hierna wordt omschreven, ten behoeve van NIBC.</xsl:text>
					</td>
				</tr>
				<tr>
					<td class="number" valign="top">&#xFEFF;</td>
				...
				<tr>
					<td class="number" valign="top">&#xFEFF;</td>
					<td>
						<xsl:text>Onder het begrip "Schuld" wordt in deze akte verstaan: de schulden en verplichtingen tot zekerheid voor de betaling waarvan de Schuldenaar blijkens deze akte aan NIBC het recht van hypotheek op het in deze akte genoemde Onderpand verleent of behoort te verlenen.</xsl:text>
					</td>
				</tr>
							...
							<tbody>
								<tr>
									...
									<td>
										...
										<xsl:text>, (daaronder begrepen de eventueel aan de Schuldenaar terugbetaalde aflossingsbedragen) en voorts de betaling van al hetgeen de Schuldenaar nu of op enig tijdstip in de toekomst al dan niet opeisbaar, voorwaardelijk of onder tijdsbepaling aan NIBC verschuldigd is of zal worden uit hoofde van de Leningsovereenkomst, deze akte, de Algemene Voorwaarden, eerdere met betrekking tot het hierna te noemen Onderpand verstrekte geldleningen, dan wel uit welke hoofde dan ook, tot een bedrag van </xsl:text>
										<xsl:call-template name="amountText">
				...
				<tr>
					...
					<td>
						...
						<xsl:text>, verleent de Hypotheekgever bij deze aan NIBC die van de Hypotheekgever aanvaardt, het recht van </xsl:text>
				...
				<tr>
					<td class="number" valign="top">&#xFEFF;</td>
					<td>
						<xsl:text>Hierna wordt onder Onderpand tevens verstaan ieder ander registergoed waarop hypothecaire zekerheid is gevestigd ten behoeve van NIBC in verband met de Lening.</xsl:text>
					</td>
				</tr>
				<tr>
					<td class="number" valign="top">&#xFEFF;</td>
					<td>
						<xsl:text>De Hypotheekgever staat er voorts jegens NIBC voor in:</xsl:text>
					</td>
				</tr>
				<tr>
					<td class="number" valign="top">&#xFEFF;</td>
						...
						<table cellspacing="0" cellpadding="0">
							<tbody>
								<tr>
									...
									<td valign="top">
										<xsl:text>dat het voormelde Onderpand hem in volle en onbezwaarde eigendom toebehoort, behoudens het (de) eventuele ten behoeve van NIBC eerder gevestigde hypotheekrecht(en) ten laste van de Hypotheekgever, en dat hij daarover de onvoorwaardelijke beschikking heeft;</xsl:text>
									</td>
								</tr>
								<tr>
									<td class="number" valign="top">
								...
								<tr>
									...
									<td>
										<xsl:text>dat het voormelde Onderpand niet anders met recht van hypotheek is of met een tweede recht van hypotheek zal worden bezwaard dan krachtens deze akte, behoudens het (de) eventuele ten behoeve van NIBC eerder gevestigde hypotheekrecht(en) ten laste van de Hypotheekgever.</xsl:text>
									</td>
								</tr>
							</tbody>
						</table>
	...
	*********************************************************
	...
	Description: NIBC mortgage deed rights.
	...
	*********************************************************
	...
	Description: NIBC mortgage deed free text part.
	...
	*********************************************************
	...
	Description: NIBC mortgage deed parties.
		...
		<xsl:choose>
			<xsl:when test="position() = 1">
				<p style="margin-left:30px">
					<xsl:text>hierna te noemen: “NIBC”;</xsl:text>
				</p>
			</xsl:when>
			<xsl:when test="position() = 2">
				<p style="margin-left:30px">
	...
	*********************************************************
	...
	Description: NIBC mortgage deed party persons.
	...
	**** Overbruggingshypotheek      ********************************************************************************
	...
	<xsl:template match="tia:StukdeelHypotheek" mode="do-overbruggingshypotheek">
        ...
        <xsl:text>Voorts verleent de Hypotheekgever tot zekerheid voor de betaling van de Schuld als hiervoor omschreven, bij deze aan NIBC, die van de Hypotheekgever aanvaardt, het recht van </xsl:text>
