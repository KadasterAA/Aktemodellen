	...
	**** matching template ********************************************************************************
	...
	<xsl:template match="tia:Bericht_TIA_Stuk" mode="do-deed">
		...
		<p>
			...
			<xsl:text>NIBC verklaarde de hiervoor vermelde schuldbekentenis te aanvaarden.</xsl:text><br />
		...
		<p>
			<xsl:text>Hierna wordt onder Onderpand tevens verstaan ieder ander registergoed waarop hypothecaire zekerheid is gevestigd ten behoeve van NIBC in verband met de Lening.</xsl:text><br />
