...
<xsl:stylesheet xmlns="http://www.w3.org/1999/xhtml"
	...
	<xsl:include href="tekstblok_aanhef_notariele_verklaring-1.13.xsl" />
	...
	<xsl:variable name="keuzeteksten" select="document('keuzeteksten-notariele_verklaring-1.26.xml')" />
