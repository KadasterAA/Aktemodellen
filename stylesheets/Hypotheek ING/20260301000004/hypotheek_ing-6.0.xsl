...
<xsl:stylesheet xmlns="http://www.w3.org/1999/xhtml" xmlns:tia="http://www.kadaster.nl/schemas/KIK/TIA_Algemeen" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:kef="nl.kadaster.xslt.XslExtensionFunctions" xmlns:exslt="http://exslt.org/common" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:gc="http://docs.oasis-open.org/codelist/ns/genericode/1.0/" exclude-result-prefixes="tia xsl xlink kef gc" version="1.0">
	...
	<xsl:variable name="keuzeteksten" select="document('keuzeteksten_hypotheek_ing-6.0.0.xml')"/>
	...
	**** matching template ********************************************************************************
	...
	<xsl:template match="tia:Bericht_TIA_Stuk" mode="do-deed">
		...
		<p>
			<xsl:text>De comparanten sub 1 en sub 2 hierna gezamenlijk ook te noemen: "Partijen".</xsl:text>
			<br />
		...
		<table cellspacing="0" cellpadding="0">
			<tbody>
				<tr>
					...
					<td>
						<xsl:text>De Bank en de Schuldenaar zijn een leningsovereenkomst aangegaan, hierna te noemen: de "Overeenkomst", van welke Overeenkomst blijkt uit een door de Bank uitgebracht en door de Schuldenaar geaccepteerd bindend aanbod in de zin van artikel 7:122 van het Burgerlijk Wetboek.</xsl:text>
					</td>
				</tr>
				<tr>
					<td class="number" valign="top">
					...
					<td>
						<xsl:text>Blijkens de Overeenkomst verstrekt de Bank aan de Schuldenaar een geldlening voor het hierna te noemen bedrag en is de Schuldenaar verplicht aan de Bank de in deze akte omschreven rechten van hypotheek en pand te (doen) verlenen op de wijze en onder de bepalingen en voorwaarden zoals uiteengezet in deze akte.</xsl:text>
					</td>
				</tr>
				<tr>
					<td class="number" valign="top">
					...
					<td class="number" valign="top">
						<table cellspacing="0" cellpadding="0">
							<tbody>
								<tr>
									...
									<td>
										<p>
											...
											<br/>
											<xsl:text>De Schuldenaar verklaart wegens van de Bank ter leen ontvangen gelden aan de Bank hoofdelijk schuldig te zijn een bedrag van: </xsl:text>
											...
											<br/>
											<xsl:text>Voor het geval de Schuldenaar uit meer personen bestaat is ieder van hen voor het geheel aansprakelijk.</xsl:text>
											<br/>
											<xsl:text>De Bank verklaart de hiervoor vermelde schuldbekentenis te aanvaarden.</xsl:text>
											<br/>
											<xsl:text>Partijen verklaren dat de Bank de Lening aan de Schuldenaar heeft verstrekt onder het beding van hypotheek- en pandverlening overeenkomstig de Overeenkomst, waarvan blijkt uit het eveneens op heden door de Schuldenaar getekende en aan deze akte gehecht exemplaar.</xsl:text>
										</p>
									</td>
								</tr>
								<tr>
									...
									<td>
										...
										<br/>
										<xsl:text>De Lening heeft een looptijd zoals bepaald in de Overeenkomst. De aflossing van de Lening vindt plaats op de wijze die is bepaald in de Overeenkomst.</xsl:text>
										<br/>
										<u>
											<xsl:text>Rente</xsl:text>
										</u>
										<br/>
										<xsl:text>De Schuldenaar is rente over de Lening verschuldigd, die wordt berekend en vastgesteld op de in de Overeenkomst bepaalde wijze.</xsl:text>
										<br/>
										<u>
											<xsl:text>Algemene Voorwaarden</xsl:text>
										</u>
										<br/>
										<xsl:text>De Overeenkomst wordt geacht onderdeel uit te maken van deze akte als ware zij daarin woordelijk opgenomen.</xsl:text>
										<br/>
										<xsl:text>Op de Overeenkomst en op deze akte en de daarbij te verstrekken rechten van hypotheek en pand zijn van toepassing:</xsl:text>
									</td>
								</tr><tr>
										...
										<table cellspacing="0" cellpadding="0">
											<tbody>
												<tr>
													...
													<td>
														<p>
															<xsl:text>De bepalingen in de Overeenkomst,</xsl:text>
														</p>
													</td>
												</tr>
												<tr>
													...
													<td>
														<p>
															<xsl:text>De overige bepalingen vervat in de bij de Overeenkomst door de Bank aan de Schuldenaar verstrekte brochures en documenten, hierna te noemen: "de Basisinformatie",</xsl:text>
														</p>
													</td>
												</tr><tr>
												<td class="number" valign="top">
												...
												<td>
													<p>
														<xsl:text>De Algemene Voorwaarden ING Hypotheken, vastgesteld bij akte op vier maart tweeduizend tien verleden voor mr. M.J.A. Laenen, notaris te Amsterdam, bij afschrift ingeschreven ten kantore van de Dienst voor het kadaster en de openbare registers op achttien juni tweeduizend vijfentwintig in register Onroerende Zaken Hypotheken 3, deel 89519, nummer 72, gedeponeerd ter Griffie van de Rechtbank Amsterdam op vier maart tweeduizend tien onder nummer 32/2010, hierna te noemen: de "Algemene Hypotheekvoorwaarden".</xsl:text>
													</p>
												</td>
											</tr>
											</tbody>
								...
								<td valign="top" class="number">﻿</td>
								<td valign="top" class="number">
										<xsl:text>De bepalingen opgenomen in de onder a. tot en met c. genoemde documenten en de bepalingen opgenomen in deze akte tezamen ook te noemen: "de Voorwaarden".</xsl:text>
										<br/>
										<xsl:text>Bij strijdigheid tussen de bepalingen van de Overeenkomst, de Basisinformatie en de Algemene Hypotheekvoorwaarden gaan de bepalingen van deze offerte voor. Bij strijdigheid tussen de Basisinformatie en Algemene Hypotheekvoorwaarden gaan de bepalingen van de Basisinformatie voor.</xsl:text>
										<br/>
										<xsl:text>De Voorwaarden worden geacht onderdeel te zijn van deze akte als ware zij daarin woordelijk opgenomen. De Hypotheekgever verklaart een exemplaar van de Voorwaarden te hebben ontvangen, van de inhoud daarvan kennis te hebben genomen en met de inhoud in te stemmen.</xsl:text>
										<br/>
										<xsl:text>Een afschrift van de Overeenkomst wordt aan deze akte gehecht.</xsl:text>
										<br/>
										<u><b>
											<xsl:text>Begrippen</xsl:text>
										</b></u>
										<br/>
										<xsl:text>Begrippen die in deze akte worden gebruikt, hebben de betekenis die daaraan is toegekend in de Algemene Hypotheekvoorwaarden, ook indien deze in de Algemene Hypotheekvoorwaarden met kleine letter zijn gedefinieerd en in de akte met hoofdletter zijn aangeduid, tenzij in deze akte anders is bepaald of uit de strekking van deze akte het tegendeel voortvloeit.</xsl:text>
										<br/>
										<xsl:text>Titels en kopjes dienen slechts ter identificatie en zijn zij niet van invloed op de uitleg van deze akte of de Overeenkomst.</xsl:text>
										<xsl:if test="translate(tia:IMKAD_AangebodenStuk/tia:tia_TekstKeuze[translate(tia:tagNaam, $upper, $lower) = 'k_svnstarterslening']/tia:tekst, $upper, $lower) = 'true'">
											...
											<br/>
											<xsl:text>In verband met de door de Stichting Stimuleringsfonds Volkshuisvesting Nederlandse Gemeenten (hierna te noemen: "SVn") te verstrekken Starterslening, heeft de Bank zich jegens SVn en Stichting Waarborgfonds Eigen Woningen, hierna te noemen: "WEW", verplicht, na het ingaan van de Lening geen gelden meer onder verband van de eerste hypotheekstelling ter leen te verstrekken aan de Schuldenaar. Tevens heeft de Bank zich jegens SVn en WEW verplicht reeds afgeloste bedragen op de Lening, onder verband van de eerste hypotheekstelling, niet opnieuw te laten opnemen door de Schuldenaar. Voormelde verplichtingen rusten uitsluitend op de Bank zolang de bij SVn aangegane Starterslening niet volledig is afgelost.</xsl:text>
										</xsl:if>
									</td>
								</tr>
							</tbody>
							...
							<tbody>
										...
										<table cellspacing="0" cellpadding="0">
											<tbody>
												<tr>
													...
													<td>
														<p>
															...
															<xsl:text>, (daaronder begrepen de eventueel aan de Schuldenaar terugbetaalde aflossingsbedragen) en voorts de betaling van al hetgeen de Schuldenaar nu of op enig tijdstip in de toekomst al dan niet opeisbaar, voorwaardelijk of onder tijdsbepaling aan de Bank verschuldigd is of zal worden uit hoofde van verstrekte en/of alsnog te verstrekken geldleningen, verleende en/of alsnog te verlenen kredieten in rekeningcourant of uit welke hoofde dan ook, tot een bedrag van </xsl:text>
															<xsl:call-template name="amountText">
												...
												<tr>
													...
													<td>
														<p>
															<xsl:text>de betaling van de rente (inclusief overeen te komen verhogingen), vertragingsrente, kosten, schadevergoedingen en/of andere vergoedingen nu of in de toekomst aan de Bank verschuldigd uit hoofde van de Overeenkomst en de betaling van al hetgeen de Bank overigens uit hoofde van de Overeenkomst, deze akte of de Algemene Hypotheekvoorwaarden van de Schuldenaar te vorderen mocht hebben, welke in deze paragraaf b bedoelde bedragen gezamenlijk worden begroot op een bedrag van </xsl:text>
															<xsl:call-template name="amountText">
															...
															<xsl:text>, zijnde vijfendertig procent (35%) van het laatst genoemde bedrag (de hiervoor onder a. en b. genoemde bedragen in deze akte aangeduid als "het Verschuldigde"),</xsl:text>
														</p>
													</td>
												</tr>
											</tbody>
								...
								<tr>
									...
									<td>
										...
										<xsl:text>, verleent de Hypotheekgever bij deze aan de Bank die van de Hypotheekgever aanvaardt, het recht van </xsl:text>
										...
										<xsl:text>hypotheek op het hierna te omschrijven registergoed, hierna tezamen met de in de Algemene Hypotheekvoorwaarden omschreven roerende zaken te noemen het "Onderpand":</xsl:text>
									</td>
								</tr>
								<tr>
									<td class="number" valign="top">
								...
								<td>
									<xsl:text>Ten aanzien van het Verschuldigde strekt een door de Bank getekend uittreksel uit haar administratie tot volledig bewijs, behoudens tegenbewijs, in welk geval de betalingsverplichting niet wordt opgeschort.</xsl:text>
								</td>
							</tr>
							</tbody>
						</table>
	...
	*********************************************************
	...
	Description: ING mortgage deed free text part.
					...
					<tbody>
						<tr>
							...
							<td>
								...
								<xsl:text>, hierna te noemen: "de Bank" of "de Hypotheekhouder";</xsl:text>
							</td>
						</tr>
					</tbody>
				</table>
	...
	**** Overbruggingshypotheek      ********************************************************************************
	...
	<xsl:template match="tia:StukdeelHypotheek" mode="do-overbruggingshypotheek">
			...
			<br />
			<xsl:text>Voorts verleent de Hypotheekgever tot zekerheid voor de betaling van het Verschuldigde als hiervoor omschreven, bij deze aan de Bank die van de Hypotheekgever aanvaardt, het recht van </xsl:text>
