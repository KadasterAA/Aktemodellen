...
Version: 4.0
- [AA-8553] Stater generiek aanpassen
*************************************************************
...
<xsl:stylesheet xmlns="http://www.w3.org/1999/xhtml" xmlns:tia="http://www.kadaster.nl/schemas/KIK/TIA_Algemeen" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:kef="nl.kadaster.xslt.XslExtensionFunctions" xmlns:exslt="http://exslt.org/common" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:gc="http://docs.oasis-open.org/codelist/ns/genericode/1.0/" exclude-result-prefixes="tia xsl xlink kef gc" version="1.0">
	...
	<xsl:variable name="keuzeteksten" select="document('keuzeteksten_hypotheek_stater-3.0.0.xml')"/>
	...
	<xsl:variable name="naamGeldverstrekker" select="$verkrijgerPartij/tia:aanduidingPartij"/>
	<xsl:variable name="naamGeldverstrekkerMetHoofdletter" select="concat(translate(substring($naamGeldverstrekker, 1, 1), $lower, $upper), substring($naamGeldverstrekker, 2))"/>
	<!--
	*********************************************************
	Mode: do-deed
	*********************************************************
	...
	Description: Stater mortgage deed.
		...
		<table cellspacing="0" cellpadding="0">
			<tbody>
				<tr>
					...
					<td>
						<xsl:value-of select="$naamGeldverstrekkerMetHoofdletter"/>
