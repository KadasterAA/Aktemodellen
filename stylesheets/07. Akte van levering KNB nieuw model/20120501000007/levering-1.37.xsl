...
<xsl:stylesheet xmlns="http://www.w3.org/1999/xhtml"
	...
	<xsl:include href="tekstblok_partij_natuurlijk_persoon-1.14.xsl"/>
	<xsl:include href="tekstblok_partij_niet_natuurlijk_persoon-1.17.xsl"/>
	<xsl:include href="tekstblok_recht-1.06.xsl"/>
	<xsl:include href="tekstblok_rechtspersoon-1.09.xsl"/>
	<xsl:include href="tekstblok_registergoed-1.16.xsl"/>	
	<xsl:include href="tekstblok_vof_cv_ms-1.02.xsl"/>
