...
<xsl:stylesheet xmlns="http://www.w3.org/1999/xhtml"
	...
	<xsl:variable name="keuzeteksten" select="document('keuzeteksten_hypotheek_particulier-1.27.xml')" />
	...
	<xsl:template match="tia:Bericht_TIA_Stuk" mode="do-deed">
		...
		<p>
			<xsl:if test="tia:IMKAD_AangebodenStuk/tia:tia_TekstKeuze[translate(tia:tagNaam, $upper, $lower) = 'k_genoegzaam']/tia:tekst = 'true'">
				...
				<xsl:text> aan de comparanten onder 2. genoemd is mij, notaris, genoegzaam gebleken.</xsl:text>
			</xsl:if>
			<br />
