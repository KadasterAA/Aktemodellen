...
<!--
*********************************************************
Stylesheet: keuzeblok_partijnamen_hypotheekakte_syntrus-achmea.xsl
Version: 1.0.0
*********************************************************
Description:
	...
	**** matching template ********************************************************************************
	...
	<xsl:template match="tia:Partij" mode="do-keuzeblok-partijnamen-hypotheekakte">
		...
		<xsl:choose>
			...
			<xsl:when test="translate(tia:aanduidingPartij, $upper, $lower) = 'hypotheekgever en/of schuldenaar'">
				...
				<xsl:text>ook te noemen: de 'hypotheekgever' en/of 'schuldenaar'</xsl:text>
			</xsl:when>
			...
			<xsl:when test="translate(tia:aanduidingPartij, $upper, $lower) = 'aanduiding per persoon'">
				...
				<xsl:if test="(not($existGevolmachtigde) and $number) or $name">
					...
					<xsl:text>ook te noemen: de 'hypotheekgever' en </xsl:text>
					<xsl:if test="$number">
						<xsl:text>de verschenen </xsl:text>
						<xsl:choose>
