...
<!--
*********************************************************
AA-4497 Syntrus Achmea - 
AA-4482 Syntrus Achmea - Afbreekstreepje bij 'hypotheek –en pandverlening' staat verkeerd.
AA-4485 Syntrus Achmea - Tekstcorrectie quootjes bij de Verzekeraar
*********************************************************
...
<xsl:stylesheet xmlns="http://www.w3.org/1999/xhtml" xmlns:tia="http://www.kadaster.nl/schemas/KIK/TIA_Algemeen" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:exslt="http://exslt.org/common" xmlns:kef="nl.kadaster.xslt.XslExtensionFunctions" xmlns:gc="http://docs.oasis-open.org/codelist/ns/genericode/1.0/" exclude-result-prefixes="tia xsl exslt xlink gc" version="1.0">
	...
	<xsl:variable name="keuzeteksten" select="document('keuzeteksten_hypotheek_syntrus_achmea-1.0.0.xml')"/>
	...
	**** matching template ********************************************************************************
	...
	<xsl:template match="tia:Bericht_TIA_Stuk" mode="do-deed">
		...
		<h3>
			<xsl:text>GELDLENING EN ZEKERHEDEN </xsl:text>
		</h3>
		<table cellspacing="0" cellpadding="0">
			<tbody>
				...
				<tr>
					...
					<td class="number" colspan="2" valign="top">
				...
				<tr>
					<td class="number" valign="top">
						<xsl:choose>
							<xsl:when test="translate(tia:IMKAD_AangebodenStuk/tia:tia_TekstKeuze[translate(tia:tagNaam, $upper, $lower) = 'k_svnstarterslening']/tia:tekst, $upper, $lower) = 'true'">
								<xsl:text>G</xsl:text>
							</xsl:when>
							<xsl:otherwise>
								<xsl:text>F</xsl:text>
