...
Version: 4.0.0 (AA-3913)
Date: 2018-07-20
*********************************************************
Description:
Hypotheek Rabobank Modeldocument versie 4.0.0
...
-->
<xsl:stylesheet xmlns="http://www.w3.org/1999/xhtml" xmlns:tia="http://www.kadaster.nl/schemas/KIK/TIA_Algemeen" xmlns:rabo="http://www.kadaster.nl/schemas/KIK/RabobankHypotheekakte/v20100406" xmlns:kef="nl.kadaster.xslt.XslExtensionFunctions" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:gc="http://docs.oasis-open.org/codelist/ns/genericode/1.0/" exclude-result-prefixes="tia rabo kef xsl xlink gc" version="1.0">
	...
	<xsl:variable name="keuzeteksten" select="document('keuzeteksten_hypotheek_rabobank-4.0.0.xml')"/>
				...
				<xsl:when test="$vasteHypotheekSchip/rabo:vasteHypotheek/rabo:Financieringsvoorstel or $vasteHypotheekSchip/rabo:vasteHypotheek/rabo:FinancieringsvoorstelAcceptatie">
					<xsl:choose>
						<xsl:when test="count($vasteHypotheekSchip/rabo:vasteHypotheek/rabo:Financieringsvoorstel/rabo:datum) = 1">
							<xsl:text>het overeenkomst zakelijke financiering </xsl:text>
						</xsl:when>
						<xsl:otherwise>
							<xsl:text>de overeenkomsten zakelijke financiering </xsl:text>
						</xsl:otherwise>
					</xsl:choose>
