...
Version: 3.12.0 (AA-3748: keuzeteksten_hypotheek_rabobank-3.10.0.xml, tekstblok burgerlijke staat)
Date: 2018-04-06
*********************************************************
Description:
...
<xsl:stylesheet xmlns="http://www.w3.org/1999/xhtml"
	...
	<xsl:variable name="keuzeteksten" select="document('keuzeteksten_hypotheek_rabobank-3.10.0.xml')" />
