...
<!--
*************************************************************
Stylesheet: hypotheek_neo.xsl
Version: 1.0.1
[AA-6591] Neo: 3 stylesheet bevindingen
*************************************************************
...
<xsl:stylesheet xmlns="http://www.w3.org/1999/xhtml" xmlns:tia="http://www.kadaster.nl/schemas/KIK/TIA_Algemeen" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:kef="nl.kadaster.xslt.XslExtensionFunctions" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:gc="http://docs.oasis-open.org/codelist/ns/genericode/1.0/" exclude-result-prefixes="tia xsl xlink kef gc" version="1.0">
	...
	<xsl:variable name="keuzeteksten" select="document('keuzeteksten_hypotheek_neo-1.0.0.xml')"/>
	...
	**** matching template ********************************************************************************
	...
	<xsl:template match="tia:Bericht_TIA_Stuk" mode="do-deed">
		...
		<p>
			<xsl:text>Van het bestaan van de (mondelinge) volmacht van Neo Hypotheken aan de comparant</xsl:text>
			<xsl:if test="translate(tia:IMKAD_AangebodenStuk/tia:Partij[2]/tia:Gevolmachtigde/tia:gegevens/tia:persoonGegevens/tia:geslacht/tia:geslachtsaanduiding,$upper,$lower) = 'vrouw'">
				<xsl:text>e</xsl:text>
			</xsl:if>
		...
		<p>
			<strong>
				<xsl:text>Artikel 1 Overeenkomst van geldlening</xsl:text>
			</strong>
		</p>
		<p>
			<xsl:text>Neo Hypotheken en de Schuldenaar zijn een leningsovereenkomst met hypotheekstelling en inpandgeving aangegaan, hierna te noemen: de "Leningsovereenkomst", van welke overeenkomst blijkt uit een aan de minuut van deze akte gehecht, door de Schuldenaar/Hypotheekgever ondertekend document genaamd ‘hypotheekaanbod’ (bijlage). Ter uitvoering van de Leningsovereenkomst verstrekt Neo Hypotheken aan de Schuldenaar een geldlening voor het hierna te noemen bedrag en is de Schuldenaar verplicht aan Neo Hypotheken de in deze akte omschreven rechten van hypotheek en pand te (doen) vestigen op de wijze en onder de bepalingen en voorwaarden als uiteengezet in deze akte.</xsl:text>
		</p>
		<p>
			<strong>
				<xsl:text>Artikel 2 Lening</xsl:text>
			</strong>
		</p>
		<p>
			<xsl:text>De Schuldenaar verklaarde wegens van Neo Hypotheken ter leen ontvangen gelden hoofdelijk schuldig te zijn aan Neo Hypotheken een bedrag van: </xsl:text>
		...
		<p>
			<xsl:text>Neo Hypotheken verklaarde de hiervoor vermelde schuldbekentenis te aanvaarden.</xsl:text>
		</p>
		<p>
			<strong>
				<xsl:text>Artikel 3 Gegevens van de Lening</xsl:text>
			</strong>
		</p>
		<p>
			<xsl:text>Voor wat betreft de (verdere) gegevens (zoals o.a. looptijd, aflossing, rente) en voorwaarden van de Lening wordt verwezen naar de aan deze akte gehechte Leningsovereenkomst en de hierna onder 8 vermelde Algemene Voorwaarden NEO Hypotheken.</xsl:text>
		</p>
		...
		<p>
			<strong>
				<xsl:text>Artikel 4 Hypotheekstelling, maximum bedrag hypotheekverlening, voorafgaande verkrijging</xsl:text>
			</strong>
		</p>
		<p>
		...
		<table cellspacing="0" cellpadding="0">
			<tbody>
				<tr>
					...
					<td colspan="2">
						<xsl:text>de (terug)betaling van de Lening en de eventueel later overeen te komen verhoging daarvan (waaronder begrepen de eventueel aan de Schuldenaar terugbetaalde aflossingsbedragen) alsmede de terugbetaling van al hetgeen NEO Hypotheken blijkens haar administratie van de Schuldenaar te vorderen heeft of mocht hebben, uit hoofde van verstrekte en/of alsnog te verstrekken geldleningen, verleende en/of alsnog te verlenen kredieten in rekening-courant, vorderingen op de Schuldenaar die </xsl:text>
						<i>
							<xsl:text>NEO Hypotheken </xsl:text>
						</i>
						<xsl:text>van derden heeft overgenomen, tegenwoordige en/of toekomstige borgstellingen, of uit welken anderen hoofde, tot een bedrag van </xsl:text>
						<xsl:call-template name="amountText">
				...
				<tr>
					...
					<td colspan="2">
						<xsl:text>de betaling van:</xsl:text>
					</td>
				</tr>
				<tr>
					<td class="number" valign="top">
					...
					<td>
						<xsl:text>de bedongen rente over de Lening en de eventueel later overeen gekomen verhoging daarvan (ook indien deze betrekking heeft op een periode langer dan drie jaren), 
					</xsl:text>
					</td>
				</tr>
				<tr>
					...
					<td>
						<xsl:text>de eventueel verschuldigde extra rente,</xsl:text>
					</td>
				</tr>
				<tr>
					<td class="number" valign="top">
					...
					<td>
						<xsl:text>voldoening van alle boeten, vergoedingen en kosten (waaronder begrepen de eventuele buitengerechtelijke kosten conform de Wet normering buitengerechtelijke kosten (Stb. 2012, 140) en de staffel van het bijbehorende Besluit vergoeding voor buitengerechtelijke incassokosten (Stb. 2012, 141) en al hetgeen de Schuldenaar verder krachtens deze akte en de hierna te noemen Algemene Voorwaarden verschuldigd is of wordt, welke onder a, b en c genoemde bedragen samen worden begroot op veertig procent (40%) van het onder I genoemde bedrag, oftewel: </xsl:text>
						<xsl:call-template name="amountText">
		...
		<p>
			<xsl:text>dus in totaal (lees; de onder a en b genoemde bedragen gezamenlijk) voor een maximumbedrag van </xsl:text>
			<xsl:call-template name="amountText">
			...
			<xsl:text>, wordt bij dezen door de Schuldenaar aan NEO Hypotheken het recht van </xsl:text>
			...
			<xsl:text>hypotheek verleend op </xsl:text>
			<xsl:value-of select="tia:IMKAD_AangebodenStuk/tia:StukdeelHypotheek[not(tia:aanduidingHypotheek) or normalize-space(tia:aanduidingHypotheek) = '']/tia:tekstkeuze[translate(tia:tagNaam, $upper, $lower) = 'k_registergoedhypotheek']/tia:tekst"/>
			<xsl:text>:</xsl:text>
		</p>
		<!-- Registered objects -->
		...
		<p>
			<xsl:text>hierna te noemen het "Onderpand".</xsl:text>
		</p>
		<!-- Bridging mortgage -->
		<xsl:if test="tia:IMKAD_AangebodenStuk/tia:StukdeelHypotheek[translate(tia:aanduidingHypotheek, $upper, $lower) = 'overbruggingshypotheek']">
			<p>
				<strong>
					<xsl:text>Artikel 5 Overbrugging</xsl:text>
				</strong>
			</p>
			<p>
				<xsl:text>Tot meerdere zekerheid voor de voldoening van de in artikel 4 genoemde bedragen wordt door Schuldenaar/Hypotheekgever tevens een recht van </xsl:text>
				...
				<xsl:text> hypotheek verleend op </xsl:text>
				<xsl:value-of select="tia:IMKAD_AangebodenStuk/tia:StukdeelHypotheek[translate(tia:aanduidingHypotheek, $upper, $lower) = 'overbruggingshypotheek']/tia:tekstkeuze[translate(tia:tagNaam, $upper, $lower) = 'k_registergoedoverbrugging']/tia:tekst"/>
				<xsl:text>:</xsl:text>
			</p>
			<!-- Registered objects -->
			<a name="hyp3.rights" class="location">&#160;</a>
			...
			<p>
				<xsl:text>hierna te noemen het "Onderpand II".</xsl:text>
			</p>
		</xsl:if>
	...
	<xsl:template match="tia:Partij" mode="do-parties">
		...
		<xsl:choose>
			<xsl:when test="position() = 1">
				...
				<p style="margin-left:30px">
					<xsl:text>de “Schuldenaar” en tevens te noemen: de “Hypotheekgever”.</xsl:text>
				</p>
			</xsl:when>
			<xsl:when test="position() = 2">
				<p style="margin-left:30px">
					<xsl:text>hierna te noemen: “Neo Hypotheken”;</xsl:text>
				</p>
			</xsl:when>
		</xsl:choose>
	</xsl:template>
