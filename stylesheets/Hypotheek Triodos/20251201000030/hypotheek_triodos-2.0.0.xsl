...
<!--
*************************************************************
Stylesheet: hypotheek_triodos.xsl
Version: 2.0.0
*************************************************************
Public:
(mode) do-deed
...
<xsl:stylesheet xmlns="http://www.w3.org/1999/xhtml" xmlns:tia="http://www.kadaster.nl/schemas/KIK/TIA_Algemeen" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:kef="nl.kadaster.xslt.XslExtensionFunctions" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:gc="http://docs.oasis-open.org/codelist/ns/genericode/1.0/" exclude-result-prefixes="tia xsl xlink kef gc" version="1.0">
	...
	<xsl:variable name="keuzeteksten" select="document('keuzeteksten_hypotheek_triodos-2.0.0.xml')"/>
	...
	*********************************************************
	...
	Description: Triodos mortgage deed.
	...
	**** matching template ********************************************************************************
	...
	<xsl:template match="tia:Bericht_TIA_Stuk" mode="do-deed">
		...
		<table cellspacing="0" cellpadding="0">
			<tbody>
				<tr>
					...
					<td>
						<xsl:text>De geldgever en de Schuldenaar zijn een leningsovereenkomst aangegaan, hierna te noemen: de "Leningsovereenkomst", van welke overeenkomst blijkt uit een door de geldgever uitgebracht en door de Schuldenaar geaccepteerd hypotheekaanbod. Een afschrift van het door de geldgever en Schuldenaar ondertekend hypotheekaanbod wordt aan deze akte gehecht.</xsl:text>
					</td>
				</tr><tr>
				<td class="number" valign="top">
					<xsl:text>-</xsl:text>
		...
		<p>
			<xsl:text>De Schuldenaar verklaarde wegens van de geldgever ter leen ontvangen gelden hoofdelijk schuldig te zijn aan de geldgever een bedrag van: </xsl:text>
			...
			<xsl:text> (hierna te noemen: de "Lening"). De geldgever verklaarde de hiervoor vermelde schuldbekentenis te aanvaarden.</xsl:text><br />
			<xsl:text>Tot zekerheid voor de betaling van de Schuld is de Schuldenaar met de geldgever overeengekomen en heeft zich jegens de geldgever verbonden en, voor zover nodig verklaart hierbij met de geldgever overeen te komen en zich te verbinden, tot het vestigen en tot het bij voorbaat vestigen van het recht van hypotheek casu quo recht van pand zoals hierna wordt omschreven, ten behoeve van de geldgever.</xsl:text>
		</p>
		<p>
			<u><xsl:text>GEGEVENS VAN DE LENING</xsl:text></u>
		</p>
		<p>
			<u><xsl:text>Looptijd en aflossing</xsl:text></u>
		</p>
		<p>
			<xsl:text>De Lening heeft een looptijd zoals in de Leningsovereenkomst is overeengekomen, dan wel eventueel nader tussen partijen (zal worden) overeengekomen. De aflossing van de Lening vindt plaats op de wijze als bepaald in de aan deze akte gehechte Leningsovereenkomst, de algemene voorwaarden van geldlening en zekerheidsstelling van de geldgever (hierna te noemen: de "Algemene Voorwaarden") welke zijn gehecht aan de Leningsovereenkomst, en/ of op een nader door partijen overeen te komen wijze.</xsl:text>
		</p>
		<p>
		...
		<p>
			<xsl:text>Onder het begrip "Schuld" wordt in deze akte verstaan: de schulden en verplichtingen tot zekerheid voor de betaling waarvan de Schuldenaar blijkens deze akte aan de geldgever het recht van hypotheek op het in deze akte genoemde Onderpand verleent of behoort te verlenen.</xsl:text>
		</p>
		<xsl:if test="translate(tia:IMKAD_AangebodenStuk/tia:tia_TekstKeuze[translate(tia:tagNaam, $upper, $lower) = 'k_svnstarterslening']/tia:tekst, $upper, $lower) = 'true'">
			...
			<p>
				<xsl:text>In verband met de door de Stichting Stimuleringsfonds Volkshuisvesting Nederlandse Gemeenten (SVn) te verstrekken Starterslening, heeft de geldgever zich jegens SVn en Stichting Waarborgfonds Eigen Woningen (WEW) verplicht, na het ingaan van de lening geen gelden meer onder verband van de eerste hypotheekstelling ter leen te verstrekken of een aanvullende ‘Combinatielening’ aan de schuldenaar te verstrekken. Tevens heeft de geldgever zich jegens SVn en WEW verplicht reeds afgeloste bedragen op de lening, onder verband van de eerste hypotheekstelling, niet opnieuw te laten opnemen door de schuldenaar. Voormelde verplichtingen rusten op de geldgever uitsluitend zolang de bij SVn aangegane Starterslening niet volledig is afgelost.</xsl:text>
			</p>
		</xsl:if>
		<p>		
			<u><xsl:text>HYPOTHEEKRECHT</xsl:text></u>
		</p>
		<p>
			...
			<tbody>
				<tr>
					...
					<td valign="top">
						...
						<xsl:text> (daaronder begrepen de eventueel aan de Schuldenaar terugbetaalde aflossingsbedragen) en voorts de betaling van al hetgeen de Schuldenaar nu of op enig tijdstip in de toekomst al dan niet opeisbaar, voorwaardelijk of onder tijdsbepaling aan de geldgever verschuldigd is of zal worden uit hoofde van de Leningsovereenkomst, deze akte, de Algemene Voorwaarden, eerdere met betrekking tot het hierna te noemen Onderpand verstrekte geldleningen, dan wel uit welke hoofde dan ook, tot een bedrag van </xsl:text>
						<xsl:call-template name="amountText">
				...
				<td class="number" valign="top">
					...
					<xsl:text>, zijnde veertig procent (40%) van het hiervoor genoemde bedrag;</xsl:text>
				</td>
			</tr>
			</tbody>
		</table>
		...
		<xsl:call-template name="amountNumber">
			...
			<xsl:text>, verleent de Hypotheekgever bij deze aan de geldgever die van de Hypotheekgever aanvaardt, het recht van </xsl:text>
		...
		<p>
			<xsl:text>Hierna wordt onder Onderpand tevens verstaan ieder ander registergoed waarop hypothecaire zekerheid is gevestigd ten behoeve van de geldgever in verband met de Lening.</xsl:text>
		</p>
		<p>
			<xsl:text>De Hypotheekgever staat er voorts jegens de geldgever voor in:</xsl:text>
		</p>
		<table cellspacing="0" cellpadding="0">
			<tbody>
				<tr>
					...
					<td valign="top">
						<xsl:text>dat het voormelde Onderpand hem in volle en onbezwaarde eigendom toebehoort, behoudens het (de) eventuele ten behoeve van de geldgever eerder gevestigde hypotheekrecht(en) ten laste van de Hypotheekgever, en dat hij daarover de onvoorwaardelijke beschikking heeft;</xsl:text>
					</td>
				</tr><tr>
					<td class="number" valign="top">
						<xsl:text>b.</xsl:text>
					...
					<td class="number" valign="top">
						...
						<xsl:text>dat het voormelde Onderpand niet anders met recht van hypotheek is of met een tweede recht van hypotheek zal worden bezwaard dan krachtens deze akte, behoudens het (de) eventuele ten behoeve van de geldgever eerder gevestigde hypotheekrecht(en) ten laste van de Hypotheekgever.</xsl:text>
				</td>
			</tr>
			</tbody>
		</table>
		<p>
			<xsl:text>De Hypotheekgever en de geldgever komen hierbij overeen dat, indien de geldgever(een deel van) haar vordering(en) tot zekerheid waarvan onderhavig hypotheekrecht wordt gevestigd, overdraagt aan een derde, op deze derde tevens een met (het overgedragen deel van) deze vordering(en) evenredig deel van het hiervoor bedoelde hypotheekrecht als nevenrecht zal overgaan.</xsl:text>
		</p>
	...
	*********************************************************
	...
	Description: Triodos mortgage deed rights.
	...
	*********************************************************
	...
	Description: mortgage deed free text part.
	...
	*********************************************************
	...
	Description: mortgage deed parties.
		...
		<xsl:choose>
			<xsl:when test="position() = 1">
				<p style="margin-left:30px">
					<xsl:text>hierna te noemen: "de geldgever";</xsl:text>
				</p>
			</xsl:when>
			<xsl:when test="position() = 2">
				<p style="margin-left:30px">
	...
	*********************************************************
	...
	Description: mortgage deed party persons.
	...
	**** Overbruggingshypotheek      ********************************************************************************
	...
	<xsl:template match="tia:StukdeelHypotheek" mode="do-overbruggingshypotheek">
		...
		<p>
			<xsl:text>Voorts verleent de Hypotheekgever tot zekerheid voor de betaling van de Schuld als hiervoor omschreven, bij deze aan de geldgever, die van de Hypotheekgever aanvaardt, het recht van </xsl:text>
