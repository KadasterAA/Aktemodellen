...
Version: 4.0.0
Wijzigingen:
- AA-4402 Regiobank - bijwerken naar nieuwste versies tekstblokken
- AA-3326 Regiobank - Afsluitend karakter na tekstblok registergoed wordt verkeerd getoond
- AA-4233 Regiobank - Stylesheet aanpassen naar algemene waardelijst met nnp-kodes
- AA7851 - bijwerken naar nieuwste tekstblokken
*************************************************************
...
<xsl:stylesheet xmlns="http://www.w3.org/1999/xhtml" xmlns:tia="http://www.kadaster.nl/schemas/KIK/TIA_Algemeen" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:kef="nl.kadaster.xslt.XslExtensionFunctions" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:gc="http://docs.oasis-open.org/codelist/ns/genericode/1.0/" exclude-result-prefixes="tia xsl xlink kef gc" version="1.0">
	...
	<xsl:variable name="keuzeteksten" select="document('keuzeteksten_hypotheek_regiobank-3.0.0.xml')"/>
