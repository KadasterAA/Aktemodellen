...
Version: 2.1.0
AA-4618 - Munt - Tekstuele wijzigingen
*************************************************************
	...
	**** Overbruggingshypotheek      ********************************************************************************
	...
	<xsl:template match="tia:StukdeelHypotheek" mode="do-overbruggingshypotheek">
		...
		<table cellspacing="0" cellpadding="0">
			<tbody>
				<tr>
					<td colspan="3"><xsl:text>De Hypotheekgever staat er voorts jegens MUNT Hypotheken voor in:</xsl:text></td>
				</tr>
				<tr>
					<td class="number" valign="top">
						<xsl:text>&#xFEFF;</xsl:text>
