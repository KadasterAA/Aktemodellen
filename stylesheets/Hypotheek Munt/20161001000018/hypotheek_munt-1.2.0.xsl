...
Version: 1.2.0 (AA-3613: tekstblok aanhef en equivalentieverklaring)
*************************************************************
...
<xsl:stylesheet xmlns="http://www.w3.org/1999/xhtml" xmlns:tia="http://www.kadaster.nl/schemas/KIK/TIA_Algemeen" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:kef="nl.kadaster.xslt.XslExtensionFunctions" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:gc="http://docs.oasis-open.org/codelist/ns/genericode/1.0/" exclude-result-prefixes="tia xsl xlink kef gc" version="1.0">
	...
	<xsl:variable name="keuzeteksten" select="document('keuzeteksten_hypotheek_munt-1.0.0.xml')"/>
		...
		<table cellspacing="0" cellpadding="0">
			<tbody>
				<tr>
					...
					<td>MUNT Hypotheken en de Schuldenaar zijn een leningsovereenkomst aangegaan,  hierna te noemen: de "Leningsovereenkomst", van welke overeenkomst blijkt uit een door MUNT Hypotheken uitgebracht en door de Schuldenaar geaccepteerd hypotheekaanbod. Een afschrift van het door MUNT Hypotheken en Schuldenaar ondertekend hypotheekaanbod wordt aan deze akte gehecht. </td>
				</tr>
				<tr>
					<td class="number" valign="top">
						<xsl:text>&#xFEFF;</xsl:text>
...
Tot zekerheid voor de betaling van de Schuld is de Schuldenaar met MUNT Hypotheken overeengekomen en heeft zich jegens MUNT Hypotheken verbonden en, voor zover nodig verklaart hierbij met MUNT Hypotheken overeen te komen en zich te verbinden, tot het vestigen en tot het bij voorbaat vestigen van het recht van hypotheek casu quo recht van pand zoals hierna wordt omschreven, ten behoeve van MUNT Hypotheken.
		...
		<p>
			<xsl:text>Hierna wordt onder Onderpand tevens verstaan ieder ander registergoed waarop hypothecaire zekerheid is gevestigd ten behoeve van MUNT Hypotheken in verband met de Lening.</xsl:text> <br/>
		...
		<table cellspacing="0" cellpadding="0">
			<tbody>
				...
				<tr>
					...
					<td valign="top">
						<xsl:text>dat het voormelde Onderpand niet anders met recht van hypotheek is of kan worden bezwaard dan krachtens deze akte, behoudens het (de) eventuele ten behoeve van MUNT Hypotheken eerder gevestigde hypotheekrecht(en) ten laste van de Hypotheekgever.</xsl:text>
					</td>
				</tr>
			</tbody>	
		</table>
		<p>
			<xsl:text>De Hypotheekgever en MUNT Hypotheken komen hierbij overeen dat, indien MUNT Hypotheken (een deel van) haar vordering(en) tot zekerheid waarvan onderhavig hypotheekrecht wordt gevestigd, overdraagt aan een derde, op deze derde tevens een met (het overgedragen deel van) deze vordering(en) evenredig deel van het hiervoor bedoelde hypotheekrecht als nevenrecht zal overgaan.</xsl:text>
		</p>		
		...
		<xsl:choose>
			...
			<xsl:when test="position() = 2">
				<p style="margin-left:30px">
					...
					<xsl:text> te noemen:</xsl:text><br/>
	...
	**** Overbruggingshypotheek      ********************************************************************************
	...
	<xsl:template match="tia:StukdeelHypotheek" mode="do-overbruggingshypotheek">
		...
		<p><u><xsl:text>Overbruggingshypotheek</xsl:text></u></p>
		<p><xsl:text>Voorts verleent de Hypotheekgever tot zekerheid voor de betaling van de Schuld als hiervoor omschreven, bij deze aan MUNT Hypotheken, die van de Hypotheekgever aanvaardt, het recht van </xsl:text>
		...
		<table cellspacing="0" cellpadding="0">
			<tbody>
				<tr>
					...
					<td valign="top">
						<xsl:text>dat het onder Overbruggingshypotheek vermelde onderpand hem in volle en onbezwaarde eigendom toebehoort, behoudens het (de) ten behoeve van MUNT Hypotheken of andere hypotheekhouders eerder gevestigde hypotheekrecht(en) ten laste van de Hypotheekgever, en dat hij daarover de onvoorwaardelijke beschikking heeft; </xsl:text>
					</td>
				</tr>
				<tr>
					<td class="number" valign="top">
				...
				<tr>
					...
					<td valign="top">
						<xsl:text>dat het onder Overbruggingshypotheek vermelde onderpand niet anders met recht van hypotheek is of kan worden bezwaard dan krachtens deze akte, behoudens het (de) ten behoeve van MUNT Hypotheken of andere hypotheekhouders eerder gevestigde hypotheekrecht(en) ten laste van de Hypotheekgever.</xsl:text>
					</td>
				</tr>
			</tbody>
		</table>	
