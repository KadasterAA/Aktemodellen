...
(mode) do-standaardlevering
(mode) do-purchase-and-transfer-tweeleveringen
(mode) do-cessie-koop
(mode) do-cessie-levering
(mode) do-indeplaatsstelling-koop
(mode) do-purchase-and-transfer-objects
(mode) do-registered-objects-deed-of-transfer
(mode) do-inschrijving-koop
(mode) do-keuzeblok-koopprijs
(mode) do-koopoptie
(mode) do-erfdienstbaarheden
(mode) do-kwalitatieve-verplichtingen
(mode) do-mandeligheid
(mode) do-woonplaatskeuze
(mode) do-keuzeblok-verdeling
...
<xsl:stylesheet xmlns="http://www.w3.org/1999/xhtml" xmlns:tia="http://www.kadaster.nl/schemas/KIK/TIA_Algemeen" xmlns:kef="nl.kadaster.xslt.XslExtensionFunctions" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:exslt="http://exslt.org/common" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:gc="http://docs.oasis-open.org/codelist/ns/genericode/1.0/" exclude-result-prefixes="tia kef xsl exslt xlink gc" version="1.0">
	...
	<xsl:variable name="keuzeteksten" select="document('keuzeteksten-levering-6.0.xml')"/>
	...
	<xsl:variable name="koop" select="tia:Bericht_TIA_Stuk/tia:IMKAD_AangebodenStuk/tia:StukdeelKoop[1]"/>
	<xsl:variable name="nextKoop" select="tia:Bericht_TIA_Stuk/tia:IMKAD_AangebodenStuk/tia:StukdeelKoop[2]"/>
	<xsl:variable name="levering" select="tia:Bericht_TIA_Stuk/tia:IMKAD_AangebodenStuk/tia:StukdeelLevering[1]"/>
	<xsl:variable name="nextLevering" select="tia:Bericht_TIA_Stuk/tia:IMKAD_AangebodenStuk/tia:StukdeelLevering[2]"/>
	<xsl:variable name="Datum_DATE1" select="substring(string($koop/tia:koopovereenkomst/tia:datumOndertekening), 0, 11)"/>
	...
	<xsl:variable name="lidwoordKoopakte1">
		<xsl:value-of select="$koop/tia:tekstkeuze[translate(tia:tagNaam, $upper, $lower) = 'k_lidwoordkoopovereenkomst']/tia:tekst"/>
	</xsl:variable>
	<xsl:variable name="aanwijzendVoornaamwoordKoopakte1">
		<xsl:choose>
			<xsl:when test="translate($koop/tia:tekstkeuze[translate(tia:tagNaam, $upper, $lower) = 'k_lidwoordkoopovereenkomst']/tia:tekst, $upper, $lower) = 'de'">
	...
	<xsl:variable name="koopakte1">
		<xsl:value-of select="$koop/tia:tekstkeuze[translate(tia:tagNaam, $upper, $lower) = 'k_koopakte']/tia:tekst"/>
	</xsl:variable>
	<xsl:variable name="volgnummerKoopakte1">
		<xsl:choose>
			<xsl:when test="translate($koop/tia:tekstkeuze[translate(tia:tagNaam, $upper, $lower) = 'k_koopaktevolgnummer']/tia:tekst, $upper, $lower) = 'true'">
				<xsl:text>1</xsl:text>
			</xsl:when>
			<xsl:otherwise>
				<xsl:text> </xsl:text>
	...
	<xsl:variable name="lidwoordKoopakte2">
		<xsl:value-of select="$nextKoop/tia:tekstkeuze[translate(tia:tagNaam, $upper, $lower) = 'k_lidwoordkoopovereenkomst']/tia:tekst"/>
	</xsl:variable>
	<xsl:variable name="aanwijzendVoornaamwoordKoopakte2">
		<xsl:choose>
			<xsl:when test="translate($nextKoop/tia:tekstkeuze[translate(tia:tagNaam, $upper, $lower) = 'k_lidwoordkoopovereenkomst']/tia:tekst, $upper, $lower) = 'de'">
				<xsl:text>Deze </xsl:text>
			</xsl:when>
			<xsl:otherwise>
				<xsl:text>Dit</xsl:text>
	...
	<xsl:variable name="koopakte2">
		<xsl:value-of select="$nextKoop/tia:tekstkeuze[translate(tia:tagNaam, $upper, $lower) = 'k_koopakte']/tia:tekst"/>
	</xsl:variable>
	<xsl:variable name="volgnummerKoopakte2">
		<xsl:choose>
			<xsl:when test="translate($nextKoop/tia:tekstkeuze[translate(tia:tagNaam, $upper, $lower) = 'k_koopaktevolgnummer']/tia:tekst, $upper, $lower) = 'true'">
				<xsl:text>2</xsl:text>
			</xsl:when>
			<xsl:otherwise>
				<xsl:text> </xsl:text>
	...
	<xsl:variable name="koopovereenkomst1">
		<xsl:value-of select="normalize-space(concat($lidwoordKoopakte1,' ',$koopakte1,' ',$volgnummerKoopakte1))"/>
	</xsl:variable>
	<xsl:variable name="koopovereenkomst1Capitalized" select="concat(translate(substring($koopakte1, 1, 1), $lower, $upper), substring($koopakte1, 2),' ',$volgnummerKoopakte1)"/>
	<xsl:variable name="koopovereenkomst2">
		<xsl:value-of select="normalize-space(concat($lidwoordKoopakte2,' ',$koopakte2,' ',$volgnummerKoopakte2))"/>
	</xsl:variable>
	<xsl:variable name="koopovereenkomst2Capitalized" select="concat(translate(substring($koopakte2, 1, 1), $lower, $upper), substring($koopakte2, 2),' ',$volgnummerKoopakte2)"/>
	<xsl:variable name="dezeditKoopovereenkomst1">
		<xsl:value-of select="normalize-space(concat($aanwijzendVoornaamwoordKoopakte1,' ',$koopakte1))"/>
	</xsl:variable>
	<xsl:variable name="dezeditKoopovereenkomst2">
		<xsl:value-of select="normalize-space(concat($aanwijzendVoornaamwoordKoopakte2,' ',$koopakte2))"/>
	</xsl:variable>
	<xsl:variable name="koopovereenkomst1ZonderLidwoord">
		<xsl:value-of select="normalize-space(concat($koopakte1,' ',$volgnummerKoopakte1))"/>
	</xsl:variable>
	<xsl:variable name="koopovereenkomst2ZonderLidwoord">
		<xsl:value-of select="normalize-space(concat($koopakte2,' ',$volgnummerKoopakte2))"/>
	</xsl:variable>
	<!--
	*********************************************************
	Mode: do-deed
	...
	**** matching template ********************************************************************************
	...
	<xsl:template match="tia:Bericht_TIA_Stuk" mode="do-deed">
		...
		<p>
			...
			<xsl:if test="tia:IMKAD_AangebodenStuk/tia:tia_TekstKeuze[translate(tia:tagNaam, $upper, $lower) = 'k_handelend']/tia:tekst != ''">
				<xsl:value-of select="tia:IMKAD_AangebodenStuk/tia:tia_TekstKeuze[translate(tia:tagNaam, $upper, $lower) = 'k_handelend']/tia:tekst"/>
			</xsl:if>
		...
		<xsl:apply-templates select="tia:IMKAD_AangebodenStuk" mode="do-inschrijving-koop"/>
		<xsl:apply-templates select="tia:IMKAD_AangebodenStuk" mode="do-keuzeblok-koopprijs"/>
		<xsl:apply-templates select="tia:IMKAD_AangebodenStuk" mode="do-vve"/>
		...
		<xsl:apply-templates select="tia:IMKAD_AangebodenStuk" mode="do-koopoptie"/>
		<xsl:apply-templates select="tia:IMKAD_AangebodenStuk" mode="do-erfdienstbaarheden"/>
		<xsl:apply-templates select="tia:IMKAD_AangebodenStuk" mode="do-kwalitatieve-verplichtingen"/>
		<xsl:apply-templates select="tia:IMKAD_AangebodenStuk" mode="do-mandeligheid"/>
		<xsl:apply-templates select="tia:IMKAD_AangebodenStuk" mode="do-woonplaatskeuze"/>
		<h3>
	...
	**** matching template ********************************************************************************
	...
	<xsl:template match="tia:IMKAD_AangebodenStuk" mode="do-purchase-and-transfer">
		...
		<xsl:choose>
			<xsl:when test="translate($SoortLevering, $upper, $lower) = 'standaardlevering'">
				<xsl:apply-templates select="." mode="do-standaardkoop"/>
				<xsl:apply-templates select="." mode="do-standaardlevering"/>
			</xsl:when>
			<xsl:when test="translate($SoortLevering, $upper, $lower) = 'twee leveringen'">
				<xsl:apply-templates select="." mode="do-tweeleveringen-koop"/>
				<xsl:apply-templates select="." mode="do-tweeleveringen-levering"/>
			</xsl:when>
			<xsl:when test="translate($SoortLevering, $upper, $lower) = 'verkoop rechten met cessie'">
				<xsl:apply-templates select="." mode="do-cessie-koop"/>
				<xsl:apply-templates select="tia:StukdeelLevering" mode="do-cessie-levering"/>
			</xsl:when>
			<xsl:when test="translate($SoortLevering, $upper, $lower) = 'verkoop rechten met indeplaatsstelling'">
				<xsl:apply-templates select="." mode="do-indeplaatsstelling-koop"/>
				<xsl:apply-templates select="tia:StukdeelLevering" mode="do-indeplaatsstelling-levering"/>
			</xsl:when>
	...
	**** matching template ********************************************************************************
	-->
	<xsl:template match="tia:IMKAD_AangebodenStuk" mode="do-keuzeblok-verdeling">
					...
					<xsl:when test="$numberOfBuyers = 2">
						<xsl:if test="$acquirerParty">
							<xsl:if test="$partyMariatalStatusText = '5' or
											...
											$partyMariatalStatusText = '18' or
											$partyMariatalStatusText = '21' or
											$partyMariatalStatusText = '22'">
						...
						<xsl:if test="$acquirerPersons[translate(tia:tia_IndGerechtigde, $upper, $lower) = 'true']">
							<xsl:if test="$personMariatalStatusText = '5' or
											...
											$personMariatalStatusText = '18' or
											$personMariatalStatusText = '21' or
											$personMariatalStatusText = '22'">
								<xsl:text>, gezamenlijk</xsl:text>
							</xsl:if>
						</xsl:if>
	...
	**** matching template ********************************************************************************
	-->
	<xsl:template match="tia:IMKAD_AangebodenStuk" mode="do-standaardkoop">
		<h2 class="header">
		...
		<xsl:for-each select="tia:StukdeelKoop[tia:tia_Volgnummer]">
			...
			<xsl:variable name="vervreemderNaam">
				<xsl:choose>
			...
			<xsl:variable name="verkrijgerNaam">
				<xsl:choose>
			...
			<p>
				<xsl:value-of select="$vervreemderNaam"/>
				<xsl:text> en </xsl:text>
				<xsl:value-of select="$verkrijgerNaam"/>
				...
				<xsl:text> een koopovereenkomst gesloten met betrekking tot </xsl:text>
				<xsl:choose>
				...
				<xsl:text>. Van de koopovereenkomst blijkt uit een onderhandse akte die </xsl:text>
				...
				<u>
					<xsl:choose>
						<xsl:when test="position() = 1">
							<xsl:value-of select="$koopovereenkomst1"/>
						</xsl:when>
						<xsl:otherwise>
							<xsl:value-of select="$koopovereenkomst2"/>
						</xsl:otherwise>
					</xsl:choose>
				</u>
				<xsl:text>".</xsl:text>
	...
	**** matching template ********************************************************************************
	-->
	<xsl:template match="tia:IMKAD_AangebodenStuk" mode="do-standaardlevering">
	...
	+ count(../tia:Partij[@id = substring-after(current()/tia:verkrijgerRechtRef/@xlink:href, '#')]/tia:IMKAD_Persoon/tia:GerelateerdPersoon[translate(tia:IMKAD_Persoon/tia:tia_IndGerechtigde, $upper, $lower) = 'true'])
			...
			<p>
				...
				<xsl:apply-templates select=".." mode="do-keuzeblok-verdeling">
			...
			<xsl:if test="tia:IMKAD_ZakelijkRecht[translate(tia:tia_TekstKeuze[translate(tia:tagNaam, $upper, $lower) = 'k_registergoedaanduidingtekst']/tia:tekst, $upper, $lower) = 'true']">
				<xsl:if test="$registergoedAanduidingHetRegistergoed">
					<p>
						...
						<xsl:text>hierna</xsl:text>
						<xsl:if test="$registergoedAanduidingHetRegistergoed/tia:tia_TekstKeuze[translate(tia:tagNaam, $upper, $lower) = 'k_registergoedaanduidingtekstfragment']/tia:tekst != ''">
							<xsl:text> </xsl:text>
							<xsl:value-of select="translate(normalize-space($registergoedAanduidingHetRegistergoed/tia:tia_TekstKeuze[translate(tia:tagNaam, $upper, $lower) = 'k_registergoedaanduidingtekstfragment']/tia:tekst), $upper, $lower)"/>
						</xsl:if>
						<xsl:text>: "</xsl:text>
						<u>
	...
	**** matching template ********************************************************************************
	-->
	<xsl:template match="tia:IMKAD_AangebodenStuk" mode="do-tweeleveringen-koop">
				...
				<tbody>
					<tr>
						...
						<td>
							...
							<xsl:value-of select="$Datum_STRING1"/>
							<xsl:text> een koopovereenkomst gesloten betreffende </xsl:text>
							<xsl:choose>
							...
							<xsl:if test="tia:tekstkeuze[translate(tia:tagNaam, $upper, $lower) = 'k_akteaangehecht']/tia:tekst = 'true'">
								<xsl:text> </xsl:text>
								<xsl:choose>
									<xsl:when test="$volgnummerKoopakte1 = ' '">
										<xsl:value-of select="$dezeditKoopovereenkomst1"/>
									</xsl:when>
									<xsl:otherwise>
										<xsl:value-of select="$koopovereenkomst1Capitalized"/>
									</xsl:otherwise>
								</xsl:choose>
					...
					<tr>
						...
						<td>
							...
							<xsl:if test="$nextKoop/tia:tekstkeuze[translate(tia:tagNaam, $upper, $lower) = 'k_akteaangehecht']/tia:tekst = 'true'">
								<xsl:text> </xsl:text>
								<xsl:choose>
									<xsl:when test="$volgnummerKoopakte2 = ' '">
										<xsl:value-of select="$dezeditKoopovereenkomst2"/>
									</xsl:when>
									<xsl:otherwise>
										<xsl:value-of select="$koopovereenkomst2Capitalized"/>
									</xsl:otherwise>
								</xsl:choose>
	...
	<xsl:template match="tia:IMKAD_AangebodenStuk" mode="do-tweeleveringen-levering">
		<xsl:for-each select="tia:StukdeelLevering[count(preceding-sibling::tia:StukdeelLevering) mod 2 = 0]">
			...
			<xsl:variable name="undividedLeveringNext">
				<xsl:choose>
					<xsl:when test="translate($nextLevering/tia:tekstkeuze[translate(tia:tagNaam, $upper, $lower) = 'k_onverdeeld']/tia:tekst, $upper, $lower) = 'true'">
						<xsl:choose>
							<xsl:when test="$numberOfBuyersLeveringNext = 2">
								<xsl:text>onverdeelde </xsl:text>
							</xsl:when>
							<xsl:when test="$numberOfBuyersLeveringNext > 2">
								<xsl:text>onverdeeld </xsl:text>
			...
			<xsl:variable name="acquirerPartyLeveringNext" select="../tia:Partij[@id = substring-after($nextKoop/tia:verkrijgerRechtRef/@xlink:href, '#')]"/>
			<xsl:variable name="nestedPartyLeveringNext" select="../tia:Partij/tia:Partij[@id = substring-after($nextKoop/tia:verkrijgerRechtRef/@xlink:href, '#')]"/>
	...
	<xsl:template match="tia:IMKAD_AangebodenStuk" mode="do-cessie-koop">
		<xsl:for-each select="tia:StukdeelKoop[count(preceding-sibling::tia:StukdeelKoop) mod 2 = 0]">
			<xsl:variable name="numberOfRegisteredObjects" select="count(../tia:StukdeelLevering/tia:IMKAD_ZakelijkRecht)"/>
			<xsl:variable name="numberOfBuyers" select="count(../tia:Partij[@id = substring-after(current()/../tia:StukdeelLevering/tia:verkrijgerRechtRef/@xlink:href, '#')]/tia:IMKAD_Persoon[translate(tia:tia_IndGerechtigde, $upper, $lower) = 'true'])
				+ count(../tia:Partij[@id = substring-after(current()/../tia:StukdeelLevering/tia:verkrijgerRechtRef/@xlink:href, '#')]/tia:IMKAD_Persoon/tia:GerelateerdPersoon[translate(tia:IMKAD_Persoon/tia:tia_IndGerechtigde, $upper, $lower) = 'true'])
				+ count(../tia:Partij[@id = substring-after(current()/../tia:StukdeelLevering/tia:verkrijgerRechtRef/@xlink:href, '#')]/tia:IMKAD_Persoon/tia:GerelateerdPersoon/tia:IMKAD_Persoon/tia:GerelateerdPersoon[translate(tia:IMKAD_Persoon/tia:tia_IndGerechtigde, $upper, $lower) = 'true'])"/>
				...
				<tbody>
					<tr>
						...
						<td>
							...
							<xsl:text> een koopovereenkomst gesloten betreffende </xsl:text>
							<xsl:choose>
								<xsl:when test="count(../tia:StukdeelLevering/tia:IMKAD_ZakelijkRecht) > 1">
									<xsl:text>de </xsl:text>
								</xsl:when>
								<xsl:when test="count(../tia:StukdeelLevering/tia:IMKAD_ZakelijkRecht) = 1">
									<xsl:text>het </xsl:text>
							...
							<xsl:text>hierna te vermelden registergoed</xsl:text>
							<xsl:if test="count(../tia:StukdeelLevering/tia:IMKAD_ZakelijkRecht) > 1">
								<xsl:text>eren</xsl:text>
							</xsl:if>
							<xsl:text>, hierna te noemen: "</xsl:text>
							<u>
					...
					<tr>
						...
						<td>
							...
							<xsl:text> op </xsl:text>
							<xsl:value-of select="$Datum_STRING2"/>
							<xsl:text> een koopovereenkomst gesloten betreffende zijn rechten uit </xsl:text>
							<xsl:value-of select="$koopovereenkomst2"/>
							<xsl:text> met </xsl:text>
							<xsl:choose>
								<xsl:when test="../tia:Partij[@id = substring-after(current()/tia:vervreemderRechtRef/@xlink:href, '#')]">
					...
					<xsl:choose>
						...
						<xsl:when test="translate(tia:tekstkeuze[translate(tia:tagNaam, $upper, $lower) = 'k_cessie']/tia:tekst, $upper, $lower) = 'true'">
							...
							<tr>
								...
								<td>
									<xsl:text>dat hij volledig bevoegd is de rechten uit </xsl:text>
									<xsl:value-of select="$koopovereenkomst1"/>
	...
	<xsl:template match="tia:StukdeelLevering" mode="do-cessie-levering">
		<xsl:variable name="numberOfBuyersLevering" select="count(../tia:Partij[@id = substring-after(current()/tia:verkrijgerRechtRef/@xlink:href, '#')]/tia:IMKAD_Persoon[translate(tia:tia_IndGerechtigde, $upper, $lower) = 'true'])
				+ count(../tia:Partij[@id = substring-after(current()/tia:verkrijgerRechtRef/@xlink:href, '#')]/tia:IMKAD_Persoon/tia:GerelateerdPersoon[translate(tia:IMKAD_Persoon/tia:tia_IndGerechtigde, $upper, $lower) = 'true'])
				+ count(../tia:Partij[@id = substring-after(current()/tia:verkrijgerRechtRef/@xlink:href, '#')]/tia:IMKAD_Persoon/tia:GerelateerdPersoon/tia:IMKAD_Persoon/tia:GerelateerdPersoon[translate(tia:IMKAD_Persoon/tia:tia_IndGerechtigde, $upper, $lower) = 'true'])"/>
		<xsl:variable name="undividedLevering">
	...
	**** matching template ********************************************************************************
	-->
	<xsl:template match="tia:IMKAD_AangebodenStuk" mode="do-indeplaatsstelling-koop">
		<xsl:for-each select="tia:StukdeelKoop[count(preceding-sibling::tia:StukdeelKoop) mod 2 = 0]">
			<xsl:variable name="numberOfRegisteredObjects" select="count($levering/tia:IMKAD_ZakelijkRecht)"/>
			<xsl:variable name="numberOfBuyers" select="count(tia:Partij[@id = substring-after($levering/tia:verkrijgerRechtRef/@xlink:href, '#')]/tia:IMKAD_Persoon[translate(tia:tia_IndGerechtigde, $upper, $lower) = 'true'])
				+ count(tia:Partij[@id = substring-after($levering/tia:verkrijgerRechtRef/@xlink:href, '#')]/tia:IMKAD_Persoon/tia:GerelateerdPersoon[translate(tia:IMKAD_Persoon/tia:tia_IndGerechtigde, $upper, $lower) = 'true'])
				+ count(tia:Partij[@id = substring-after($levering/tia:verkrijgerRechtRef/@xlink:href, '#')]/tia:IMKAD_Persoon/tia:GerelateerdPersoon/tia:IMKAD_Persoon/tia:GerelateerdPersoon[translate(tia:IMKAD_Persoon/tia:tia_IndGerechtigde, $upper, $lower) = 'true'])"/>
			<h2 class="header">
				<xsl:text>KOOP</xsl:text>
			</h2>
			<table cellpadding="0" cellspacing="0">
				<tbody>
					<tr>
						...
						<td>
							...
							<xsl:text> een koopovereenkomst gesloten betreffende </xsl:text>
							<xsl:choose>
								<xsl:when test="count($levering/tia:IMKAD_ZakelijkRecht) > 1">
									<xsl:text>de </xsl:text>
								</xsl:when>
								<xsl:when test="count($levering/tia:IMKAD_ZakelijkRecht) = 1">
									<xsl:text>het </xsl:text>
							...
							<xsl:text>hierna te vermelden registergoed</xsl:text>
							<xsl:if test="count($levering/tia:IMKAD_ZakelijkRecht) > 1">
								<xsl:text>eren</xsl:text>
							</xsl:if>
							<xsl:text>, hierna te noemen: "</xsl:text>
							<u>
	...
	<xsl:template match="tia:StukdeelLevering" mode="do-indeplaatsstelling-levering">
		<xsl:variable name="numberOfBuyersLevering" select="count(../tia:Partij[@id = substring-after(current()/tia:verkrijgerRechtRef/@xlink:href, '#')]/tia:IMKAD_Persoon[translate(tia:tia_IndGerechtigde, $upper, $lower) = 'true'])
				+ count(../tia:Partij[@id = substring-after(current()/tia:verkrijgerRechtRef/@xlink:href, '#')]/tia:IMKAD_Persoon/tia:GerelateerdPersoon[translate(tia:IMKAD_Persoon/tia:tia_IndGerechtigde, $upper, $lower) = 'true'])
				+ count(../tia:Partij[@id = substring-after(current()/tia:verkrijgerRechtRef/@xlink:href, '#')]/tia:IMKAD_Persoon/tia:GerelateerdPersoon/tia:IMKAD_Persoon/tia:GerelateerdPersoon[translate(tia:IMKAD_Persoon/tia:tia_IndGerechtigde, $upper, $lower) = 'true'])"/>
		<xsl:variable name="undividedLevering">
	...
	**** matching template ********************************************************************************
	-->
	<xsl:template match="tia:IMKAD_AangebodenStuk" mode="do-inschrijving-koop">
	...
	**** matching template ********************************************************************************
	-->
	<xsl:template match="tia:IMKAD_AangebodenStuk[tia:StukdeelKoop/tia:koopovereenkomst/tia:datumInschrijving and tia:StukdeelKoop/tia:koopovereenkomst/tia:gegevensInschrijving]" mode="do-inschrijving-koop">
		<xsl:variable name="Inschrijving_DATE1" select="substring(string($koop/tia:koopovereenkomst/tia:datumInschrijving), 0, 11)"/>
		<xsl:variable name="Inschrijving_STRING1">
			<xsl:if test="$Datum_DATE1 != ''">
				<xsl:value-of select="kef:convertDateToText($Inschrijving_DATE1)"/>
			</xsl:if>
		</xsl:variable>
		<xsl:variable name="Inschrijving_DATE2" select="substring(string($nextKoop/tia:koopovereenkomst/tia:datumInschrijving), 0, 11)"/>
		<xsl:variable name="Inschrijving_STRING2">
			<xsl:if test="$Datum_DATE2 != ''">
				<xsl:value-of select="kef:convertDateToText($Inschrijving_DATE2)"/>
			</xsl:if>
		</xsl:variable>
		<xsl:if test="count(tia:StukdeelKoop[translate(tia:tekstkeuze[translate(tia:tagNaam, $upper, $lower) = 'k_inschrijvingkoop']/tia:tekst, $upper, $lower) = 'true']) > 0">
			...
			<xsl:for-each select="tia:StukdeelKoop[tia:tekstkeuze[translate(tia:tagNaam, $upper, $lower) = 'k_inschrijvingkoop']/tia:tekst = 'true']">
				<p>
						...
						<xsl:choose>
							<xsl:when test="position()=1">
								<xsl:choose>
									...
									<xsl:otherwise>
										<xsl:value-of select="$koopovereenkomst1ZonderLidwoord"/>
									</xsl:otherwise>
								</xsl:choose>
							</xsl:when>
							<xsl:otherwise>
								<xsl:choose>
									...
									<xsl:otherwise>
										<xsl:value-of select="$koopovereenkomst2ZonderLidwoord"/>
									</xsl:otherwise>
								</xsl:choose>
							</xsl:otherwise>
						</xsl:choose>
					...
					<xsl:choose>
						<xsl:when test="position()=1">
							<xsl:value-of select="$Inschrijving_STRING1"/>
						</xsl:when>
						<xsl:otherwise>
							<xsl:value-of select="$Inschrijving_STRING2"/>
						</xsl:otherwise>
					</xsl:choose>
					<xsl:text> in </xsl:text>
	...
	**** matching template ********************************************************************************
	-->
	<xsl:template match="tia:IMKAD_AangebodenStuk" mode="do-keuzeblok-koopprijs">
		<h2 class="header">
			...
			<xsl:when test="translate($SoortLevering, $upper, $lower) = 'twee leveringen'">
				<xsl:for-each select="tia:StukdeelLevering[tia:tia_Volgnummer and count(preceding-sibling::tia:StukdeelLevering) mod 2 = 0]">
					...
					<xsl:if test="$tweeLeveringGroupNext">
						<xsl:apply-templates select="." mode="do-keuzeblok-koopprijs-twee-levering-group">
						...
						<xsl:apply-templates select="." mode="do-keuzeblok-koopprijs-twee-levering-group-next">
							<xsl:with-param name="stukdeelLeveringNext" select="$stukdeelLeveringNext"/>
					...
					<xsl:for-each select="$stukdeelLeveringNext/tia:IMKAD_ZakelijkRecht">
						<xsl:if test="not($tweeLeveringGroupNext)">
							<xsl:apply-templates select="." mode="do-keuzeblok-koopprijs-twee-levering-individual">
								<xsl:with-param name="stukdeelLeveringNext" select="$stukdeelLeveringNext"/>
								<xsl:with-param name="stukdeelKoop" select="$stukdeelKoop"/>
								<xsl:with-param name="partyNameVariantVrijOpNaam" select="$partyNameVariantVrijOpNaam"/>
								<xsl:with-param name="partyNameVariantKoopAanneemsom" select="$partyNameVariantKoopAanneemsom"/>
							...
							<xsl:apply-templates select="." mode="do-keuzeblok-koopprijs-twee-levering-individual-next">
								<xsl:with-param name="stukdeelLeveringNext" select="$stukdeelLeveringNext"/>
								<xsl:with-param name="stukdeelKoopNext" select="$stukdeelKoopNext"/>
								<xsl:with-param name="partyNameVariantVrijOpNaamNext" select="$partyNameVariantVrijOpNaamNext"/>
								<xsl:with-param name="partyNameVariantKoopAanneemsomNext" select="$partyNameVariantKoopAanneemsomNext"/>
							...
							<xsl:choose>
								...
								<xsl:when test="count(tia:IMKAD_ZakelijkRecht[translate(tia:tia_TekstKeuze[translate(tia:tagNaam, $upper, $lower) = 'k_koopprijsvariant']/tia:tekst, $upper, $lower) = 'kaal']) = count(tia:IMKAD_ZakelijkRecht)
									...
									<p>
										...
										<xsl:choose>
											<xsl:when test="$stukdeelKoop/tia:tekstkeuze[translate(tia:tagNaam, $upper, $lower) = 'k_koopprijsperregistergoed']/tia:tekst = 'true' and
	...
	<xsl:template match="tia:StukdeelLevering" mode="do-keuzeblok-koopprijs-twee-levering-group">
	...
	<xsl:template match="tia:IMKAD_ZakelijkRecht" mode="do-keuzeblok-koopprijs-twee-levering-individual">
		<xsl:param name="stukdeelLeveringNext" select="self::node()[false()]"/>
		<xsl:param name="stukdeelKoop" select="self::node()[false()]"/>
		<xsl:param name="partyNameVariantVrijOpNaam" select="''"/>
		<xsl:param name="partyNameVariantKoopAanneemsom" select="''"/>
	...
	<xsl:template match="tia:StukdeelLevering" mode="do-keuzeblok-koopprijs-twee-levering-group-next">
		<xsl:param name="stukdeelLeveringNext" select="self::node()[false()]"/>
	...
	<xsl:template match="tia:IMKAD_ZakelijkRecht" mode="do-keuzeblok-koopprijs-twee-levering-individual-next">
		<xsl:param name="stukdeelLeveringNext" select="self::node()[false()]"/>
		<xsl:param name="stukdeelKoopNext" select="self::node()[false()]"/>
		<xsl:param name="partyNameVariantVrijOpNaamNext" select="''"/>
		<xsl:param name="partyNameVariantKoopAanneemsomNext" select="''"/>
	...
	**** matching template ********************************************************************************
	-->
	<xsl:template match="tia:IMKAD_AangebodenStuk" mode="do-koopoptie">
	...
	**** matching template ********************************************************************************
	-->
	<xsl:template match="tia:IMKAD_AangebodenStuk[tia:StukdeelKoopoptie]" mode="do-koopoptie">
		<a name="hyp4.purchaseOption" class="location">&#160;</a>
		<h2 class="header">
	...
	**** matching template ********************************************************************************
	-->
	<xsl:template match="tia:IMKAD_AangebodenStuk" mode="do-erfdienstbaarheden">
	...
	**** matching template ********************************************************************************
	-->
	<xsl:template match="tia:IMKAD_AangebodenStuk[tia:StukdeelErfdienstbaarheid]" mode="do-erfdienstbaarheden">
		<a name="hyp4.easements" class="location">&#160;</a>
		<h2 class="header">
			<xsl:text>VESTIGING ERFDIENSTBAARHEDEN</xsl:text>
		</h2>
		<xsl:for-each select="tia:StukdeelErfdienstbaarheid[tia:tia_Volgnummer]">
			<xsl:variable name="heenEnWeer">
				<xsl:choose>
					<xsl:when test="translate(../tia:tia_TekstKeuze[translate(tia:tagNaam, $upper, $lower) = 'k_overenweer']/tia:tekst='true',$upper, $lower)='true'">
						<xsl:variable name="tenBehoevePerceel">
							<xsl:for-each select="tia:IMKAD_AantekeningKadastraalObject/tia:tenBehoeveVan/tia:IMKAD_Perceel/tia:kadastraleAanduiding">
								<xsl:if test="not(tia:gemeente = ../../../../tia:IMKAD_AantekeningKadastraalObject/tia:tenLasteVan/tia:IMKAD_Perceel/tia:kadastraleAanduiding/tia:gemeente and 
					tia:sectie = ../../../../tia:IMKAD_AantekeningKadastraalObject/tia:tenLasteVan/tia:IMKAD_Perceel/tia:kadastraleAanduiding/tia:sectie and
					tia:perceelnummer = ../../../../tia:IMKAD_AantekeningKadastraalObject/tia:tenLasteVan/tia:IMKAD_Perceel/tia:kadastraleAanduiding/tia:perceelnummer)">
									<xsl:text>false</xsl:text>
								</xsl:if>
							</xsl:for-each>
						</xsl:variable>
						<xsl:variable name="tenLastePerceel">
							<xsl:for-each select="tia:IMKAD_AantekeningKadastraalObject/tia:tenLasteVan/tia:IMKAD_Perceel/tia:kadastraleAanduiding">
								<xsl:if test="not(tia:gemeente = ../../../../tia:IMKAD_AantekeningKadastraalObject/tia:tenBehoeveVan/tia:IMKAD_Perceel/tia:kadastraleAanduiding/tia:gemeente and 
					tia:sectie = ../../../../tia:IMKAD_AantekeningKadastraalObject/tia:tenBehoeveVan/tia:IMKAD_Perceel/tia:kadastraleAanduiding/tia:sectie and
					tia:perceelnummer = ../../../../tia:IMKAD_AantekeningKadastraalObject/tia:tenBehoeveVan/tia:IMKAD_Perceel/tia:kadastraleAanduiding/tia:perceelnummer)">
									<xsl:text>false</xsl:text>
								</xsl:if>
							</xsl:for-each>
						</xsl:variable>
						<xsl:variable name="tenBehoeveAppartement">
							<xsl:for-each select="tia:IMKAD_AantekeningKadastraalObject/tia:tenBehoeveVan/tia:IMKAD_Appartementsrecht/tia:kadastraleAanduiding">
								<xsl:if test="not(tia:gemeente = ../../../../tia:IMKAD_AantekeningKadastraalObject/tia:tenLasteVan/tia:IMKAD_Appartementsrecht/tia:kadastraleAanduiding/tia:gemeente and 
					tia:sectie = ../../../../tia:IMKAD_AantekeningKadastraalObject/tia:tenLasteVan/tia:IMKAD_Appartementsrecht/tia:kadastraleAanduiding/tia:sectie and
					tia:perceelnummer = ../../../../tia:IMKAD_AantekeningKadastraalObject/tia:tenLasteVan/tia:IMKAD_Appartementsrecht/tia:kadastraleAanduiding/tia:perceelnummer and
					tia:appartementsindex = ../../../../tia:IMKAD_AantekeningKadastraalObject/tia:tenLasteVan/tia:IMKAD_Appartementsrecht/tia:kadastraleAanduiding/tia:appartementsindex)">
									<xsl:text>false</xsl:text>
								</xsl:if>
							</xsl:for-each>
						</xsl:variable>
						<xsl:variable name="tenLasteAppartement">
							<xsl:for-each select="tia:IMKAD_AantekeningKadastraalObject/tia:tenLasteVan/tia:IMKAD_Appartementsrecht/tia:kadastraleAanduiding">
								<xsl:if test="not(tia:gemeente = ../../../../tia:IMKAD_AantekeningKadastraalObject/tia:tenBehoeveVan/tia:IMKAD_Appartementsrecht/tia:kadastraleAanduiding/tia:gemeente and 
					tia:sectie = ../../../../tia:IMKAD_AantekeningKadastraalObject/tia:tenBehoeveVan/tia:IMKAD_Appartementsrecht/tia:kadastraleAanduiding/tia:sectie and
					tia:perceelnummer = ../../../../tia:IMKAD_AantekeningKadastraalObject/tia:tenBehoeveVan/tia:IMKAD_Appartementsrecht/tia:kadastraleAanduiding/tia:perceelnummer and
					tia:appartementsindex = ../../../../tia:IMKAD_AantekeningKadastraalObject/tia:tenBehoeveVan/tia:IMKAD_Appartementsrecht/tia:kadastraleAanduiding/tia:appartementsindex)">
									<xsl:text>false</xsl:text>
								</xsl:if>
							</xsl:for-each>
						</xsl:variable>
						<xsl:choose>
							<xsl:when test="$tenBehoevePerceel='false' or $tenLastePerceel='false' or $tenBehoeveAppartement='false' or $tenLasteAppartement='false'">
								<xsl:text>false</xsl:text>
							</xsl:when>
							<xsl:otherwise>
								<xsl:text>true</xsl:text>
			...
			<p>
				...
				<xsl:text> en </xsl:text>
				<xsl:value-of select="$verkrijgerPartyName"/>
				<xsl:text> zijn overeengekomen erfdienstbaarheden te vestigen zoals hierna omschreven. Ter uitvoering van de overeenkomst worden hierbij </xsl:text>
				<xsl:if test="$heenEnWeer = 'true'">
					<xsl:text>over en weer </xsl:text>
				</xsl:if>
				<xsl:text>gevestigd </xsl:text>
				<xsl:if test="translate(../tia:tia_TekstKeuze[translate(tia:tagNaam, $upper, $lower) = 'k_aanvaard']/tia:tekst='true',$upper, $lower)='true'">
					<xsl:text>en aanvaard </xsl:text>
				</xsl:if>
				<xsl:text>ten behoeve </xsl:text>
				<xsl:if test="$heenEnWeer = 'true'">
					<xsl:text>en ten laste </xsl:text>
				</xsl:if>
				<xsl:text>van </xsl:text>
	...
	**** matching template ********************************************************************************
	-->
	<xsl:template match="tia:IMKAD_AangebodenStuk" mode="do-kwalitatieve-verplichtingen">
	...
	**** matching template ********************************************************************************
	-->
	<xsl:template match="tia:IMKAD_AangebodenStuk[tia:StukdeelKwalitatieveVerplichting]" mode="do-kwalitatieve-verplichtingen">
		<a name="hyp4.qualitativeObligation" class="location">&#160;</a>
		<h2 class="header">
			<xsl:text>VESTIGING KWALITATIEVE VERPLICHTINGEN</xsl:text>
		</h2>
		<xsl:for-each select="tia:StukdeelKwalitatieveVerplichting">
			<xsl:variable name="verkrijgerPartyName">
				<xsl:choose>
					<xsl:when test="../tia:Partij[@id = substring-after(current()/tia:verkrijgerRechtRef/@xlink:href, '#')]">
						<xsl:value-of select="../tia:Partij[@id = substring-after(current()/tia:verkrijgerRechtRef/@xlink:href, '#')]/tia:aanduidingPartij"/>
	...
	**** matching template ********************************************************************************
	-->
	<xsl:template match="tia:IMKAD_AangebodenStuk" mode="do-mandeligheid">
	...
	**** matching template ********************************************************************************
	-->
	<xsl:template match="tia:IMKAD_AangebodenStuk[tia:StukdeelMandeligheid]" mode="do-mandeligheid">
		<a name="hyp4.commonOwnership" class="location">&#160;</a>
		<h2 class="header">
	...
	**** matching template ********************************************************************************
	-->
	<xsl:template match="tia:IMKAD_AangebodenStuk" mode="do-woonplaatskeuze">
		<a name="hyp4.electionOfDomicile" class="location">&#160;</a>
		<xsl:if test="tia:tia_TekstKeuze[translate(tia:tagNaam, $upper, $lower) = 'k_woonplaatskeuze']/tia:tekst != ''">
			<h2 class="header">
				<u>
			...
			<p>
				<xsl:value-of select="tia:tia_TekstKeuze[translate(tia:tagNaam, $upper, $lower) = 'k_woonplaatskeuze']/tia:tekst"/>
			</p>
		</xsl:if>
	</xsl:template>
	<!--
	...
	**** matching template ********************************************************************************
	...
	<xsl:template match="tia:StukdeelLevering" mode="do-registered-objects-deed-of-transfer">
		...
		<xsl:variable name="aardVerkregen" select="count(tia:IMKAD_ZakelijkRecht[tia:aardVerkregen = tia:IMKAD_ZakelijkRecht[tia:IMKAD_Perceel][1]/tia:aardVerkregen
						and normalize-space(tia:aardVerkregen) != ''])"/>
		<xsl:variable name="aardVerkregenVariant" select="count(tia:IMKAD_ZakelijkRecht[((tia:aardVerkregenVariant 
							= tia:IMKAD_ZakelijkRecht[tia:IMKAD_Perceel][1]/tia:aardVerkregenVariant)
							or (not(tia:aardVerkregenVariant)
							and not(tia:IMKAD_ZakelijkRecht[tia:IMKAD_Perceel][1]/tia:aardVerkregenVariant)))])"/>
		<xsl:variable name="aantalBPRechten" select="count(tia:IMKAD_ZakelijkRecht[((tia:tia_Aantal_BP_Rechten
								= tia:IMKAD_ZakelijkRecht[tia:IMKAD_Perceel][1]/tia:tia_Aantal_BP_Rechten)
							or (not(tia:tia_Aantal_BP_Rechten)
								and not(tia:IMKAD_ZakelijkRecht[tia:IMKAD_Perceel][1]/tia:tia_Aantal_BP_Rechten)))])"/>
		<xsl:variable name="aantalRechten" select="count(tia:IMKAD_ZakelijkRecht[((tia:tia_Aantal_Rechten
								= tia:IMKAD_ZakelijkRecht[tia:IMKAD_Perceel][1]/tia:tia_Aantal_Rechten)
							or (not(tia:tia_Aantal_Rechten)
								and not(tia:IMKAD_ZakelijkRecht[tia:IMKAD_Perceel][1]/tia:tia_Aantal_Rechten)))])"/>
		<xsl:variable name="aantalRechtenVariant" select="count(tia:IMKAD_ZakelijkRecht[((tia:tia_Aantal_RechtenVariant
								= tia:IMKAD_ZakelijkRecht[tia:IMKAD_Perceel][1]/tia:tia_Aantal_RechtenVariant)
							or (not(tia:tia_Aantal_RechtenVariant)
								and not(tia:IMKAD_ZakelijkRecht[tia:IMKAD_Perceel][1]/tia:tia_Aantal_RechtenVariant)))])"/>
		<xsl:variable name="kNaderTeOmschrijven" select="count(tia:IMKAD_ZakelijkRecht[((tia:tia_TekstKeuze[translate(tia:tagNaam, $upper, $lower) = 'k_naderteomschrijven']/tia:tekst
								= tia:IMKAD_ZakelijkRecht[tia:IMKAD_Perceel][1]/tia:tia_TekstKeuze[translate(tia:tagNaam, $upper, $lower) = 'k_naderteomschrijven']/tia:tekst)
							or (not(tia:tia_TekstKeuze[translate(tia:tagNaam, $upper, $lower) = 'k_naderteomschrijven'])
								and not(tia:IMKAD_ZakelijkRecht[tia:IMKAD_Perceel][1]/tia:tia_TekstKeuze[translate(tia:tagNaam, $upper, $lower) = 'k_naderteomschrijven'])))])"/>
		<xsl:variable name="kVoorlopigeGrenzen" select="count(tia:IMKAD_ZakelijkRecht[((tia:tia_TekstKeuze[translate(tia:tagNaam, $upper, $lower) = 'k_voorlopigegrenzen']/tia:tekst
								= tia:IMKAD_ZakelijkRecht[tia:IMKAD_Perceel][1]/tia:tia_TekstKeuze[translate(tia:tagNaam, $upper, $lower) = 'k_voorlopigegrenzen']/tia:tekst)
							or (not(tia:tia_TekstKeuze[translate(tia:tagNaam, $upper, $lower) = 'k_voorlopigegrenzen'])
								and not(tia:IMKAD_ZakelijkRecht[tia:IMKAD_Perceel][1]/tia:tia_TekstKeuze[translate(tia:tagNaam, $upper, $lower) = 'k_voorlopigegrenzen'])))])"/>
		<xsl:variable name="kEigendom" select="count(tia:IMKAD_ZakelijkRecht[((tia:tia_TekstKeuze[translate(tia:tagNaam, $upper, $lower) = 'k_eigendom']/tia:tekst
								= tia:IMKAD_ZakelijkRecht[tia:IMKAD_Perceel][1]/tia:tia_TekstKeuze[translate(tia:tagNaam, $upper, $lower) = 'k_eigendom']/tia:tekst)
							or (not(tia:tia_TekstKeuze[translate(tia:tagNaam, $upper, $lower) = 'k_eigendom'])
							and not(tia:IMKAD_ZakelijkRecht[tia:IMKAD_Perceel][1]/tia:tia_TekstKeuze[translate(tia:tagNaam, $upper, $lower) = 'k_eigendom'])))])"/>
		<xsl:variable name="kMeervoud" select="count(tia:IMKAD_ZakelijkRecht[((tia:tia_TekstKeuze[translate(tia:tagNaam, $upper, $lower) = 'k_meervoud']/tia:tekst
								= tia:IMKAD_ZakelijkRecht[tia:IMKAD_Perceel][1]/tia:tia_TekstKeuze[translate(tia:tagNaam, $upper, $lower) = 'k_meervoud']/tia:tekst)
							or (not(tia:tia_TekstKeuze[translate(tia:tagNaam, $upper, $lower) = 'k_meervoud'])
							and not(tia:IMKAD_ZakelijkRecht[tia:IMKAD_Perceel][1]/tia:tia_TekstKeuze[translate(tia:tagNaam, $upper, $lower) = 'k_meervoud'])))])"/>
		<xsl:variable name="kEeuwigdurend" select="count(tia:IMKAD_ZakelijkRecht[((tia:tia_TekstKeuze[translate(tia:tagNaam, $upper, $lower) = 'k_eeuwigdurend']/tia:tekst
								= tia:IMKAD_ZakelijkRecht[tia:IMKAD_Perceel][1]/tia:tia_TekstKeuze[translate(tia:tagNaam, $upper, $lower) = 'k_eeuwigdurend']/tia:tekst)
							or (not(tia:tia_TekstKeuze[translate(tia:tagNaam, $upper, $lower) = 'k_eeuwigdurend'])
							and not(tia:IMKAD_ZakelijkRecht[tia:IMKAD_Perceel][1]/tia:tia_TekstKeuze[translate(tia:tagNaam, $upper, $lower) = 'k_eeuwigdurend'])))])"/>
		<xsl:variable name="kNaderTeOmschrijvenVariant" select="count(tia:IMKAD_ZakelijkRecht[((tia:tia_TekstKeuze[translate(tia:tagNaam, $upper, $lower) = 'k_naderteomschrijvenvariant']/tia:tekst
								= tia:IMKAD_ZakelijkRecht[tia:IMKAD_Perceel][1]/tia:tia_TekstKeuze[translate(tia:tagNaam, $upper, $lower) = 'k_naderteomschrijvenvariant']/tia:tekst)
							or (not(tia:tia_TekstKeuze[translate(tia:tagNaam, $upper, $lower) = 'k_naderteomschrijvenvariant'])
							and not(tia:IMKAD_ZakelijkRecht[tia:IMKAD_Perceel][1]/tia:tia_TekstKeuze[translate(tia:tagNaam, $upper, $lower) = 'k_naderteomschrijvenvariant'])))])"/>
		<xsl:variable name="kMeervoudVariant" select="count(tia:IMKAD_ZakelijkRecht[((tia:tia_TekstKeuze[translate(tia:tagNaam, $upper, $lower) = 'k_meervoudvariant']/tia:tekst
								= tia:IMKAD_ZakelijkRecht[tia:IMKAD_Perceel][1]/tia:tia_TekstKeuze[translate(tia:tagNaam, $upper, $lower) = 'k_meervoudvariant']/tia:tekst)
							or (not(tia:tia_TekstKeuze[translate(tia:tagNaam, $upper, $lower) = 'k_meervoudvariant'])
							and not(tia:IMKAD_ZakelijkRecht[tia:IMKAD_Perceel][1]/tia:tia_TekstKeuze[translate(tia:tagNaam, $upper, $lower) = 'k_meervoudvariant'])))])"/>
		<xsl:variable name="kEeuwigdurendVariant" select="count(tia:IMKAD_ZakelijkRecht[((tia:tia_TekstKeuze[translate(tia:tagNaam, $upper, $lower) = 'k_eeuwigdurendvariant']/tia:tekst
								= tia:IMKAD_ZakelijkRecht[tia:IMKAD_Perceel][1]/tia:tia_TekstKeuze[translate(tia:tagNaam, $upper, $lower) = 'k_eeuwigdurendvariant']/tia:tekst)
							or (not(tia:tia_TekstKeuze[translate(tia:tagNaam, $upper, $lower) = 'k_eeuwigdurendvariant'])
							and not(tia:IMKAD_ZakelijkRecht[tia:IMKAD_Perceel][1]/tia:tia_TekstKeuze[translate(tia:tagNaam, $upper, $lower) = 'k_eeuwigdurendvariant'])))])"/>
		<xsl:variable name="kAantalBPRechtenVariant" select="count(tia:IMKAD_ZakelijkRecht[((tia:tia_TekstKeuze[translate(tia:tagNaam, $upper, $lower) = 'k_aantal_bp_rechtenvariant']/tia:tekst
								= tia:IMKAD_ZakelijkRecht[tia:IMKAD_Perceel][1]/tia:tia_TekstKeuze[translate(tia:tagNaam, $upper, $lower) = 'k_aantal_bp_rechtenvariant']/tia:tekst)
							or (not(tia:tia_TekstKeuze[translate(tia:tagNaam, $upper, $lower) = 'k_aantal_bp_rechtenvariant'])
							and not(tia:IMKAD_ZakelijkRecht[tia:IMKAD_Perceel][1]/tia:tia_TekstKeuze[translate(tia:tagNaam, $upper, $lower) = 'k_aantal_bp_rechtenvariant'])))])"/>
		<xsl:variable name="kWijzeVanLevering" select="count(tia:IMKAD_ZakelijkRecht[((tia:tia_TekstKeuze[translate(tia:tagNaam, $upper, $lower) = 'k_wijzevanlevering']/tia:tekst
								= tia:IMKAD_ZakelijkRecht[tia:IMKAD_Perceel][1]/tia:tia_TekstKeuze[translate(tia:tagNaam, $upper, $lower) = 'k_wijzevanlevering']/tia:tekst)
							or (not(tia:tia_TekstKeuze[translate(tia:tagNaam, $upper, $lower) = 'k_wijzevanlevering'])
								and not(tia:IMKAD_ZakelijkRecht[tia:IMKAD_Perceel][1]/tia:tia_TekstKeuze[translate(tia:tagNaam, $upper, $lower) = 'k_wijzevanlevering'])))])"/>
		<xsl:variable name="aandeelInRecht" select="count(tia:IMKAD_ZakelijkRecht[((tia:aandeelInRecht/tia:teller = tia:IMKAD_ZakelijkRecht[tia:IMKAD_Perceel][1]/tia:aandeelInRecht/tia:teller
							and tia:aandeelInRecht/tia:noemer = tia:IMKAD_ZakelijkRecht[tia:IMKAD_Perceel][1]/tia:aandeelInRecht/tia:noemer)
							or (not(tia:aandeelInRecht)
								and not(tia:IMKAD_ZakelijkRecht[tia:IMKAD_Perceel][1]/tia:aandeelInRecht)))])"/>
		<xsl:variable name="omschrijvingEigendom" select="count(tia:IMKAD_ZakelijkRecht[tia:IMKAD_Perceel[
							tia:tia_OmschrijvingEigendom
								= tia:IMKAD_ZakelijkRecht[tia:IMKAD_Perceel][1]/tia:IMKAD_Perceel/tia:tia_OmschrijvingEigendom
							and normalize-space(tia:tia_OmschrijvingEigendom) != '']])"/>
		<xsl:variable name="kMandeligheid" select="count(tia:IMKAD_ZakelijkRecht[tia:IMKAD_Perceel[((tia:tia_Tekstkeuze[translate(tia:tagNaam, $upper, $lower) = 'k_mandeligheid']/tia:tekst
									= tia:IMKAD_ZakelijkRecht[tia:IMKAD_Perceel][1]/tia:IMKAD_Perceel/tia:tia_Tekstkeuze[translate(tia:tagNaam, $upper, $lower) = 'k_mandeligheid']/tia:tekst)
								or (not(tia:tia_Tekstkeuze[translate(tia:tagNaam, $upper, $lower) = 'k_mandeligheid'])
									and not(tia:IMKAD_ZakelijkRecht[tia:IMKAD_Perceel][1]/tia:IMKAD_Perceel/tia:tia_Tekstkeuze[translate(tia:tagNaam, $upper, $lower) = 'k_mandeligheid'])))]])"/>
		<xsl:variable name="kAanduiding" select="count(tia:IMKAD_ZakelijkRecht[tia:IMKAD_Perceel[((tia:tia_Tekstkeuze[translate(tia:tagNaam, $upper, $lower) = 'k_aanduiding']/tia:tekst
									= tia:IMKAD_ZakelijkRecht[tia:IMKAD_Perceel][1]/tia:IMKAD_Perceel/tia:tia_Tekstkeuze[translate(tia:tagNaam, $upper, $lower) = 'k_aanduiding']/tia:tekst)
								or (not(tia:tia_Tekstkeuze[translate(tia:tagNaam, $upper, $lower) = 'k_aanduiding'])
								and not(tia:IMKAD_ZakelijkRecht[tia:IMKAD_Perceel][1]/tia:IMKAD_Perceel/tia:tia_Tekstkeuze[translate(tia:tagNaam, $upper, $lower) = 'k_aanduiding'])))]])"/>
		<xsl:variable name="kNabij" select="count(tia:IMKAD_ZakelijkRecht[tia:IMKAD_Perceel[((tia:tia_Tekstkeuze[translate(tia:tagNaam, $upper, $lower) = 'k_nabij']/tia:tekst
									= tia:IMKAD_ZakelijkRecht[tia:IMKAD_Perceel][1]/tia:IMKAD_Perceel/tia:tia_Tekstkeuze[translate(tia:tagNaam, $upper, $lower) = 'k_nabij']/tia:tekst)
								or (not(tia:tia_Tekstkeuze[translate(tia:tagNaam, $upper, $lower) = 'k_nabij'])
								and not(tia:IMKAD_ZakelijkRecht[tia:IMKAD_Perceel][1]/tia:IMKAD_Perceel/tia:tia_Tekstkeuze[translate(tia:tagNaam, $upper, $lower) = 'k_nabij'])))]])"/>
		<xsl:variable name="kKomma" select="count(tia:IMKAD_ZakelijkRecht[tia:IMKAD_Perceel[((tia:tia_Tekstkeuze[translate(tia:tagNaam, $upper, $lower) = 'k_komma']/tia:tekst
									= tia:IMKAD_ZakelijkRecht[tia:IMKAD_Perceel][1]/tia:IMKAD_Perceel/tia:tia_Tekstkeuze[translate(tia:tagNaam, $upper, $lower) = 'k_komma']/tia:tekst)
								or (not(tia:tia_Tekstkeuze[translate(tia:tagNaam, $upper, $lower) = 'k_komma'])
								and not(tia:IMKAD_ZakelijkRecht[tia:IMKAD_Perceel][1]/tia:IMKAD_Perceel/tia:tia_Tekstkeuze[translate(tia:tagNaam, $upper, $lower) = 'k_komma'])))]])"/>
		<xsl:variable name="splitsingsverzoekOrdernummer" select="count(tia:IMKAD_ZakelijkRecht[tia:IMKAD_Perceel[((tia:tia_SplitsingsverzoekOrdernummer
									= tia:IMKAD_ZakelijkRecht[tia:IMKAD_Perceel][1]/tia:IMKAD_Perceel/tia:tia_SplitsingsverzoekOrdernummer)
								or (not(tia:tia_SplitsingsverzoekOrdernummer)
									and not(tia:IMKAD_ZakelijkRecht[tia:IMKAD_Perceel][1]/tia:IMKAD_Perceel/tia:tia_SplitsingsverzoekOrdernummer)))]])"/>
		<xsl:variable name="reeks" select="count(tia:IMKAD_ZakelijkRecht[tia:IMKAD_Perceel[((tia:stukVerificatiekosten/tia:reeks
						= tia:IMKAD_ZakelijkRecht[tia:IMKAD_Perceel][1]/tia:IMKAD_Perceel/tia:stukVerificatiekosten/tia:reeks)
					or (not(tia:stukVerificatiekosten/tia:reeks)
						and not(tia:IMKAD_ZakelijkRecht[tia:IMKAD_Perceel][1]/tia:IMKAD_Perceel/tia:stukVerificatiekosten/tia:reeks)))]])"/>
		<xsl:variable name="deel" select="count(tia:IMKAD_ZakelijkRecht[tia:IMKAD_Perceel[((tia:stukVerificatiekosten/tia:deel
						= tia:IMKAD_ZakelijkRecht[tia:IMKAD_Perceel][1]/tia:IMKAD_Perceel/tia:stukVerificatiekosten/tia:deel)
					or (not(tia:stukVerificatiekosten/tia:deel)
						and not(tia:IMKAD_ZakelijkRecht[tia:IMKAD_Perceel][1]/tia:IMKAD_Perceel/tia:stukVerificatiekosten/tia:deel)))]])"/>
		<xsl:variable name="nummer" select="count(tia:IMKAD_ZakelijkRecht[tia:IMKAD_Perceel[((tia:stukVerificatiekosten/tia:nummer
						= tia:IMKAD_ZakelijkRecht[tia:IMKAD_Perceel][1]/tia:IMKAD_Perceel/tia:stukVerificatiekosten/tia:nummer)
					or (not(tia:stukVerificatiekosten/tia:nummer)
						and not(tia:IMKAD_ZakelijkRecht[tia:IMKAD_Perceel][1]/tia:IMKAD_Perceel/tia:stukVerificatiekosten/tia:nummer)))]])"/>
		<xsl:variable name="gemeente" select="count(tia:IMKAD_ZakelijkRecht[tia:IMKAD_Perceel[tia:kadastraleAanduiding/tia:gemeente
					= tia:IMKAD_ZakelijkRecht[tia:IMKAD_Perceel][1]/tia:IMKAD_Perceel/tia:kadastraleAanduiding/tia:gemeente
				and normalize-space(tia:kadastraleAanduiding/tia:gemeente) != '']])"/>
		<xsl:variable name="sectie" select="count(tia:IMKAD_ZakelijkRecht[tia:IMKAD_Perceel[tia:kadastraleAanduiding/tia:sectie
					= tia:IMKAD_ZakelijkRecht[tia:IMKAD_Perceel][1]/tia:IMKAD_Perceel/tia:kadastraleAanduiding/tia:sectie
				and normalize-space(tia:kadastraleAanduiding/tia:sectie) != '']])"/>
		<xsl:variable name="ligging" select="count(tia:IMKAD_ZakelijkRecht[tia:IMKAD_Perceel[tia:IMKAD_OZLocatie/tia:ligging
					= tia:IMKAD_ZakelijkRecht[tia:IMKAD_Perceel][1]/tia:IMKAD_Perceel/tia:IMKAD_OZLocatie/tia:ligging
				and normalize-space(tia:IMKAD_OZLocatie/tia:ligging) != '']])"/>
		<xsl:variable name="huisnummer" select="count(tia:IMKAD_ZakelijkRecht[tia:IMKAD_Perceel[((tia:IMKAD_OZLocatie/tia:adres/tia:BAG_NummerAanduiding/tia:huisnummer
					= tia:IMKAD_ZakelijkRecht[tia:IMKAD_Perceel][1]/tia:IMKAD_Perceel/tia:IMKAD_OZLocatie/tia:adres/tia:BAG_NummerAanduiding/tia:huisnummer)
					or (not(tia:IMKAD_OZLocatie/tia:adres/tia:BAG_NummerAanduiding/tia:huisnummer)
						and not(tia:IMKAD_ZakelijkRecht[tia:IMKAD_Perceel][1]/tia:IMKAD_Perceel/tia:IMKAD_OZLocatie/tia:adres/tia:BAG_NummerAanduiding/tia:huisnummer)))]])"/>
		<xsl:variable name="huisletter" select="count(tia:IMKAD_ZakelijkRecht[tia:IMKAD_Perceel[((tia:IMKAD_OZLocatie/tia:adres/tia:BAG_NummerAanduiding/tia:huisletter
						= tia:IMKAD_ZakelijkRecht[tia:IMKAD_Perceel][1]/tia:IMKAD_Perceel/tia:IMKAD_OZLocatie/tia:adres/tia:BAG_NummerAanduiding/tia:huisletter)
					or (not(tia:IMKAD_OZLocatie/tia:adres/tia:BAG_NummerAanduiding/tia:huisletter)
						and not(tia:IMKAD_ZakelijkRecht[tia:IMKAD_Perceel][1]/tia:IMKAD_Perceel/tia:IMKAD_OZLocatie/tia:adres/tia:BAG_NummerAanduiding/tia:huisletter)))]])"/>
		<xsl:variable name="huisnummerToevoeging" select="count(tia:IMKAD_ZakelijkRecht[tia:IMKAD_Perceel[((tia:IMKAD_OZLocatie/tia:adres/tia:BAG_NummerAanduiding/tia:huisnummertoevoeging
						= tia:IMKAD_ZakelijkRecht[tia:IMKAD_Perceel][1]/tia:IMKAD_Perceel/tia:IMKAD_OZLocatie/tia:adres/tia:BAG_NummerAanduiding/tia:huisnummertoevoeging)
					or (not(tia:IMKAD_OZLocatie/tia:adres/tia:BAG_NummerAanduiding/tia:huisnummertoevoeging)
						and not(tia:IMKAD_ZakelijkRecht[tia:IMKAD_Perceel][1]/tia:IMKAD_Perceel/tia:IMKAD_OZLocatie/tia:adres/tia:BAG_NummerAanduiding/tia:huisnummertoevoeging)))]])"/>
		<xsl:variable name="postcode" select="count(tia:IMKAD_ZakelijkRecht[tia:IMKAD_Perceel[((tia:IMKAD_OZLocatie/tia:adres/tia:BAG_NummerAanduiding/tia:postcode
						= tia:IMKAD_ZakelijkRecht[tia:IMKAD_Perceel][1]/tia:IMKAD_Perceel/tia:IMKAD_OZLocatie/tia:adres/tia:BAG_NummerAanduiding/tia:postcode)
					or (not(tia:IMKAD_OZLocatie/tia:adres/tia:BAG_NummerAanduiding/tia:postcode)
						and not(tia:IMKAD_ZakelijkRecht[tia:IMKAD_Perceel][1]/tia:IMKAD_Perceel/tia:IMKAD_OZLocatie/tia:adres/tia:BAG_NummerAanduiding/tia:postcode)))]])"/>
		<xsl:variable name="openbareRuimteNaam" select="count(tia:IMKAD_ZakelijkRecht[tia:IMKAD_Perceel[((tia:IMKAD_OZLocatie/tia:adres/tia:BAG_OpenbareRuimte/tia:openbareRuimteNaam
					= tia:IMKAD_ZakelijkRecht[tia:IMKAD_Perceel][1]/tia:IMKAD_Perceel/tia:IMKAD_OZLocatie/tia:adres/tia:BAG_OpenbareRuimte/tia:openbareRuimteNaam)
					or (not(tia:IMKAD_OZLocatie/tia:adres/tia:BAG_OpenbareRuimte/tia:openbareRuimteNaam)
						and not(tia:IMKAD_ZakelijkRecht[tia:IMKAD_Perceel][1]/tia:IMKAD_Perceel/tia:IMKAD_OZLocatie/tia:adres/tia:BAG_OpenbareRuimte/tia:openbareRuimteNaam)))]])"/>
		<xsl:variable name="woonplaatsNaam" select="count(tia:IMKAD_ZakelijkRecht[tia:IMKAD_Perceel[((tia:IMKAD_OZLocatie/tia:adres/tia:BAG_Woonplaats/tia:woonplaatsNaam
					= tia:IMKAD_ZakelijkRecht[tia:IMKAD_Perceel][1]/tia:IMKAD_Perceel/tia:IMKAD_OZLocatie/tia:adres/tia:BAG_Woonplaats/tia:woonplaatsNaam)
					or (not(tia:IMKAD_OZLocatie/tia:adres/tia:BAG_Woonplaats/tia:woonplaatsNaam)
						and not(tia:IMKAD_ZakelijkRecht[tia:IMKAD_Perceel][1]/tia:IMKAD_Perceel/tia:IMKAD_OZLocatie/tia:adres/tia:BAG_Woonplaats/tia:woonplaatsNaam)))]])"/>
		<xsl:variable name="binnenlandsAdresPostcode" select="count(tia:IMKAD_ZakelijkRecht[tia:IMKAD_Perceel[((tia:IMKAD_OZLocatie/tia:kadBinnenlandsAdres/tia:postcode
					= tia:IMKAD_ZakelijkRecht[tia:IMKAD_Perceel][1]/tia:IMKAD_Perceel/tia:IMKAD_OZLocatie/tia:kadBinnenlandsAdres/tia:postcode)
					or (not(tia:IMKAD_OZLocatie/tia:kadBinnenlandsAdres/tia:postcode)
						and not(tia:IMKAD_ZakelijkRecht[tia:IMKAD_Perceel][1]/tia:IMKAD_Perceel/tia:kadBinnenlandsAdres/tia:postcode)))]])"/>
		<xsl:variable name="binnenlandsAdresWoonplaatsNaam" select="count(tia:IMKAD_ZakelijkRecht[tia:IMKAD_Perceel[((tia:IMKAD_OZLocatie/tia:kadBinnenlandsAdres/tia:woonplaatsNaam
					= tia:IMKAD_ZakelijkRecht[tia:IMKAD_Perceel][1]/tia:IMKAD_Perceel/tia:IMKAD_OZLocatie/tia:kadBinnenlandsAdres/tia:woonplaatsNaam)
					or (not(tia:IMKAD_OZLocatie/tia:kadBinnenlandsAdres/tia:woonplaatsNaam)
						and not(tia:IMKAD_ZakelijkRecht[tia:IMKAD_Perceel][1]/tia:IMKAD_Perceel/tia:kadBinnenlandsAdres/tia:woonplaatsNaam)))]])"/>
		<xsl:variable name="binnenlandsAdresOpenbareRuimteNaam" select="count(tia:IMKAD_ZakelijkRecht[tia:IMKAD_Perceel[((tia:IMKAD_OZLocatie/tia:kadBinnenlandsAdres/tia:openbareRuimteNaam
					= tia:IMKAD_ZakelijkRecht[tia:IMKAD_Perceel][1]/tia:IMKAD_Perceel/tia:IMKAD_OZLocatie/tia:kadBinnenlandsAdres/tia:openbareRuimteNaam)
					or (not(tia:IMKAD_OZLocatie/tia:kadBinnenlandsAdres/tia:openbareRuimteNaam)
						and not(tia:IMKAD_ZakelijkRecht[tia:IMKAD_Perceel][1]/tia:IMKAD_Perceel/tia:kadBinnenlandsAdres/tia:openbareRuimteNaam)))]])"/>
		<xsl:variable name="binnenlandsAdresHuisnummer" select="count(tia:IMKAD_ZakelijkRecht[tia:IMKAD_Perceel[((tia:IMKAD_OZLocatie/tia:kadBinnenlandsAdres/tia:huisNummer
					= tia:IMKAD_ZakelijkRecht[tia:IMKAD_Perceel][1]/tia:IMKAD_Perceel/tia:IMKAD_OZLocatie/tia:kadBinnenlandsAdres/tia:huisNummer)
					or (not(tia:IMKAD_OZLocatie/tia:kadBinnenlandsAdres/tia:huisNummer)
						and not(tia:IMKAD_ZakelijkRecht[tia:IMKAD_Perceel][1]/tia:IMKAD_Perceel/tia:kadBinnenlandsAdres/tia:huisNummer)))]])"/>
		<xsl:variable name="binnenlandsAdresHuisletter" select="count(tia:IMKAD_ZakelijkRecht[tia:IMKAD_Perceel[((tia:IMKAD_OZLocatie/tia:kadBinnenlandsAdres/tia:huisLetter
					= tia:IMKAD_ZakelijkRecht[tia:IMKAD_Perceel][1]/tia:IMKAD_Perceel/tia:IMKAD_OZLocatie/tia:kadBinnenlandsAdres/tia:huisLetter)
					or (not(tia:IMKAD_OZLocatie/tia:kadBinnenlandsAdres/tia:huisLetter)
						and not(tia:IMKAD_ZakelijkRecht[tia:IMKAD_Perceel][1]/tia:IMKAD_Perceel/tia:kadBinnenlandsAdres/tia:huisLetter)))]])"/>
		<xsl:variable name="binnenlandsAdresHuisnummerToevoeging" select="count(tia:IMKAD_ZakelijkRecht[tia:IMKAD_Perceel[((tia:IMKAD_OZLocatie/tia:kadBinnenlandsAdres/tia:huisNummerToevoeging
					= tia:IMKAD_ZakelijkRecht[tia:IMKAD_Perceel][1]/tia:IMKAD_Perceel/tia:IMKAD_OZLocatie/tia:kadBinnenlandsAdres/tia:huisNummerToevoeging)
					or (not(tia:IMKAD_OZLocatie/tia:kadBinnenlandsAdres/tia:huisNummerToevoeging)
						and not(tia:IMKAD_ZakelijkRecht[tia:IMKAD_Perceel][1]/tia:IMKAD_Perceel/tia:kadBinnenlandsAdres/tia:huisNummerToevoeging)))]])"/>
		<xsl:choose>
			...
			<xsl:when test="((count(tia:IMKAD_ZakelijkRecht) = $aardVerkregen)
						and  (count(tia:IMKAD_ZakelijkRecht) = $aardVerkregenVariant)
						and  (count(tia:IMKAD_ZakelijkRecht) = $aantalBPRechten)
						and  (count(tia:IMKAD_ZakelijkRecht) = $aantalRechten)
						and  (count(tia:IMKAD_ZakelijkRecht) = $aantalRechtenVariant)
						and  (count(tia:IMKAD_ZakelijkRecht) = $kNaderTeOmschrijven)
						and  (count(tia:IMKAD_ZakelijkRecht) = $kEigendom)
						and  (count(tia:IMKAD_ZakelijkRecht) = $kMeervoud)
						and  (count(tia:IMKAD_ZakelijkRecht) = $kEeuwigdurend)
						and  (count(tia:IMKAD_ZakelijkRecht) = $kNaderTeOmschrijvenVariant)
						and  (count(tia:IMKAD_ZakelijkRecht) = $kMeervoudVariant)
						and  (count(tia:IMKAD_ZakelijkRecht) = $kEeuwigdurendVariant)
						and  (count(tia:IMKAD_ZakelijkRecht) = $kAantalBPRechtenVariant)
						and  (count(tia:IMKAD_ZakelijkRecht) = $kVoorlopigeGrenzen)
						and  (count(tia:IMKAD_ZakelijkRecht) = $kWijzeVanLevering)
						and  (count(tia:IMKAD_ZakelijkRecht) = $aandeelInRecht)
						and  (count(tia:IMKAD_ZakelijkRecht) = $omschrijvingEigendom)
						and  (count(tia:IMKAD_ZakelijkRecht) = $kMandeligheid)
						and  (count(tia:IMKAD_ZakelijkRecht) = $kAanduiding)
						and  (count(tia:IMKAD_ZakelijkRecht) = $kNabij)
						and  (count(tia:IMKAD_ZakelijkRecht) = $kKomma)
						and  (count(tia:IMKAD_ZakelijkRecht) = $splitsingsverzoekOrdernummer)
						and  (count(tia:IMKAD_ZakelijkRecht) = $reeks)
						and  (count(tia:IMKAD_ZakelijkRecht) = $deel)
						and  (count(tia:IMKAD_ZakelijkRecht) = $nummer)
						and  (count(tia:IMKAD_ZakelijkRecht) = $gemeente)
						and  (count(tia:IMKAD_ZakelijkRecht) = $sectie)
						and  (count(tia:IMKAD_ZakelijkRecht) = $ligging)
						and  (count(tia:IMKAD_ZakelijkRecht) = $huisnummer)
						and  (count(tia:IMKAD_ZakelijkRecht) = $huisletter)
						and  (count(tia:IMKAD_ZakelijkRecht) = $huisnummerToevoeging)
						and  (count(tia:IMKAD_ZakelijkRecht) = $postcode)
						and  (count(tia:IMKAD_ZakelijkRecht) = $openbareRuimteNaam)
						and  (count(tia:IMKAD_ZakelijkRecht) = $woonplaatsNaam)
						and  (count(tia:IMKAD_ZakelijkRecht) = $binnenlandsAdresPostcode)
						and  (count(tia:IMKAD_ZakelijkRecht) = $binnenlandsAdresWoonplaatsNaam)
						and  (count(tia:IMKAD_ZakelijkRecht) = $binnenlandsAdresOpenbareRuimteNaam)
						and  (count(tia:IMKAD_ZakelijkRecht) = $binnenlandsAdresHuisnummer)
						and  (count(tia:IMKAD_ZakelijkRecht) = $binnenlandsAdresHuisletter)
						and  (count(tia:IMKAD_ZakelijkRecht) = $binnenlandsAdresHuisnummerToevoeging))
						and $RegistergoedTonenPerPerceel='false' ">
				<p>
					<xsl:variable name="rightText">
	...
	**** named template ********************************************************************************
	-->
	<xsl:template match="tia:IMKAD_AangebodenStuk" mode="do-vve">
		<a name="hyp4.purchaseOption" class="location">&#160;</a>
			...
			<xsl:for-each select="tia:StukdeelLevering[tia:IMKAD_ZakelijkRecht]">
				...
				<xsl:variable name="stukdeelKoopVolgnummer">
					<xsl:choose>
						...
						<xsl:when test="translate($SoortLevering, $upper, $lower) = 'verkoop rechten met cessie' or translate($SoortLevering, $upper, $lower) = 'verkoop rechten met indeplaatsstelling'">
	...
	*********************************************************
	...
	Called by:
	(mode) do-keuzeblok-koopprijs
	(mode) do-keuzeblok-koopprijs-twee-levering-group
	(mode) do-keuzeblok-koopprijs-twee-levering-individual
	(mode) do-keuzeblok-koopprijs-twee-levering-group-next
	(mode) do-keuzeblok-koopprijs-twee-levering-individual-next
	-->
	<!--
	**** matching template ********************************************************************************
	-->
