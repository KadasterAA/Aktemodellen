...
<xsl:stylesheet xmlns="http://www.w3.org/1999/xhtml" xmlns:tia="http://www.kadaster.nl/schemas/KIK/TIA_Algemeen" xmlns:xlink="http://www.w3.org/1999/xlink"
    ...
    <xsl:variable name="keuzeteksten" select="document('keuzeteksten_hypotheek_aegon-6.0.0.xml')"/>
                            ...
                            <tbody>
                                    ...
                                    <td>
                                        <p>
                                            ...
                                            <xsl:if test="tia:IMKAD_AangebodenStuk/tia:StukdeelHypotheek[translate(tia:aanduidingHypotheek, $upper, $lower) = 'overbruggingshypotheek']">
                                                ...
                                                <xsl:text>, (hierna te noemen: de "Overbruggingshypotheek").</xsl:text>
                                                <br/>
                                                <xsl:text>Aegon verklaarde de hiervoor vermelde schuldbekentenis te aanvaarden.</xsl:text>
                                            </xsl:if>
                                            <br/>
                                            ...
                                            <xsl:if test="tia:IMKAD_AangebodenStuk/tia:StukdeelHypotheek[translate(tia:aanduidingHypotheek, $upper, $lower) = 'overbruggingshypotheek']">
                                                <xsl:text> en Overbruggingshypotheek</xsl:text>
                                            </xsl:if>
                                            <xsl:text>.</xsl:text>
                                            <br/>
                                            <b>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <br/>
                                        <xsl:text>De Lening heeft een looptijd zoals in de Overeenkomst van geldlening is overeengekomen, dan wel eventueel nader tussen partijen (zal worden) overeengekomen. De aflossing van de Lening vindt plaats op de wijze als bepaald in de aan deze akte gehechte Leningsovereenkomst, en de Algemene Voorwaarden welke zijn gehecht aan de Leningsovereenkomst, en / of op een nader door partijen overeen te komen wijze.</xsl:text>
                                        <br/>
                                        <u>
                                            <xsl:text>Rente</xsl:text>
                                        </u>
                                        <br/>
                                        <xsl:text>De Schuldenaar is rente over de Lening tegen het in de Overeenkomst van geldlening overeengekomen rentepercentage verschuldigd. De voor het eerst te betalen rente wordt berekend vanaf de datum waarop Aegon het bedrag van de Lening heeft overgeboekt naar de rekening van de notaris en / of naar de Bouwdepotrekening tot de laatste dag van de desbetreffende maand. Voor iedere volgende maand wordt de door de Schuldenaar te betalen rente berekend over het Uitstaande Bedrag per het einde van de daaraan voorafgaande maand.</xsl:text>
                                        <br/>
                                        <u>
                                            <xsl:text>Algemene Voorwaarden</xsl:text>
                                        </u>
                                        <br/>
                                        <xsl:text>Op de Overeenkomst van geldlening en op deze akte en de daarbij te verstrekken rechten van hypotheek en pand zijn van toepassing de Algemene Voorwaarden. De Algemene Voorwaarden worden geacht een onderdeel te zijn van de Overeenkomst van geldlening en deze akte als waren zij in de Overeenkomst van geldlening en deze akte woordelijk opgenomen. De (Derde) Hypotheekgever verklaart een exemplaar van de Algemene Voorwaarden te hebben ontvangen, daarvan kennis te hebben genomen en daarmee in te stemmen.</xsl:text>
                                        <br/>
                                        <u>
                            ...
                            <tbody>
                                    ...
                                    <td>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <p>
                                                        <xsl:text>de hiervoor bedoelde rente, boeten en kosten, die tezamen worden begroot op veertig procent (40%) van het onder (A) omschreven bedrag, zijnde </xsl:text>
                                                        <xsl:call-template name="amountText">
                                                            <xsl:with-param name="amount"
                                ...
                                <xsl:if test="tia:IMKAD_AangebodenStuk/tia:StukdeelHypotheek[translate(tia:aanduidingHypotheek, $upper, $lower) = 'overbruggingshypotheek']">
                                    <tr>
                                        ...
                                        <td>
                                            <b>
                                                <xsl:text>Hypotheekstelling Overbruggingshypotheek</xsl:text>
                                            </b>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <p>
                                                            <xsl:text>de hiervoor bedoelde rente, boeten en kosten, die tezamen worden begroot op veertig procent (40%) van het onder (I) omschreven bedrag, zijnde </xsl:text>
                                                            <xsl:call-template name="amountText">
                                                                <xsl:with-param name="amount"
