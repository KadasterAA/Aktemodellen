...
<!--
*********************************************************
Stylesheet: keuzeblok_partijnamen_in_hypotheekakten_aegon-1.0.xsl
Version: 1.0
- [AA-7712] Genderneutraal maken Hypotheekakten - ABP, Aegon Stater, Argenta, Credo
- [AA-7550] Aegon model: Verschil gebruik quootjes bij aanduiding hypotheekgever in bankmodel en TB PIH
*********************************************************
Description:
	...
	**** matching template ********************************************************************************
	...
	<xsl:template match="tia:Partij" mode="do-keuzeblok-partijnamen-hypotheekakte">
		...
		<xsl:choose>
			...
			<xsl:otherwise>
				<xsl:text>KEUZEBLOK PARTIJNAMEN IN HYPOTHEEKAKTE</xsl:text>
			</xsl:otherwise>
		</xsl:choose>
	</xsl:template>
	<!--
