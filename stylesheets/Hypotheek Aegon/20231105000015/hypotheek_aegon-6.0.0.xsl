...
Version: 6.0.0
- [AA-6054] Aegon wijzigingen op basis van model HYAEGO01
*************************************************************
...
<xsl:stylesheet xmlns="http://www.w3.org/1999/xhtml" xmlns:tia="http://www.kadaster.nl/schemas/KIK/TIA_Algemeen" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:kef="nl.kadaster.xslt.XslExtensionFunctions" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:gc="http://docs.oasis-open.org/codelist/ns/genericode/1.0/" exclude-result-prefixes="tia xsl xlink kef gc" version="1.0">
	...
	<xsl:variable name="keuzeteksten" select="document('keuzeteksten_hypotheek_aegon-5.0.0.xml')"/>
	...
	*********************************************************
	...
	Description: Aegon mortgage deed.
	...
	<xsl:template match="tia:Bericht_TIA_Stuk" mode="do-deed">
		...
		<tr>
			<td class="number" valign="top">
				<b><xsl:text>(1)</xsl:text></b>
			</td>
			<td valign="top">
				<b><xsl:text>OVEREENKOMST VAN GELDLENING</xsl:text></b>
			</td>
		</tr><tr>
			<td class="number" valign="top">
				<xsl:text>&#xFEFF;</xsl:text>
			...
			<td valign="top">
				<xsl:text>Tussen de schuldenaar en de geldgeefster is een overeenkomst van geldlening met hypotheekstelling en inpandgeving gesloten, hierna te noemen “de overeenkomst van geldlening”. Deze overeenkomst van geldlening is omschreven in het door geldgeefster gedane bindend aanbod onder nummer </xsl:text>
				<xsl:value-of select="tia:IMKAD_AangebodenStuk/tia:tia_TekstKeuze[tia:tagNaam='k_Offertenummer']/tia:tekst"/>
				<xsl:text>. Ter uitvoering van die overeenkomst van geldlening zal door geldgeefster een som geld aan de schuldenaar ter beschikking worden gesteld en zullen door de schuldenaar een recht van hypotheek en pandrechten ten behoeve van geldgeefster worden gevestigd, een en ander zoals in deze akte omschreven.</xsl:text>
			</td>
		</tr><tr>
			<td class="number" valign="top">
				<xsl:text>&#xFEFF;</xsl:text>
			...
			<td valign="top">
				<b><xsl:text>AANVULLENDE GELDLENING</xsl:text></b>
			</td>
		</tr><tr>
			<td class="number" valign="top">
				<xsl:text>&#xFEFF;</xsl:text>
			...
			<td valign="top">
				<xsl:text>De schuldenaar en de geldgeefster kunnen overeenkomen dat door de geldgeefster aan de schuldenaar een aanvullende geldlening wordt verstrekt, hierna te noemen: “de aanvullende geldlening”. Een aanvullende geldlening wordt alleen verstrekt voor zover het op grond van de voormelde overeenkomst van geldlening en eventuele aanvullende geldlening(en) uitstaande bedrag lager is dan het hierna onder HYPOTHEEKSTELLINGEN sub (A) genoemde bedrag en indien aan de op dat moment geldende acceptatiecriteria wordt voldaan.</xsl:text>
			</td>
		</tr><tr>
			<td class="number" valign="top">
				<b><xsl:text>(2)</xsl:text></b>
			</td>
			<td valign="top">
				<b><xsl:text>BEDRAG GELDLENING (Hypotheeknummer: </xsl:text>
				<xsl:value-of select="tia:IMKAD_AangebodenStuk/tia:tia_TekstKeuze[tia:tagNaam='k_Offertenummer']/tia:tekst"/>
				<xsl:text>)</xsl:text></b>
			</td>
		</tr><tr>
			...
			<td valign="top">
				<xsl:text>De schuldenaar verklaart van geldgeefster ter leen te hebben ontvangen en aan deze daarom een bedrag van </xsl:text>
		...
		<xsl:if test="tia:IMKAD_AangebodenStuk/tia:StukdeelHypotheek[translate(tia:aanduidingHypotheek, $upper, $lower) = 'overbruggingshypotheek']">
			<tr>
				<td class="number" valign="top">
					<b><xsl:text>(2a)</xsl:text></b>
				</td>
				<td valign="top">
					<b><xsl:text>OVERBRUGGINGSLENING (Hypotheeknummer: </xsl:text>
						<xsl:value-of select="tia:IMKAD_AangebodenStuk/tia:tia_TekstKeuze[tia:tagNaam='k_Offertenummer']/tia:tekst"/>
						<xsl:text>)</xsl:text></b>
				</td>
			</tr><tr>
			...
			<td valign="top">
				<xsl:text>De schuldenaar en geldgeefster verklaren hierbij tevens een overbruggingslening te hebben gesloten voor een bedrag van </xsl:text>
				<xsl:call-template name="amountText">
				...
				<xsl:text>, hierna te noemen “de overbruggingslening”. Deze overbruggingslening is omschreven in het bovengenoemde bindend aanbod, zo de schuldenaar uit meerdere personen bestaat onder het beding van hoofdelijke aansprakelijkheid en voorts onder de volgende bepalingen.</xsl:text>
			</td>
		</tr>
		</xsl:if>
			<tr>
				<td class="number" valign="top">
					<b><xsl:text>(3)</xsl:text></b>
				</td>
				<td valign="top">
					<b><xsl:text>HYPOTHEEKSTELLING(EN)</xsl:text></b>
				</td>
			</tr><tr>
			<td class="number" valign="top">
				<xsl:text>&#xFEFF;</xsl:text>
			...
			<td valign="top">
				...
				<table cellspacing="0" cellpadding="0">
					<tbody>
						...
						<xsl:text>de hiervoor bedoelde rente, boeten en kosten, die tezamen worden begroot op vijftig procent (50%) van het onder (A) omschreven bedrag, zijnde </xsl:text>
						<xsl:call-template name="amountText">
		...
		<xsl:if test="tia:IMKAD_AangebodenStuk/tia:StukdeelHypotheek[translate(tia:aanduidingHypotheek, $upper, $lower) = 'overbruggingshypotheek']">
			<tr>
				...
				<td valign="top">
					<xsl:text>De schuldenaar verleent daarnaast, tot zekerheid voor de betaling van al hetgeen geldgeefster te vorderen mocht hebben of krijgen op grond van de overbruggingslening, de betaling van de verschuldigde rente (ook indien deze betrekking heeft op een periode van langer dan drie jaar), boeten en de in de Algemene Voorwaarden bedoelde kosten, een recht van hypotheek </xsl:text>
					...
					<xsl:text> in rang en wel op het overbruggingspand zoals hierna vermeld</xsl:text>
					<table cellspacing="0" cellpadding="0">
						<tbody>
							<tr>
								<td class="number" valign="top">
								...
								<xsl:text>tot een bedrag van </xsl:text>
								<xsl:call-template name="amountText">
							...
							<xsl:text>de hiervoor bedoelde rente, boeten en kosten, die tezamen worden begroot op vijftig procent (50%) van het onder (I) omschreven bedrag, zijnde </xsl:text>
							<xsl:call-template name="amountText">
		...
		<tr>
			<td class="number" valign="top">
				...
				<xsl:text>De hypotheek of hypotheken zoals hierboven omschreven worden verleend op:</xsl:text><br />
			...
			<xsl:text>in deze akte te noemen “het registergoed”.</xsl:text>
		</td>
		</tr>
			<xsl:if test="tia:IMKAD_AangebodenStuk/tia:StukdeelHypotheek[translate(tia:aanduidingHypotheek, $upper, $lower) = 'overbruggingshypotheek']">
				<tr>
					...
					<xsl:text>Het overbruggingspand</xsl:text>
				</td>
				</tr><tr>
				<td class="number" valign="top">
					<xsl:text>&#xFEFF;</xsl:text>
					...
					<xsl:text>in deze akte te noemen “het overbruggingspand”.</xsl:text>
				</td>
				</tr>
			</xsl:if>
			<tr>
...
Bovendien is geldgeefster gerechtigd haar rechtsverhouding, inclusief alle afhankelijke rechten en nevenrechten, waaronder uitdrukkelijk mede begrepen pand- en/of hypotheekrechten, uit de overeenkomst van geldlening en/of een aanvullende geldlening en/of een overbruggingslening geheel of gedeeltelijk aan een derde over te dragen conform artikel 6:159 Burgerlijk Wetboek, waarvoor schuldenaar reeds nu, bij voorbaat, haar medewerking verleent. Van een eventuele overdracht zal mededeling worden gedaan aan de schuldenaar.
			...
			<td class="number" valign="top">
				<b><xsl:text>(4)</xsl:text></b>
			</td><td>
				<b><xsl:text>AANVAARDING ZEKERHEDEN EN HYPOTHEEKSTELLING(EN)</xsl:text></b>
			</td>
			</tr><tr>
				<td class="number" valign="top">
					<xsl:text>&#xFEFF;</xsl:text>
				</td><td>
				<xsl:text>Geldgeefster verklaart de hiervoor vermelde hypotheekstelling(en), de hierna vermelde (verpande) rechten, alle aangegane verbintenissen en alle verleende volmachten te aanvaarden.</xsl:text>
			</td>
		</tr>
	...
	*********************************************************
	...
	Description: Aegon mortgage deed rights.
	...
	*********************************************************
	...
	Description: Aegon mortgage deed election of domicile.
	...
	*********************************************************
	...
	Description: Aegon mortgage deed free text part.
	...
	*********************************************************
	...
	Description: Aegon mortgage deed parties.
	...
	<xsl:template match="tia:Partij" mode="do-parties">
		...
		<xsl:choose>
			...
			<xsl:when test="position() = 2">
				<p style="margin-left:30px">
					<xsl:text>hierna ook te noemen ’geldgeefster’, alsmede haar rechtverkrijgenden onder algemene en onder bijzondere titel. Overal waar in deze akte of de hierna te noemen Algemene Voorwaarden gesproken wordt van geldgeefster, zal na overgang hierin worden gelezen haar rechtsopvolger.</xsl:text>
					<br/>
					...
					<xsl:text>het volgende verklaard:</xsl:text>
				</p>
			</xsl:when>
		</xsl:choose>
	</xsl:template>
	...
	*********************************************************
	...
	Description: Aegon mortgage deed party persons.
