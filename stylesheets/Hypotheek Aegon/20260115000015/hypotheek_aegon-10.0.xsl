...
<xsl:stylesheet xmlns="http://www.w3.org/1999/xhtml" xmlns:tia="http://www.kadaster.nl/schemas/KIK/TIA_Algemeen" xmlns:xlink="http://www.w3.org/1999/xlink"
    ...
    <xsl:include href="keuzeblok_partijnamen_in_hypotheekakten_aegon-2.0.xsl"/>
    ...
    <xsl:variable name="keuzeteksten" select="document('keuzeteksten_hypotheek_aegon-8.0.0.xml')"/>
