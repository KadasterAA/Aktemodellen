...
Version: 5.0.0
AA-4406 - Aegon - bijwerken naar nieuwste versies tekstblokken
AA-4227 - Aegon - Stylesheet aanpassen naar algemene waardelijst met nnp-kodes
*************************************************************
...
<xsl:stylesheet xmlns="http://www.w3.org/1999/xhtml" xmlns:tia="http://www.kadaster.nl/schemas/KIK/TIA_Algemeen" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:kef="nl.kadaster.xslt.XslExtensionFunctions" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:gc="http://docs.oasis-open.org/codelist/ns/genericode/1.0/" exclude-result-prefixes="tia xsl xlink kef gc" version="1.0">
	...
	<xsl:variable name="keuzeteksten" select="document('keuzeteksten_hypotheek_aegon-4.1.0.xml')"/>
	...
	**** matching template ********************************************************************************
	...
	<xsl:template match="tia:Bericht_TIA_Stuk" mode="do-deed">
		...
		<p>
			<xsl:text>De comparanten, handelend als voormeld, verklaarden dat tussen hen een overeenkomst van geldlening met hypotheekstelling en inpandgeving is gesloten ten behoeve van de financiering van de verkrijging en/of verbouwing en/of verbetering van dan wel andere handelingen die verband houden met het hierna vermelde registergoed, welke overeenkomst is omschreven in het door geldgeefster gedane bindend aanbod onder nummer </xsl:text>
			<xsl:value-of select="tia:IMKAD_AangebodenStuk/tia:tia_TekstKeuze[tia:tagNaam='k_Offertenummer']/tia:tekst"/>
			<xsl:text>. Ter uitvoering van die overeenkomst zal door geldgeefster een som geld aan de schuldenaar ter beschikking worden gesteld en zullen door de schuldenaar een recht van hypotheek en pandrechten ten behoeve van geldgeefster worden gevestigd, een en ander zoals in deze akte omschreven. De schuldenaar en de geldgeefster kunnen overeenkomen dat onder deze akte een aanvullende geldlening wordt verstrekt tot maximaal de hieronder genoemde hoofdsom, hierna te noemen de “aanvullende geldlening”. Een aanvullende geldlening wordt alleen verstrekt voor zover het op grond van de voormelde overeenkomst en eventuele aanvullende geldlening(en) uitstaande leningbedrag lager is dan de hierna te noemen hoofdsom en indien aan de op dat moment geldende acceptatiecriteria wordt voldaan.</xsl:text>
		</p>
		<p>
			<b>
		...
		<xsl:if test="tia:IMKAD_AangebodenStuk/tia:StukdeelHypotheek[translate(tia:aanduidingHypotheek, $upper, $lower) = 'overbruggingshypotheek']">
			...
			<p>
				...
				<xsl:text>, hierna te noemen de overbrugging. Deze overbruggingslening is omschreven in het bovengenoemde aanbod, zo de schuldenaar uit meerdere personen bestaat onder het beding van hoofdelijke aansprakelijkheid en voorts onder de volgende bepalingen.</xsl:text>
			</p>
		</xsl:if>
		<p>
			<b>
		...
		<xsl:if test="tia:IMKAD_AangebodenStuk/tia:StukdeelHypotheek[translate(tia:aanduidingHypotheek, $upper, $lower) = 'overbruggingshypotheek']">
			<p>
				<u><xsl:text>Het overbruggingspand</xsl:text></u>
			</p>
			<a name="hyp3.rights" class="location">&#160;</a>
			<xsl:apply-templates select="." mode="do-rights">
		...
		<p>
			<xsl:text>Geldgeefster verklaart de hiervoor vermelde hypotheekstelling, de hierna vermelde (verpande) rechten, alle aangegane verbintenissen en alle verleende volmachten te aanvaarden.</xsl:text>
		</p>
