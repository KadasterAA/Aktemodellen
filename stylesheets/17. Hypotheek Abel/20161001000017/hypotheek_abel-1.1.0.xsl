...
<!--
*************************************************************
Stylesheet: hypotheek_abel.xsl
Version: 1.1.0 (AA-3140)
*************************************************************
...
<xsl:stylesheet xmlns="http://www.w3.org/1999/xhtml" xmlns:tia="http://www.kadaster.nl/schemas/KIK/TIA_Algemeen" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:kef="nl.kadaster.xslt.XslExtensionFunctions" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:gc="http://docs.oasis-open.org/codelist/ns/genericode/1.0/" exclude-result-prefixes="tia xsl xlink kef gc" version="1.0">
	...
	<xsl:variable name="keuzeteksten" select="document('keuzeteksten_hypotheek_abel-1.0.0.xml')"/>
	...
	*********************************************************
	...
	Description: Abel mortgage deed.
	...
	**** matching template ********************************************************************************
	...
	<xsl:template match="tia:Bericht_TIA_Stuk" mode="do-deed">
		...
		<table cellspacing="0" cellpadding="0">
			<tbody>
				<tr>
					...
					<td>Abel Hypotheken en de Schuldenaar zijn een leningsovereenkomst aangegaan, hierna te noemen: de "Leningsovereenkomst", van welke overeenkomst blijkt uit een door Abel Hypotheken uitgebracht en door de Schuldenaar geaccepteerd hypotheekaanbod. Een afschrift van het door Abel Hypotheken en Schuldenaar ondertekend hypotheekaanbod wordt aan deze akte gehecht.</td>
				</tr>
				<tr>
					<td class="number" valign="top">
						<xsl:text>&#xFEFF;</xsl:text>
					...
					<td>Blijkens de Leningsovereenkomst verstrekt Abel Hypotheken aan de Schuldenaar een geldlening voor het hierna te noemen bedrag en is de Schuldenaar verplicht aan Abel Hypotheken de in deze akte omschreven rechten van hypotheek en pand te (doen) verlenen op de wijze en onder de bepalingen en voorwaarden als uiteengezet in deze akte. </td>
				</tr>
				<tr>
					<td class="number" valign="top">
						<xsl:text>&#xFEFF;</xsl:text>
		...
		<p>
			<xsl:text>De Schuldenaar verklaarde wegens van Abel Hypotheken ter leen ontvangen gelden hoofdelijk schuldig te zijn aan Abel Hypotheken een bedrag van: </xsl:text>
		...
		<p>
			<xsl:text>Abel Hypotheken verklaarde de hiervoor vermelde schuldbekentenis te aanvaarden.</xsl:text>
			<br/>
			<xsl:text>Tot zekerheid voor de betaling van de Schuld is de Schuldenaar met Abel Hypotheken overeengekomen en heeft zich jegens Abel Hypotheken verbonden en, voor zover nodig verklaart hierbij met Abel Hypotheken overeen te komen en zich te verbinden, tot het vestigen en tot het bij voorbaat vestigen van het recht van hypotheek casu quo recht van pand zoals hierna wordt omschreven, ten behoeve van Abel Hypotheken.</xsl:text>
		</p>
		<p>
			<u>
		...
		<p>
			...
			<br/>
			<xsl:text>Onder het begrip "Schuld" wordt in deze akte verstaan: de schulden en verplichtingen tot zekerheid voor de betaling waarvan de Schuldenaar blijkens deze akte aan Abel Hypotheken het recht van hypotheek op het in deze akte genoemde Onderpand verleent of behoort te verlenen.</xsl:text>
		</p>
		<xsl:if test="translate(tia:IMKAD_AangebodenStuk/tia:tia_TekstKeuze[translate(tia:tagNaam, $upper, $lower) = 'k_svnstarterslening']/tia:tekst, $upper, $lower) = 'true'">
			...
			<p>
				<xsl:text>In verband met de door de Stichting Stimuleringsfonds Volkshuisvesting Nederlandse Gemeenten (SVn) te verstrekken Starterslening, heeft Abel Hypotheken zich jegens SVn en Stichting Waarborgfonds Eigen Woningen (WEW) verplicht, na het ingaan van de lening geen gelden meer onder verband van de eerste hypotheekstelling ter leen te verstrekken aan de Schuldenaar. Tevens heeft Abel Hypotheken zich jegens SVn en WEW verplicht reeds afgeloste bedragen op de lening, onder verband van de eerste hypotheekstelling, niet opnieuw te laten opnemen door de Schuldenaar. Voormelde verplichtingen rusten op Abel Hypotheken uitsluitend zolang de bij SVn aangegane Starterslening niet volledig is afgelost.</xsl:text>
			</p>
		</xsl:if>
		<p>
			...
			<tbody>
				<tr>
					...
					<td valign="top">
						...
						<xsl:text>, (daaronder begrepen de eventueel aan de Schuldenaar terugbetaalde aflossingsbedragen) en voorts de betaling van al hetgeen de Schuldenaar nu of op enig tijdstip in de toekomst al dan niet opeisbaar, voorwaardelijk of onder tijdsbepaling aan Abel Hypotheken verschuldigd is of zal worden uit hoofde van de Leningsovereenkomst, deze akte, de Algemene Voorwaarden, eerdere met betrekking tot het hierna te noemen Onderpand verstrekte geldleningen, dan wel uit welke hoofde dan ook, tot een bedrag van </xsl:text>
						<xsl:call-template name="amountText">
				...
				<tr>
					...
					<td valign="top">
						<xsl:text>de betaling van de rente (inclusief overeen te komen verhogingen), vertragingsrente, kosten, schadevergoedingen en/of andere vergoedingen nu of in de toekomst aan Abel Hypotheken verschuldigd  uit hoofde van de Leningsovereenkomst en de betaling van al hetgeen Abel Hypotheken overigens uit hoofde van de Leningsovereenkomst, deze akte of de Algemene Voorwaarden van de Schuldenaar te vorderen mocht hebben, welke in deze paragraaf b bedoelde bedragen gezamenlijk worden begroot op een bedrag van </xsl:text>
						<xsl:call-template name="amountText">
		...
		<p>
			...
			<xsl:text>, verleent de Hypotheekgever bij deze aan Abel Hypotheken die van de Hypotheekgever aanvaardt, het recht van </xsl:text>
		...
		<p>
			<xsl:text>Hierna wordt onder Onderpand tevens verstaan ieder ander registergoed waarop hypothecaire zekerheid is gevestigd ten behoeve van Abel Hypotheken in verband met de Lening.</xsl:text>
		</p>
		...
		<p>
			<xsl:text>De Hypotheekgever staat er voorts jegens Abel Hypotheken voor in:</xsl:text>
		</p>
		<table cellspacing="0" cellpadding="0">
			<tbody>
				<tr>
					...
					<td valign="top">
						<xsl:text>dat het voormelde Onderpand hem in volle en onbezwaarde eigendom toebehoort, behoudens het (de) eventuele ten behoeve van Abel Hypotheken eerder gevestigde hypotheekrecht(en) ten laste van de Hypotheekgever, en dat hij daarover de onvoorwaardelijke beschikking heeft;</xsl:text>
					</td>
				</tr>
				<tr>
					<td class="number" valign="top">
				...
				<tr>
					...
					<td valign="top">
						<xsl:text>dat het voormelde Onderpand niet anders met recht van hypotheek is of kan worden bezwaard dan krachtens deze akte, behoudens het (de) eventuele ten behoeve van Abel Hypotheken eerder gevestigde hypotheekrecht(en) ten laste van de Hypotheekgever.</xsl:text>
					</td>
				</tr>
			</tbody>
		</table>
		<p>
			<xsl:text>De Hypotheekgever en Abel Hypotheken komen hierbij overeen dat, indien Abel Hypotheken (een deel van) haar vordering(en) tot zekerheid waarvan onderhavig hypotheekrecht wordt gevestigd, overdraagt aan een derde, op deze derde tevens een met (het overgedragen deel van) deze vordering(en) evenredig deel van het hiervoor bedoelde hypotheekrecht als nevenrecht zal overgaan.</xsl:text>
		</p>
			...
			<table cellspacing="0" cellpadding="0">
				<tbody>
					<tr>
						...
						<td valign="top">
							<xsl:text>dat het onder Overbruggingshypotheek vermelde onderpand hem in volle en onbezwaarde eigendom toebehoort, behoudens het (de) ten behoeve van Abel Hypotheken of andere hypotheekhouders eerder gevestigde hypotheekrecht(en) ten laste van de Hypotheekgever, en dat hij daarover de onvoorwaardelijke beschikking heeft;</xsl:text>
						</td>
					</tr>
					<tr>
						<td class="number" valign="top">
					...
					<tr>
						...
						<td valign="top">
							<xsl:text>dat het onder Overbruggingshypotheek vermelde onderpand niet anders met recht van hypotheek is of kan worden bezwaard dan krachtens deze akte, behoudens het (de) ten behoeve van Abel Hypotheken of andere hypotheekhouders eerder gevestigde hypotheekrecht(en) ten laste van de Hypotheekgever.</xsl:text>
						</td>
					</tr>
				</tbody>
			</table>
		...
		<xsl:choose>
			<xsl:when test="position() = 1">
				<p style="margin-left:30px">
					<xsl:text>hierna te noemen "Abel Hypotheken";</xsl:text>
				</p>
			</xsl:when>
			<xsl:when test="position() = 2">
				<p style="margin-left:30px">
					...
					<br/>
					<xsl:text>de “Hypotheekgever” en “Schuldenaar”; </xsl:text>
				</p>
			</xsl:when>
		</xsl:choose>
	</xsl:template>
	...
	**** Overbruggingshypotheek      ********************************************************************************
	...
	<xsl:template match="tia:StukdeelHypotheek" mode="do-overbruggingshypotheek">
		...
		<p>
			<xsl:text>Voorts verleent de Hypotheekgever tot zekerheid voor de betaling van de Schuld als hiervoor omschreven, bij deze aan Abel Hypotheken, die van de Hypotheekgever aanvaardt, het recht van </xsl:text>
