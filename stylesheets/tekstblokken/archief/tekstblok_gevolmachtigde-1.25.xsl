			...
			<xsl:when test="tia:tekstkeuze[translate(tia:tagNaam, $upper, $lower) = 'k_optie']/tia:tekst = '2'">
				<xsl:choose>
					<xsl:when test="count(tia:GerelateerdPersoon) = 0">
						...
						<xsl:if test="$maritalStatusVariant = '3' or $maritalStatusVariant = '4' or $maritalStatusVariant = '5' or $maritalStatusVariant = '7' or $maritalStatusVariant = '9' or 
 									  $maritalStatusVariant = '10' or $maritalStatusVariant = '13' or $maritalStatusVariant = '15' or $maritalStatusVariant = '17' or $maritalStatusVariant = '18' or   
	 								  $maritalStatusVariant = '19' or $maritalStatusVariant = '22' or $maritalStatusVariant = '23' or $maritalStatusVariant = '25' or $maritalStatusVariant = '27' or 
									  $maritalStatusVariant = '28' or $maritalStatusVariant = '29' or $maritalStatusVariant = '33' or $maritalStatusVariant = '34'">
							<xsl:text> </xsl:text>
						...
						<xsl:choose>
							...
							<xsl:when test="translate(tia:GerelateerdPersoon/tia:IndGezamenlijkeWoonlocatie, $upper, $lower) = 'false' and tia:tekstkeuze[translate(tia:tagNaam, $upper, $lower) = 'k_burgerlijkestaattekst']/tia:tekst">
								...
								<xsl:for-each select="tia:GerelateerdPersoon">
									...
									<xsl:text>, wonende te </xsl:text>
									<xsl:apply-templates select="tia:IMKAD_Persoon/tia:IMKAD_WoonlocatiePersoon" mode="do-address" />
									<xsl:if test="$maritalStatusForPerson = '3' or $maritalStatusForPerson = '4' or $maritalStatusForPerson = '5' or $maritalStatusForPerson = '7' or $maritalStatusForPerson = '9' or 
			  									  $maritalStatusForPerson = '10' or $maritalStatusForPerson = '13' or $maritalStatusForPerson = '15' or $maritalStatusForPerson = '17' or $maritalStatusForPerson = '18' or   
				 								  $maritalStatusForPerson = '19' or $maritalStatusForPerson = '22' or $maritalStatusForPerson = '23' or $maritalStatusForPerson = '25' or $maritalStatusForPerson = '27' or 
												  $maritalStatusForPerson = '28' or $maritalStatusForPerson = '29' or $maritalStatusForPerson = '33' or $maritalStatusForPerson = '34'">
										<xsl:text>, </xsl:text>
		...
		<xsl:choose>
			...
			<xsl:when test="$capacityVariant = '6'">
				...
				<xsl:variable name="capacityTextVariant6WithGender">
					<xsl:value-of select="concat(substring-before($capacityTextVariant6, 'zijn/haar/hun'), $genderVariant6, substring-after($capacityTextVariant6, 'zijn/haar/hun'))"/>
				</xsl:variable>
