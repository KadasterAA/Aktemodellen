...
<xsl:stylesheet xmlns="http://www.w3.org/1999/xhtml"
	...
	*********************************************************
	...
	Input: tia:algemeneVoorwaarden, tia:doorTeHalenStuk, tia:vervallenInschrijving, tia:stukTeHandhavenBeperking, tia:gegevensInschrijving
	...
	**** matching template ********************************************************************************
	-->
	<xsl:template match="tia:algemeneVoorwaarden | tia:doorTeHalenStuk | tia:vervallenInschrijving | tia:stukTeHandhavenBeperking | tia:gegevensInschrijving" mode="do-part-and-number">
