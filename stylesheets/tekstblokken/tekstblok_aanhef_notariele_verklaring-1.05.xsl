...
<xsl:stylesheet xmlns="http://www.w3.org/1999/xhtml"
	...
	**** matching template ********************************************************************************
	...
	<xsl:template match="tia:IMKAD_AangebodenStuk" mode="do-header">
		...
		<xsl:variable name="following" select="tia:tia_TekstKeuze[translate(tia:tagNaam, $upper, $lower) = 'k_volgend']/tia:tekst[translate(normalize-space(.), $upper, $lower) = 
			...
			translate(normalize-space(current()/tia:tia_TekstKeuze[translate(tia:tagNaam, $upper, $lower) = 'k_volgend']/tia:tekst), $upper, $lower)]), $upper, $lower)]" />
