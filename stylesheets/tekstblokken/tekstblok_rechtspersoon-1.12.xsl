...
<xsl:stylesheet xmlns="http://www.w3.org/1999/xhtml"
	...
	**** matching template ********************************************************************************
	...
	<xsl:template match="tia:NHR_Rechtspersoon | tia:vofCvMs" mode="do-chamber-of-commerce-data">
		...
		<xsl:choose>
			<xsl:when test="tia:FINummer and normalize-space(tia:FINummer) != ''">
			...
			<xsl:when test="translate(tia:rechtsvormSub, $upper, $lower) = 'publiekrechtelijk rechtspersoon' and normalize-space($gegevensOndertekening/tia:naamGemeente) != ''">
