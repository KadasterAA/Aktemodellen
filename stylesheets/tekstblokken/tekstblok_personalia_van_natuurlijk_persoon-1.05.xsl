...
<xsl:stylesheet xmlns="http://www.w3.org/1999/xhtml"
	...
	**** matching template ********************************************************************************
	-->
	<xsl:template  match="tia:verklaarder | tia:waarnemerVoor | tia:tia_WaarnemerVoor | tia:tia_Ondertekenaar | tia:GBA_Ingezetene | tia:IMKAD_NietIngezetene | tia:persoonGegevens | tia:kadGegevensPersoon | tia:kadGegevensVerklaarder | tia:IMKAD_KadNatuurlijkPersoon" mode="do-natural-person-personal-data">
