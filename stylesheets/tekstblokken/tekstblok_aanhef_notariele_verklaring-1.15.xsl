	...
	<xsl:template match="tia:IMKAD_AangebodenStuk" mode="do-header">
		...
		<p>
			...
			<xsl:choose>
				<xsl:when test="not(tia:heeftOndertekenaar/tia:tekstkeuze[translate(tia:tagNaam, $upper, $lower) = 'k_ondertekenaarwaarneming'])">
					...
					<xsl:if test="$woonplaats">
						<xsl:if test="tia:heeftOndertekenaar/tia:gemeente and not(tia:heeftOndertekenaar/tia:tekstkeuze[translate(tia:tagNaam, $upper, $lower) = 'k_komma']/tia:tekst = 'false')">
							<xsl:text>,</xsl:text>
						</xsl:if>
						<xsl:text> </xsl:text>
						<xsl:choose>
						...
						<xsl:when test="translate(tia:heeftOndertekenaar/tia:tekstkeuze[translate(tia:tagNaam, $upper, $lower) = 'k_ondertekenaarwaarneming']/tia:tekst, $upper, $lower) = 'vacant kantoor'">
							...
							<xsl:if test="tia:heeftOndertekenaar/tia:isWaarnemerVoor">
								...
								<xsl:if test="tia:heeftOndertekenaar/tia:isWaarnemerVoor/tia:standplaats">
									<xsl:if test="tia:heeftOndertekenaar/tia:isWaarnemerVoor/tia:gemeente and not(tia:heeftOndertekenaar/tia:isWaarnemerVoor/tia:tekstkeuze[translate(tia:tagNaam, $upper, $lower) = 'k_komma']/tia:tekst = 'false')">
										<xsl:text>,</xsl:text>
									</xsl:if>
									<xsl:text> </xsl:text>
									<xsl:choose>
							...
							<xsl:choose>
								<xsl:when test="tia:heeftOndertekenaar/tia:isVacatureWaarnemerVoor">
									...
									<xsl:if test="tia:heeftOndertekenaar/tia:isVacatureWaarnemerVoor/tia:standplaats">
										<xsl:if test="tia:heeftOndertekenaar/tia:isVacatureWaarnemerVoor/tia:gemeente and not(tia:heeftOndertekenaar/tia:isVacatureWaarnemerVoor/tia:tekstkeuze[translate(tia:tagNaam, $upper, $lower) = 'k_komma']/tia:tekst = 'false')">
											<xsl:text>,</xsl:text>
										</xsl:if>
										<xsl:text> </xsl:text>
										<xsl:choose>
								...
								<xsl:otherwise>
									...
									<xsl:if test="tia:heeftOndertekenaar/tia:isWaarnemerVoor/tia:isVacatureWaarnemerVoor/tia:standplaats">
										<xsl:if test="tia:heeftOndertekenaar/tia:isWaarnemerVoor/tia:isVacatureWaarnemerVoor/tia:gemeente and not(tia:heeftOndertekenaar/tia:isWaarnemerVoor/tia:isVacatureWaarnemerVoor/tia:tekstkeuze[translate(tia:tagNaam, $upper, $lower) = 'k_komma']/tia:tekst = 'false')">
											<xsl:text>,</xsl:text>
										</xsl:if>
										<xsl:text> </xsl:text>
										<xsl:choose>
			...
			<xsl:if test="tia:heeftOndertekenaar/tia:tekstkeuze[translate(tia:tagNaam, $upper, $lower) = 'k_ondertekenaarwaarneming'] and
						...
						translate(tia:heeftOndertekenaar/tia:tekstkeuze[translate(tia:tagNaam, $upper, $lower) = 'k_ondertekenaarwaarneming']/tia:tekst, $upper, $lower) != 'niet vacant kantoor'">
				<xsl:text>, notaris</xsl:text>
				<xsl:if test="tia:heeftOndertekenaar/tia:isWaarnemerVoor/tia:gemeente">
					<xsl:text> in de gemeente </xsl:text>
					<xsl:value-of select="tia:heeftOndertekenaar/tia:isWaarnemerVoor/tia:gemeente"/>
				</xsl:if>
				<xsl:if test="tia:heeftOndertekenaar/tia:isWaarnemerVoor/tia:gemeente and tia:heeftOndertekenaar/tia:isWaarnemerVoor/tia:standplaats  and not(tia:heeftOndertekenaar/tia:isWaarnemerVoor/tia:tekstkeuze[translate(tia:tagNaam, $upper, $lower) = 'k_komma']/tia:tekst = 'false')">
					<xsl:text>,</xsl:text>
				</xsl:if>
				<xsl:if test="tia:heeftOndertekenaar/tia:isWaarnemerVoor/tia:standplaats">
					<xsl:text> </xsl:text>
