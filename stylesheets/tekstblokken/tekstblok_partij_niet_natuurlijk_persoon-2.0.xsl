		...
		<xsl:choose>
			...
			<xsl:when test="$capacityVariant = '2'">
				...
				<xsl:variable name="capacityTextVariant2WithGender">
					<xsl:choose>
						<xsl:when test="contains($capacityTextVariant2, 'zijn/haar/diens/hun')">
							<xsl:value-of select="concat(substring-before($capacityTextVariant2, 'zijn/haar/diens/hun'), $gender, substring-after($capacityTextVariant2, 'zijn/haar/diens/hun'))"/>
						</xsl:when>
						<xsl:otherwise>
			...
			<xsl:when test="$capacityVariant = '6'">
				...
				<xsl:variable name="capacityTextVariant6WithGender">
					<xsl:choose>
						<xsl:when test="contains($capacityTextVariant6, 'zijn/haar/diens/hun')">
							<xsl:value-of select="concat(substring-before($capacityTextVariant6, 'zijn/haar/diens/hun'), $gender, substring-after($capacityTextVariant6, 'zijn/haar/diens/hun'))"/>
						</xsl:when>
						<xsl:otherwise>
			...
			<xsl:when test="$capacityVariant = '7'">
				...
				<xsl:variable name="placeVariant7">
					<xsl:value-of select="tia:tia_GegevensOndertekening[tia:soortOndertekening = 'beschikking kantonrechter']/tia:naamGemeente"/>
				</xsl:variable>
				<xsl:variable name="dateVariant7">
					<xsl:value-of select="tia:tia_GegevensOndertekening[tia:soortOndertekening = 'beschikking kantonrechter']/tia:datum"/>
				</xsl:variable>
