...
<xsl:stylesheet xmlns="http://www.w3.org/1999/xhtml"
	...
	**** matching template ********************************************************************************
	-->
	<xsl:template match="tia:IMKAD_Persoon" mode="do-legal-person">
	...
	**** matching template ********************************************************************************
	-->
	<xsl:template match="tia:NHR_Rechtspersoon" mode="do-legal-person-data">
		<xsl:choose>
			<xsl:when test="translate(tia:rechtsvormSub, $upper, $lower) = 'de staat' or tia:rechtsvormSub = ''"/>
			<xsl:when test="translate(tia:rechtsvormSub, $upper, $lower) = 'kerkgenootschap alsmede haar zelfstandige onderdelen'">
