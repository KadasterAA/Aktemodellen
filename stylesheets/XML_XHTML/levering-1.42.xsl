...
<xsl:stylesheet xmlns="http://www.w3.org/1999/xhtml"
	...
	<xsl:variable name="keuzeteksten" select="document('keuzeteksten-levering-1.18.xml')"/>
			...
			<table cellspacing="0" cellpadding="0">
				<tbody>
					<xsl:for-each select="$acquirerParty/tia:IMKAD_Persoon[tia:tia_AandeelInRechten or tia:GerelateerdPersoon[translate(tia:tia_IndPartij, $upper, $lower) = 'true']/tia:IMKAD_Persoon[tia:tia_AandeelInRechten]]">
						...
						<!-- manager on legal person / second and above persons in person group -->
						<xsl:for-each select="tia:GerelateerdPersoon[translate(tia:tia_IndPartij, $upper, $lower) = 'true' and tia:IMKAD_Persoon/tia:tia_AandeelInRechten]/tia:IMKAD_Persoon">
							<tr>
								<td class="number" valign="top">
									<xsl:text>-</xsl:text>
								</td>
		    	...
		    	<xsl:choose>
		    		...
		    		<xsl:when test="translate(tia:StukdeelKoop[tia:tia_Volgnummer = '1']/tia:tekstkeuze[translate(tia:tagNaam, $upper, $lower) = 'k_koopprijsvariant']/tia:tekst, $upper, $lower) = 'roerende zaken exclusief'">
		    			<xsl:variable name="partyTextOne">
		    				<xsl:choose>
		    					<xsl:when test="tia:StukdeelKoop[tia:tia_Volgnummer = '1']/tia:koopprijsSpecificatie/tia:tekstkeuze[translate(tia:tagNaam, $upper, $lower) = 'k_partijkeuzekoopprijs']/tia:tekst = '1'">
		    						<xsl:call-template name="capitalizePartyAlias">
										<xsl:with-param name="party" select="tia:Partij[@id = substring-after(current()/tia:StukdeelKoop[tia:tia_Volgnummer = '1']/tia:vervreemderRechtRef/@xlink:href, '#')]"/>
									</xsl:call-template>
		    					</xsl:when>
		    					<xsl:when test="tia:StukdeelKoop[tia:tia_Volgnummer = '1']/tia:koopprijsSpecificatie/tia:tekstkeuze[translate(tia:tagNaam, $upper, $lower) = 'k_partijkeuzekoopprijs']/tia:tekst = '2'">
		    						<xsl:call-template name="capitalizePartyAlias">
										<xsl:with-param name="party" select="tia:Partij[@id = substring-after(current()/tia:StukdeelKoop[tia:tia_Volgnummer = '1']/tia:verkrijgerRechtRef/@xlink:href, '#')]"/>
									</xsl:call-template>
		    					</xsl:when>
		    					<xsl:when test="tia:StukdeelKoop[tia:tia_Volgnummer = '1']/tia:koopprijsSpecificatie/tia:tekstkeuze[translate(tia:tagNaam, $upper, $lower) = 'k_partijkeuzekoopprijs']/tia:tekst = '3'">
		    						<xsl:call-template name="capitalizePartyAlias">
										<xsl:with-param name="party" select="tia:Partij[@id = substring-after(current()/tia:StukdeelKoop[tia:tia_Volgnummer = '1']/tia:vervreemderRechtRef/@xlink:href, '#')]"/>
									</xsl:call-template>
		    						<xsl:text> en </xsl:text>
		    			...
		    			<xsl:variable name="partyTextTwo">
		    				<xsl:choose>
		    					<xsl:when test="tia:StukdeelKoop[tia:tia_Volgnummer = '2']/tia:koopprijsSpecificatie/tia:tekstkeuze[translate(tia:tagNaam, $upper, $lower) = 'k_partijkeuzekoopprijs']/tia:tekst = '1'">
		    						<xsl:call-template name="capitalizePartyAlias">
										<xsl:with-param name="party" select="tia:Partij[@id = substring-after(current()/tia:StukdeelKoop[tia:tia_Volgnummer = '2']/tia:vervreemderRechtRef/@xlink:href, '#')]"/>
									</xsl:call-template>
		    					</xsl:when>
		    					<xsl:when test="tia:StukdeelKoop[tia:tia_Volgnummer = '2']/tia:koopprijsSpecificatie/tia:tekstkeuze[translate(tia:tagNaam, $upper, $lower) = 'k_partijkeuzekoopprijs']/tia:tekst = '2'">
		    						<xsl:call-template name="capitalizePartyAlias">
										<xsl:with-param name="party" select="tia:Partij[@id = substring-after(current()/tia:StukdeelKoop[tia:tia_Volgnummer = '2']/tia:verkrijgerRechtRef/@xlink:href, '#')]"/>
									</xsl:call-template>
		    					</xsl:when>
		    					<xsl:when test="tia:StukdeelKoop[tia:tia_Volgnummer = '2']/tia:koopprijsSpecificatie/tia:tekstkeuze[translate(tia:tagNaam, $upper, $lower) = 'k_partijkeuzekoopprijs']/tia:tekst = '3'">
		    						<xsl:call-template name="capitalizePartyAlias">
										<xsl:with-param name="party" select="tia:Partij[@id = substring-after(current()/tia:StukdeelKoop[tia:tia_Volgnummer = '2']/tia:vervreemderRechtRef/@xlink:href, '#')]"/>
									</xsl:call-template>
		    						<xsl:text> en </xsl:text>
		    		...
		    		<xsl:when test="translate(tia:StukdeelKoop[tia:tia_Volgnummer = '1']/tia:tekstkeuze[translate(tia:tagNaam, $upper, $lower) = 'k_koopprijsvariant']/tia:tekst, $upper, $lower) = 'roerende zaken exclusief'">
		    			<xsl:variable name="partyText">
		    				<xsl:choose>
		    					...
		    					<xsl:when test="tia:StukdeelKoop[tia:tia_Volgnummer = '1']/tia:koopprijsSpecificatie/tia:tekstkeuze[translate(tia:tagNaam, $upper, $lower) = 'k_partijkeuzekoopprijs']/tia:tekst = '1' and $variant = '1'">
		    						<xsl:call-template name="capitalizePartyAlias">
										<xsl:with-param name="party" select="tia:Partij[@id = substring-after(current()/tia:StukdeelKoop[tia:tia_Volgnummer = '1']/tia:verkrijgerRechtRef/@xlink:href, '#')]"/>
									</xsl:call-template>
		    					</xsl:when>
		    					<xsl:when test="tia:StukdeelKoop[tia:tia_Volgnummer = '1']/tia:koopprijsSpecificatie/tia:tekstkeuze[translate(tia:tagNaam, $upper, $lower) = 'k_partijkeuzekoopprijs']/tia:tekst = '3' and $variant = '1'">
		    						<xsl:call-template name="capitalizePartyAlias">
										<xsl:with-param name="party" select="tia:Partij[@id = substring-after(current()/tia:StukdeelKoop[tia:tia_Volgnummer = '1']/tia:verkrijgerRechtRef/@xlink:href, '#')]"/>
									</xsl:call-template>
		    						<xsl:text> en </xsl:text>
		    					...
		    					<xsl:when test="tia:StukdeelKoop[tia:tia_Volgnummer = '1']/tia:koopprijsSpecificatie/tia:tekstkeuze[translate(tia:tagNaam, $upper, $lower) = 'k_partijkeuzekoopprijs']/tia:tekst = '1' and ($variant = '3' or $variant = '4')">
		    						<xsl:call-template name="capitalizePartyAlias">
										<xsl:with-param name="party" select="tia:Partij[@id = substring-after(current()/tia:StukdeelKoop[tia:tia_Volgnummer = '2']/tia:verkrijgerRechtRef/@xlink:href, '#')]"/>
									</xsl:call-template>
		    					</xsl:when>
		    					<xsl:when test="tia:StukdeelKoop[tia:tia_Volgnummer = '1']/tia:koopprijsSpecificatie/tia:tekstkeuze[translate(tia:tagNaam, $upper, $lower) = 'k_partijkeuzekoopprijs']/tia:tekst = '3' and ($variant = '3' or $variant = '4')">
		    						<xsl:call-template name="capitalizePartyAlias">
										<xsl:with-param name="party" select="tia:Partij[@id = substring-after(current()/tia:StukdeelKoop[tia:tia_Volgnummer = '2']/tia:verkrijgerRechtRef/@xlink:href, '#')]"/>
									</xsl:call-template>
		    						<xsl:text> en </xsl:text>
