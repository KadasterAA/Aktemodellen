...
Version: 1.2.0 (AA-910: TB Burgerlijke Staat en TB Gevolmachtigde)
*************************************************************
...
<xsl:stylesheet xmlns="http://www.w3.org/1999/xhtml" xmlns:tia="http://www.kadaster.nl/schemas/KIK/TIA_Algemeen" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:kef="nl.kadaster.xslt.XslExtensionFunctions" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:gc="http://docs.oasis-open.org/codelist/ns/genericode/1.0/" exclude-result-prefixes="tia xsl xlink kef gc" version="1.0">
	...
	<xsl:variable name="keuzeteksten" select="document('keuzeteksten_hypotheek_sns-1.2.0.xml')"/>
			...
			<tbody>
				<tr>
					...
					<td>
						...
						<xsl:text> en zoals deze is of zal worden vastgelegd in een door de bank en de schuldenaar gesloten respectievelijk te sluiten overeenkomst van geldlening SNS Bank (particulier) of zoals deze eventueel, al dan niet met kredietfaciliteiten, later gewijzigd, aangevuld of verhoogd mocht worden;</xsl:text>
					</td>
				</tr>
				<tr>
					<td class="number" valign="top">
		...
		<p style="margin-left:30px">
			<xsl:choose>
				...
				<xsl:when test="position() = 2">
					<xsl:text>hierna zowel SNS Bank N.V. als haar rechtsopvolgers onder algemene of bijzondere titel te noemen: '</xsl:text>
					<u>
