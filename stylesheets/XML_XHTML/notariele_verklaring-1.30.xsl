...
<xsl:stylesheet xmlns="http://www.w3.org/1999/xhtml"
	...
	<xsl:include href="tekstblok_aanhef_notariele_verklaring-1.05.xsl"/>	
	...
	<xsl:variable name="keuzeteksten" select="document('keuzeteksten-notariele_verklaring-1.07.xml')"/>        
	...
	**** matching template ********************************************************************************
	...
	<xsl:template match="tia:Partij" mode="do-parties">
		...
		<xsl:variable name="numberOfPersons" select="count(tia:IMKAD_Persoon) + count(tia:IMKAD_Persoon/tia:GerelateerdPersoon[tia:tia_IndPartij = 'true'])"/>
