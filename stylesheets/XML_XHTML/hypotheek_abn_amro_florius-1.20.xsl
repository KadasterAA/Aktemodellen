...
<xsl:stylesheet xmlns="http://www.w3.org/1999/xhtml"
	...
	<!-- ABN AMRO Florius specific global variables -->
	<xsl:variable name="keuzeteksten" select="document('keuzeteksten_hypotheek_abn_amro_florius-1.07.xml')"/>
	<xsl:variable name="documentTitle">
		<xsl:choose>
			...
			<xsl:otherwise><xsl:text>ABN AMRO Florius Hypotheek</xsl:text></xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
