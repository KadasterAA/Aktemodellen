...
|---|---|
**Versie Bankmodel ASN**|HYASNBA00 (model BA1 Particulier) versie juni 2023|
**Stylesheetnummer**|20240601000033 implementatienummer 1|
**Release**|11 juni 2024|

## Wijzigingen
|Wijziging|Omschrijving|Oplossing|
|---|---|---|
AA-6528 | Oplevering nieuw bankmodel tbv van ASN Hypotheken. |Toelichting, Modeldocument, stylesheets en backend controles|


### TB Equivalentieverklaring
|Wijziging|Omschrijving|Oplossing|
|---|---|---|
AA-6057 | Nieuwe versie van de stylesheet opgenomen in de ASN. Het tekstblok is aangepast vanwege de aanpassingen tbv de Omgevingswet. Deze wijzigingen hebben geen betrekking op de ASN akte. | Stylesheet |


### Specificaties
Naam|Versie MD/TB|Versie Toelich.|  |
| --- |--- |--- |---|
Modeldocument ASN|**[1.0.0](/kik-modeldocumenten/modeldocumenten/Hypotheek%20ASN/20240601000033/Modeldocument%20ASN%20Bank%20v1.0.0.docx)**|**[1.0.0](/kik-modeldocumenten/modeldocumenten/Hypotheek%20ASN/20240601000033/Toelichting%20modeldocument%20ASN%20Bank%201.0.0%20-%20v1.0.0.docx)**| X |
