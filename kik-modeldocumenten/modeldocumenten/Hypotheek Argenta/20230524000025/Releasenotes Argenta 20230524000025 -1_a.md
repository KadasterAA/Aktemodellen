...
|---|---|
**Versie Bankmodel Argenta**|Model Argenta [5.3] |
**Stylesheetnummer**|20230524000025 implementatienummer 1|
...
|---|---|---|
AA-6038 | Tekstuele aanpassing: In de titel van het modeldocument stond nog een verkeerde versie van het bankmodel genoemd. Deze is nu gewijzigd in "HYQUAR02". Hierdoor is de versie van het modeldocument gewijzigd en is de titel van de Toelichting daardoor ook aangepast. |Modeldocument en Toelichting | 


### 6 juni 2023
|Wijziging|Omschrijving|Oplossing|
|---|---|---|
AA-5777 | Tekstuele aanpassing: Onder Woonplaatskeuze was het nieuwe postadres niet volledig aangepast onder de kolom 'modeldocument tekst'. In de stylesheet staat de juiste tekst. |Toelichting | 
...
| --- |--- |--- |---|
Modeldocument Argenta|[3.1]( /kik-modeldocumenten/modeldocumenten/Hypotheek%20Argenta/20230524000025/Modeldocument%20Argenta%20v3.1.docx)|**[3.0]( /kik-modeldocumenten/modeldocumenten/Hypotheek%20Argenta/20230524000025/Toelichting%20modeldocument%20Argenta%20v3.1%20-%20v3.0.docx)**|X|
