# Release notes
Product|Rabobank stylesheetnummer 20181015000005 implementatienummer 1|
|---|---|
|**Release**|**15 oktober 2018**|
## Wijzigingen
### Aangepast modeldocument
|Wijziging|Omschrijving|Oplossing|
|---|---|---|
AA-4249 |Lidwoord het/de overeenkomst(en) in keuzeblok soort hypotheek vervangen voor de overeenkomst(en). |Toelichting, Stylesheet|
AA-4250 |Nieuwe versie van het tekstblok Partijnamen in hypotheekakten: 'de' optioneel voor partijaanduiding. |Toelichting, Stylesheet|

### Specificaties
Naam|Versie MD/TB|Versie Toelich.|  |
| --- |--- |--- |---|
Modeldocument Rabobank|[4.1](/kik-modeldocumenten/modeldocumenten/Hypotheek%20Rabobank/20181015000005/Modeldocument%20Rabobank%20v4.1.docx)|**[4.2.0](/kik-modeldocumenten/modeldocumenten/Hypotheek%20Rabobank/20181015000005/Toelichting%20modeldocument%20Rabobank%204.1%20-%20v4.2.0.docx)**| X |
XSD RabobankHypotheekakte|[1.3](/schema/RabobankHypotheekakte/1.3/RabobankHypotheekakte-1.3.xsd)||  |
