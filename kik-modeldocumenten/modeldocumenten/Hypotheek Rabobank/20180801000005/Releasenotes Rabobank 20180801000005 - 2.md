# Release notes
Product|Rabobank stylesheetnummer 20180801000005 implementatienummer 2|
|---|---|
...
|---|---|---|
AA-4183 | We hebben de WoonlocatiePersoon verwijderd uit Rabobank XSD specifiek. De woonlocatie van een IMKAD_Persoon moet bij een borgtocht niet meer vermeld. | XSD RabobankHypotheekakte |
AA-4166 | De Partij aanduiding 'bank' werd onterecht afgekeurd. We hebben de controle op de inhoud van de Partij aanduiding verwijderd voor dit stylesheetnummer. | Controles |
AA-4178 | Vast afsluitend karakter ";" na de rechtspersoon in de Rabobank ontbrak. We hebben onze stylesheet hier op aangepast. | stylesheet |

### Specificaties
Naam|Versie MD/TB|Versie Toelich.|  |
| --- |--- |--- |---|
Modeldocument Rabobank|[4.0.1](/kik-modeldocumenten/modeldocumenten/Hypotheek%20Rabobank/20180801000005/Modeldocument%20Rabobank%20v4.0.1.docx)|[4.0.0](/kik-modeldocumenten/modeldocumenten/Hypotheek%20Rabobank/20180801000005/Toelichting%20modeldocument%20Rabobank%204.0.1%20-%20v4.0.0.docx)|  |
XSD RabobankHypotheekakte|**[1.4](/schema/RabobankHypotheekakte/1.4/RabobankHypotheekakte-1.4.xsd)**|| X |
