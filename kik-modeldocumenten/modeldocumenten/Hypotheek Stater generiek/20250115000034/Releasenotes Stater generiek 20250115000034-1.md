...
**Stylesheetnummer**|20250115000034 implementatienummer 1|
**Release**|27 januari 2025|

## Wijzigingen
|Wijziging|Omschrijving|Oplossing|
|---|---|---|
 AA-7405 | De tekst van de Starterslening was onjuist.  |Stylesheet|
 AA-7405 | Het tonen van de partijaanduiding van de "Geldverstrekker" is aangepast. In plaats van vaste tekst is dit nu, net als in de rest van het document, een afleidbare tekst geworden. In zowel het modeldocument en de toelichting werden 2 verschillende namen gebruikt voor de aanduiding van de hypotheekverstrekker: "geldverstrekker" of "geldgever". Dit is nu gelijk getrokken naar "geldverstrekker". |Modeldocument, Toelichting, Stylesheet en controles|


### Specificaties
Naam|Versie MD/TB|Versie Toelich.|  |
| --- |--- |--- |---|
Modeldocument Stater generiek|**[2.0](/kik-modeldocumenten/modeldocumenten/Hypotheek%20Stater%20generiek/20250115000034/Modeldocument%20Stater%20generiek%20v2.0.docx)**|**[2.0](/kik-modeldocumenten/modeldocumenten/Hypotheek%20Stater%20generiek/20250115000034/Toelichting%20Modeldocument%20Stater%20generiek%20v2.0%20-%20v2.0.docx)**| X |
