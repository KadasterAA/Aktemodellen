# Release notes
Product|Akte van verdeling stylesheetnummer 20231016000009 implementatienummer 1|
|---|---|
...
|---|---|---|
AA-6059 | In verband met de wijziging van WVG naar Omgevingswet is er een nieuwe versie van de stylesheet opgeleverd. Hierin is de keuzetekst 'k_VerklaringWvg' gewijzigd naar 'k_VerklaringOmgevingsWet'. Documentatie is niet aangepast voor dit Tekstblok.| Stylesheet |
...
|Wijziging|Omschrijving|Oplossing|
|---|---|---|
AA-6059 | Voor de wijziging naar de Omgevingswet is de tekst voor de WVG vervangen voor tekst tbv de Omgevingswet. Tevens is de mapping aangepast voor de hierboven genoemde keuzetekst. | Modeldocument, Toelichting, Stylesheet en backend controles |


### Specificaties
Naam|Versie MD/TB|Versie Toelich.|  |
| --- |--- |--- |---|
Modeldocument Akte van verdeling|**[5.0]( /kik-modeldocumenten/modeldocumenten/Akte%20van%20verdeling/20231016000009/Modeldocument%20akte%20van%20verdeling%20v5.0.docx)**|**[5.0]( /kik-modeldocumenten/modeldocumenten/Akte%20van%20verdeling/20231016000009/Toelichting%20modeldocument%20Akte%20van%20verdeling%205.0%20-%20v5.0.docx)**|X|
