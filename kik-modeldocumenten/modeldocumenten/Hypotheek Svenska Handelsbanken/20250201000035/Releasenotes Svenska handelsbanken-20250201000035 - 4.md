...
|---|---|---|
AA-8679| De afsluitende tekst van de hypotheekgever partij was niet conform het modeldocument in het vorige implementatienummer, de tekst "voor zover in deze akte niet anders aangeduid," ontbrak in sommige situaties. Hiervoor is een nieuwe implementatienummer opgeleverd: 20250201000035 implementatienummer 4. Dit betreft alleen een stylesheet aanpassing.  | Stylesheet | 
