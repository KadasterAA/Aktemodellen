...
|---|---|---|
AA-7670| Met dit issue was ook een bevinding opgelost. Dit was helaas niet in de releasenotes opgenomen. In de zin 'hierna te noemen: de Onderzetter/Schuldenaar' ontbrak de dubbele punt. Dit is alleen opgelost in de stylesheet. In de documentatie stond het al goed | stylesheet|


## 26 februari 2025
|Issue nr.|Omschrijving|Oplossing|
|---|---|---|
AA-7670| Oplevering nieuw stylesheetnummer tbv van Svenska handelsbanken. In deze versie van de stylesheet is het nu mogelijk om bij de vervreemderpartij een partijaanduiding per persoon aan te geven en is het nu mogelijk om de akte genderneutraal op te stellen. Voor het genderneutraal maken zijn er een aantal Teksblokken aangepast. Hieronder vindt u de details van de aanpassingen.|Toelichting, Modeldocument, stylesheets, XSD en backend controles|
