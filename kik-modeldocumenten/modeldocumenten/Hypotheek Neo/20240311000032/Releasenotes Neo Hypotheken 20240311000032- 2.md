...
|---|---|---|
AA-6591| Oplevering nieuw implementatienummer tbv van Neo Hypotheken. |Stylesheet|
| |**Opgelost:**
||- Het leningbedrag werd niet in cijfers getoond
||- Bij de Registergoederen werd als afsluitend teken een komma getoond ipv een puntkomma als het samengevoegde objecten betrof.
||- Er ontbrak een spatie voor het rentebedrag.
...
| --- |--- |--- |---|
Modeldocument Neo|[1.0](/kik-modeldocumenten/modeldocumenten/Hypotheek%20Neo/Modeldocument%20Neo%20v1.0.docx)|[1.0](/kik-modeldocumenten/modeldocumenten/Hypotheek%20Neo/Toelichting%20modeldocument%20Neo%20Hypothekent%20v1.0%20-%20v1.0.docx)|  |
