...
**Stylesheetnummer**|20241201000032 implementatienummer 1|
**Release**|4 december 2024|

## Wijzigingen
|Issue nr.|Omschrijving|Oplossing|
|---|---|---|
AA-7059 | Oplevering nieuw versie bankmodel tbv van Neo Hypotheken. De volgende tekst is verwijderd uit de volgende paragrafen: <ul><li>Artikel 1: ", van welke overeenkomst blijkt uit een aan de minuut van deze akte gehecht, door de Schuldenaar/Hypotheekgever ondertekend document genaamd ‘hypotheekaanbod’ (bijlage)"</li><li>Artikel 3: "aan deze akte gehechte Leningsovereenkomst en de"</li></ul> | Toelichting, Modeldocument, stylesheets en backend controles |
