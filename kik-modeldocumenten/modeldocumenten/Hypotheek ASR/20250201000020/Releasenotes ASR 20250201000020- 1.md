...
|---|---|
**Versie Bankmodel ASR**|21.02|
**Stylesheetnummer**|20250201000020 implementatienummer 1|
...
|---|---|---|
AA-6733 | Nieuwe versie van de stylesheet opgeleverd. Het is nu mogelijk om de akte genderneutraal op te stellen. Inhoudelijk zijn er geen wijzigingen, er zijn wel een aantal Teksblokken hiervoor aangepast. Hieronder vindt u de details van de aanpassingen.| Stylesheet | 
AA-6628 | Bevinding opgelost: Als de derde Hypotheekgever niet aanwezig was, dan werd de zin afgeloten met een puntkomma ipv een punt. | Modeldocument, Toelichting en Stylesheet 
...
| --- |--- |--- |---|
**Modeldocument ASR**|**[4.0](/kik-modeldocumenten/modeldocumenten/Hypotheek%20ASR/20250201000020/Modeldocument%20ASR%20vv.0.docx)**|**[3.0](/kik-modeldocumenten/modeldocumenten/Hypotheek%20ASR/20250201000020/Toelichting%20modeldocument%20ASR%20v4.0%20-v4.0.docx)**|X |
