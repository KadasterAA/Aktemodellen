# Release notes
Product|ASR stylesheetnummer 20190401000020 implementatienummer 3|
|---|---|
|**Release**|**3 juni 2019**|
## Wijzigingen

### MD ASR nieuwe wijzigingen
|Wijziging|Omschrijving|Oplossing|
|---|---|---|
AA-4411 |Aanduiding van de derde hypotheekgever werd niet getoond als de schuldenaar/hypotheekgever partij een gerelateerd persoon bevatte. | Stylesheet |
AA-4412 |In het modeldocument was de woonplaatskeuze ten onrechte als vaste tekst opgenomen.| Modeldocument|

### Specificaties
Naam|Versie MD/TB|Versie Toelich.|  |
| --- |--- |--- |---|
Modeldocument ASR|**[1.3]( /kik-modeldocumenten/modeldocumenten/Hypotheek%20ASR/20190401000020/Modeldocument%20ASR%20v1.3.docx)**|[1.1.0]( /kik-modeldocumenten/modeldocumenten/Hypotheek%20ASR/20190401000020/Toelichting%20modeldocument%20ASR%201.3%20-v1.1.0.docx)| X|
