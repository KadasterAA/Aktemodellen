# Release notes
Product|ASR stylesheetnummer 20190401000020 implementatienummer 2|
|---|---|
|**Release**|**17 mei 2019**|
## Wijzigingen
### Tekstblok TB Aanhef
...
|Wijziging|Omschrijving|Oplossing|
|---|---|---|
AA-4395 | In de alinea van de Geldlening miste er een spatie in de vaste tekst. | Stylesheet | 
AA-4409 | Dubbele punt ontbrak bij de partijnaam van de bank. | Modeldocument, Toelichting, Stylesheet |

### Specificaties
Naam|Versie MD/TB|Versie Toelich.|  |
| --- |--- |--- |---|
Modeldocument ASR|**[1.2]( /kik-modeldocumenten/modeldocumenten/Hypotheek%20ASR/20190401000020/Modeldocument%20ASR%20v1.2.docx)**|**[1.1.0]( /kik-modeldocumenten/modeldocumenten/Hypotheek%20ASR/20190401000020/Toelichting%20modeldocument%20ASR%201.2%20-v1.1.0.docx)**| X|
