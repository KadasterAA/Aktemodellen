# Release notes
Product|ASR stylesheetnummer 20210511000020 implementatienummer 1|
|---|---|
|**Release**|**4 juni 2021**|
## Wijzigingen
...
|---|---|---|
AA-5075 |In dit model is onder het kopje 'Looptijd -en aflossing' de tekst "Algemene Bepalingen" gewijzigd in "Algemene Voorwaarden"| Stylesheet, modeldocument, toelichting |

### Specificaties
Naam|Versie MD/TB|Versie Toelich.|  |
| --- |--- |--- |---|
Modeldocument ASR|**[2.0]( /kik-modeldocumenten/modeldocumenten/Hypotheek%20ASR/20210511000020/Modeldocument%20ASR%20v2.0.docx)**|**[2.0]( /kik-modeldocumenten/modeldocumenten/Hypotheek%20ASR/20210511000020/Toelichting%20modeldocument%20ASR%202.0%20-v2.0.docx)**|X |
