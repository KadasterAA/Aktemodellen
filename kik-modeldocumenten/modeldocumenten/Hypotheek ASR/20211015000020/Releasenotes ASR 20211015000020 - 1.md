...
**Stylesheetnummer**|**20211015000020 implementatienummer 1**|
...
|---|---|---|
AA-5075 |Op basis van de laatste versie van het ASR bankmodel is er een nieuw stylesheetnummer opgeleverd. In de rode tekst zijn een aantal aanpassingen gedaan. | Bankmodel, Modeldocument, Toelichting, Stylesheet |

### Specificaties
Naam|Versie MD/TB|Versie Toelich.|  |
| --- |--- |--- |---|
Modeldocument ASR|**[3.0]( /kik-modeldocumenten/modeldocumenten/Hypotheek%20ASR/20211015000020/Modeldocument%20ASR%20v3.0.docx)**|**[3.0]( /kik-modeldocumenten/modeldocumenten/Hypotheek%20ASR/20211015000020/Toelichting%20modeldocument%20ASR%203.0%20-v3.0.docx)**|X |
