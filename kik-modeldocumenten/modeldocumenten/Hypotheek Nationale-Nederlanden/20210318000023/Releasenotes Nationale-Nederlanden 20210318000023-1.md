# Release notes
Product|Nationale-Nederlanden stylesheetnummer 20210318000023 implementatienummer 1|
|---|---|
...
|---|---|---|
AA-5016 | Nieuw modeldocument Nationale Nederlanden. In deze versie hebben we van de 2e vermelding van het Rangtelwoord, in de Stukdeel Overbruggingshypotheek, een tekstkeuze gemaakt. In de vorige versie werd deze afgeleid van wat er in de 1e vermelding van Rangtelwoord in Stukdeel Overbruggingshypotheek stond.| Toelichting, Stylesheet en backend controles|


### Specificaties
Naam|Versie MD/TB|Versie Toelich.|  |
| --- |--- |--- |---|
Modeldocument Nationale-Nederlanden|[1.0]( /kik-modeldocumenten/modeldocumenten/Hypotheek%20Nationale-Nederlanden/20210318000023/Modeldocument%20NN%20v1.0.docx)|**[2.0]( /kik-modeldocumenten/modeldocumenten/Hypotheek%20Nationale-Nederlanden/20210318000023/Toelichting%20modeldocument%20Nationale-Nederlanden%201.0%20-%20v2.0.docx)**| X |
XSD StukAlgemeen|[12.0.0](/schema/stuk%20algemeen/11.0.0/StukAlgemeen-12.0.0.xsd)||  |
