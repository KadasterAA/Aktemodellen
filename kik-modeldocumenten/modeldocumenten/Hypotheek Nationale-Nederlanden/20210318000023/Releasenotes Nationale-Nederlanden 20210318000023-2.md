# Release notes
Product|Nationale-Nederlanden stylesheetnummer 20210318000023 implementatienummer 2|
|---|---|
...
|---|---|---|
AA-5127 | Als er via WordML een PDF werd aangemaakt ontstond in de tekst een lege regel en werden een aantal kopjes niet vet afgedrukt. Tekstueel is er in dit implementatienummer niets veranderd. |  Stylesheet |


### Specificaties
Naam|Versie MD/TB|Versie Toelich.|  |
| --- |--- |--- |---|
Modeldocument Nationale-Nederlanden|[1.0]( /kik-modeldocumenten/modeldocumenten/Hypotheek%20Nationale-Nederlanden/20210318000023/Modeldocument%20NN%20v1.0.docx)|[2.0]( /kik-modeldocumenten/modeldocumenten/Hypotheek%20Nationale-Nederlanden/20210318000023/Toelichting%20modeldocument%20Nationale-Nederlanden%201.0%20-%20v2.0.docx)|  |
