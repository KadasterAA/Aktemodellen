# Release notes
Product|Akte van Levering stylesheetnummer 20231016000007 implementatienummer 1|
|---|---|
...
|---|---|---|
AA-6086 | In verband met de wijziging van WVG naar Omgevingswet is er een nieuwe versie van de stylesheet opgeleverd. Hierin is de keuzetekst 'k_VerklaringWvg' gewijzigd naar 'k_VerklaringOmgevingsWet'. Documentatie is niet aangepast voor dit Tekstblok.| Stylesheet |
...
|Wijziging|Omschrijving|Oplossing|
|---|---|---|
AA-6086 | Voor de wijziging naar de Omgevingswet is de tekst voor de WVG vervangen voor tekst tbv de Omgevingswet. Tevens is de mapping aangepast voor de hierboven genoemde keuzetekst. | Modeldocument, Toelichting, Stylesheet en backend controles |
