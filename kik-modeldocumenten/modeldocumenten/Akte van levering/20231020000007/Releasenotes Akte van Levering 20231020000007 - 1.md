...
|---|---|
**Stylesheetnummer**|**20231020000007 implementatienummer 1**|
...
|---|---|---|
AA-6057 | In verband met de wijziging van WVG naar Omgevingswet is er een nieuwe versie van de stylesheet opgeleverd. Hierin is de keuzetekst 'k_VerklaringWvg' gewijzigd naar 'k_VerklaringOmgevingsWet'. Documentatie is niet aangepast voor dit Tekstblok.| Stylesheet |
...
|Wijziging|Omschrijving|Oplossing|
|---|---|---|
AA-6057 | Voor de wijziging naar de Omgevingswet is de tekst voor de WVG vervangen voor tekst tbv de Omgevingswet. Tevens is de mapping aangepast voor de hierboven genoemde keuzetekst. | Modeldocument, Toelichting, Stylesheet en backend controles |


### Specificaties
Naam|Versie MD/TB|Versie Toelich.|  |
| --- |--- |--- |---|
Modeldocument|**[6.0](/kik-modeldocumenten/modeldocumenten/Akte%20van%20levering/20231020000007/Modeldocument%20Akte%20van%20Levering%20v6.0.docx)**|**[6.0](/kik-modeldocumenten/modeldocumenten/Akte%20van%20levering/20231020000007/Toelichting%20modeldocument%20Akte%20van%20Levering%20v6.0%20-%20v6.0.docx)**|X|
