...
|---|---| 
**Versie Bankmodel ABP Hypotheken**|ABP (ABP 23.01) |
**Stylesheetnummer**|20240321000019 implementatienummer 1|
...
|---|---|---|
| AA-6241 | Oplevering van een nieuw stylesheet tbv van ABP op basis van het nieuwe bankmodel. |Toelichting, Modeldocument, stylesheets en backend controles|


### Tekstblok Equivalentieverklaring
|Wijziging|Omschrijving|Oplossing|
|---|---|---|
AA-6057 | Voor deze versie van de ABP moet de nieuwe versie van het Tekstblok worden gebruikt. Het tekstblok is aangepast vanwege de aanpassingen tbv de Omgevingswet. Deze wijzigingen hebben GEEN betrekking op de ABP akte. | Stylesheet |
...
| --- |--- |--- |---|
Modeldocument ABP|**[2.0]( /kik-modeldocumenten/modeldocumenten/Hypotheek%20ABP/20240321000019/Modeldocument%20ABP%20v2.0.docx)**|**[2.0]( /kik-modeldocumenten/modeldocumenten/Hypotheek%20ABP/20240321000019/Toelichting%20modeldocument%20ABP%202.0%20-%20v2.0.docx)**|  |
XSD StukAlgemeen|[12.0.0](/schema/stuk%20algemeen/8.1.0/StukAlgemeen-12.0.0.xsd)||  |
