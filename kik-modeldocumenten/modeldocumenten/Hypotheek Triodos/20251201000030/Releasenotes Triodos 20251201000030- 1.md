...
|---|---|
|**Versie Bankmodel Triodos**|Triodos hypotheekakte (Model Triodos 24.01)|
|**Stylesheetnummer**|20251201000030 implementatienummer 1|
...
|---|---|---|
|AA-7247 | Nieuwe versie van de stylesheet opgeleverd. Het is nu mogelijk om de akte genderneutraal op te stellen. Hiervoor zin alleen de tekstblokken aangepast. Hieronder vindt u de details van de aanpassingen van de tekstblokken. Tevens is er een tekstuele aanpassing in de vaste tekst van de 'Starterslening' ivm nieuwe versie van het bankmodel.| Model, Toelichting, Stylesheet, XSD|
...
| --- |--- |--- |---|
|**Modeldocument Triodos**|**[2.0](/kik-modeldocumenten/modeldocumenten/Hypotheek%20Triodos/20230401000030/Modeldocument%20Triodos%20Bank%20N.V.%20v2.0.docx)**|**[2.0](/kik-modeldocumenten/modeldocumenten/Hypotheek%20Triodos/20230401000030/Toelichitng%20modeldocument%20Triodos%20Bank%20N.V.%202.0%20-v2.0.docx)**| X |
...
|~~**Tekstblok - Legitimatie**~~|VERWIJDERD||X |
