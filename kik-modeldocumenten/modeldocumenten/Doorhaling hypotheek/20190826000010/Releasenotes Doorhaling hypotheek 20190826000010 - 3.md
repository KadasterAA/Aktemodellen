...
|---|---|
**Stylesheetnummer**|**20190826000010 implementatienummer 3**|
...
|---|---|---|
AA-5220 | Technische aanpassing aan de stylesheet. Er is code verwijderd die ervoor zorgde dat het compileren van het document, in een enkel geval, niet lukte.| Stylesheet|


**17 januari 2020**
|ID|Omschrijving|Oplossing|
|---|---|---|
AA-4578 | Nummering van de comparitie aangepast.| Stylesheet, Toelichting|
