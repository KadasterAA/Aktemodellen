...
**Stylesheetnummer**|20250301000006 implementatienummer 1|
...
|---|---|---|
| AA-7713 | Nieuwe versie van de stylesheet opgeleverd. Het is nu mogelijk om de akte genderneutraal op te stellen. Om de akte genderneutraal op te kunnen stellen zijn ook een aantal tekstblokken en het XSD aangepast. Hieronder vindt u de details van de aanpassingen van de tekstblokken.| Modeldocument, Toelichting en Stylesheet | 
...
|Wijziging|Omschrijving|Oplossing|
|---|---|---|
AA-6895 | Het geslacht van de persoon is nu optioneel geworden zodat het mogelijk is de akte genderneutraal op te stellen. Tevens is in deze versie van het tekstblok een bevinding opgelost. Sommige van de Partijaanduidingen werden altijd omgezet naar kleine letters.| Stylesheet |

### Specificaties
Naam|Versie MD/TB|Versie Toelich.|  |
| --- |--- |--- |---|
**Modeldocument**|**[3.0]( /kik-modeldocumenten/modeldocumenten/Hypotheek%20Particulier/20250301000006/Modeldocument%20particuliere%20hypotheek%20v3.0.docx)**|**[3.0]( /kik-modeldocumenten/modeldocumenten/Hypotheek%20Particulier/20250301000006/Toelichting%20modeldocument%20Particuliere%20hypotheek%20v3.0%20-%20v3.0.docx)**|X |
