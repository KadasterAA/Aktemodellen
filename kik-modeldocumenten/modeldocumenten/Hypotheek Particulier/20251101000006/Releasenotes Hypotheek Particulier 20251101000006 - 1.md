...
|---|---|
|**Versie Bankmodel Particulier**||
|**Stylesheetnummer**|20251101000006 implementatienummer 1|
...
|---|---|---|
| AA-8931 | In het keuzeblok 'Vaste hypotheek, niet zijnde teboekgesteld binnenschip' was het nog niet mogelijk om de tekst genderneutraal op te stellen. Hiervoor is een nieuwe versie van het Particuliere specifieke XSD opgeleverd. Er zijn geen inhoudelijk wijzingen in het Model en de Toelichting. Er is wel een nieuwe stylesheet opgeleverd. Hierin is alleen de versie van de specifieke XSD aangepast.| XSD ParticuliereHypotheekakte, Stylesheet |

### Specificaties

|Naam|Versie MD/TB|Versie Toelich.|  |
| --- |--- |--- |---|
|Modeldocument|[3.0]( /kik-modeldocumenten/modeldocumenten/Hypotheek%20Particulier/20250301000006/Modeldocument%20particuliere%20hypotheek%20v3.0.docx)|[3.0]( /kik-modeldocumenten/modeldocumenten/Hypotheek%20Particulier/20250301000006/Toelichting%20modeldocument%20Particuliere%20hypotheek%20v3.0%20-%20v3.0.docx)| |
|XSD StukAlgemeen|[13.0.0](/schema/stuk%20algemeen/13.0.0/StukAlgemeen-13.0.0.xsd)|  |  |
|**XSD ParticuliereHypotheekakte**|**[2.0](/schema/ParticuliereHypotheekakte/2.0/ParticuliereHypotheekakte-2.0.xsd)**||X |
