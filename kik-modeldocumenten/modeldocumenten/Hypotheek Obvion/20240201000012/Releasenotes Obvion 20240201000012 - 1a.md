...
|---|---|---|
AA-XXXX | In de toelichting stond er een verkeerde waarde bij de partijaanduiding van de verkrijgende partij. Was 'geldgeefster' moet zijn 'geldgever'. | Toelichting |
...
|---|---|---|
AA-6057 | Voor deze versie van de Obvion moet de nieuwe versie van het Tekstblok worden gebruikt. Het tekstblok is aangepast vanwege de aanpassingen tbv de Omgevingswet. Deze wijzigingen hebben GEEN betrekking op de Obvion akte. | Stylesheet |


### MD Obvion
|Wijziging|Omschrijving|Oplossing|
|---|---|---|
| AA-6142 | Nieuwe versie stylesheet 20240201000012 ivm wijzigingen bankmodel | Modeldocument, Toelichting en Stylesheet | 


### Specificaties
Naam|Versie MD/TB|Versie Toelich.|  |
| --- |--- |--- |---|
Modeldocument Obvion|[3.0.0]( /kik-modeldocumenten/modeldocumenten/Hypotheek%20Obvion/20180501000012/Modeldocument%20Obvion%20v3.0.0.docx)|**[4.1.0]( /kik-modeldocumenten/modeldocumenten/Hypotheek%20Obvion/20240201000012/Toelichting%20modeldocument%20Obvion%203.0.0%20-%20v4.1.0.docx)**| X |
...
Tekstblok - Rechtspersoon|[2.8.0](/kik-modeldocumenten/tekstblokken/Tekstblok%20-%20Rechtspersoon%20v2.8.0.docx)|[2.12.0](/kik-modeldocumenten/tekstblokken/Toelichting%20Tekstblok%20-%20Rechtspersoon%202.8.0%20-%20v2.11.0.docx)|  |
